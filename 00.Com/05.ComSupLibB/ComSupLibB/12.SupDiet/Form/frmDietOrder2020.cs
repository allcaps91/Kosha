...
namespace ComSupLibB
{
    ...
    public partial class frmDietOrder2020 : Form, MainFormMessage
    {
        ...
        public frmDietOrder2020()
        {
            InitializeComponent();
        }

        public frmDietOrder2020(MainFormMessage pform)
        {
            InitializeComponent();
            this.mCallForm = pform;
        }

        public frmDietOrder2020(string strFlag, string strPano)
        {
            InitializeComponent();
            FstrFlag = strFlag;
            FstrPano = strPano;
        ...
        public frmDietOrder2020(string strFlag, string strPano, string strWard)
        {
            InitializeComponent();
            FstrFlag = strFlag;
            FstrPano = strPano;
        ...
        private void frmDietOrder2020_Load(object sender, EventArgs e)
        {
            ...
            SS1_Sheet1.Columns[6 + 1].Visible = false;
            SS1_Sheet1.Columns[7 + 1].Visible = false;
            SS1_Sheet1.Columns[10 + 1].Visible = false;
            SS1_Sheet1.Columns[11 + 1].Visible = false;
            SS1_Sheet1.Columns[12 + 1].Visible = false;
            SS1_Sheet1.Columns[13 + 1].Visible = false;
            SS1_Sheet1.Columns[14 + 1].Visible = false;
            SS1_Sheet1.Columns[15 + 1].Visible = false;
            SS1_Sheet1.Columns[16 + 1].Visible = false;
            SS1_Sheet1.Columns[17 + 1].Visible = false;
            ...
            strMsg += ComNum.VBLF + "HS 마감시각 15:00";
            ...
            strMsg2 += ComNum.VBLF + "HS 마감시각 15:00";
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0 || clsType.User.Sabun == "04349" || clsType.User.Sabun == "04444" || GstrWardCodes == "TOP" || clsType.User.JobGroup == "JOB018003") 
                {
                    ...
                    SS1_Sheet1.Columns[7 + 1].Visible = true;
        ...
        private void READ_DIET_ADD()
        {
            ...
            try
            {
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    SS1_Sheet1.Cells[i, 8 + 1].Text = "재원중";

                    SS1_Sheet1.Cells[i, 9 + 1].Text = dt.Rows[i]["PANO"].ToString().Trim();
                    strPano = dt.Rows[i]["Pano"].ToString().Trim();
                    SS1_Sheet1.Cells[i, 10 + 1].Text = dt.Rows[i]["DEPTCODE"].ToString().Trim();
                    SS1_Sheet1.Cells[i, 11 + 1].Text = dt.Rows[i]["BI"].ToString().Trim();
                    SS1_Sheet1.Cells[i, 12 + 1].Text = dt.Rows[i]["SNAME"].ToString().Trim();
                    SS1_Sheet1.Cells[i, 13 + 1].Text = dt.Rows[i]["DRCODE"].ToString().Trim();
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        SS1_Sheet1.Cells[i, 8 + 1].Text = strStat;
                        ...
                        SS1_Sheet1.Cells[i, 14 + 1].Text = dt.Rows[i]["IPDNO"].ToString().Trim();
                        nIPDNO = VB.Val(SS1_Sheet1.Cells[i, 14 + 1].Text);
                        ...
                        if (dtTemp.Rows.Count > 0)
                        {
                            SS1_Sheet1.Cells[i, 17 + 1].Text = dtTemp.Rows[0]["UDATE"].ToString().Trim();
                        }

                        dtTemp.Dispose();
                        dtTemp = null;

                        SS1_Sheet1.Cells[i, 15 + 1].Text = dt.Rows[i]["INDATE"].ToString().Trim();
                        SS1_Sheet1.Cells[i, 16 + 1].Text = dt.Rows[i]["SEX"].ToString().Trim();
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        SS1_Sheet1.Cells[SS1_Sheet1.RowCount - 1, 8 + 1].Text = strStat;
                        //COLOR
                        if (strStat == "재원중")
                        {
                        ...
                        SS1_Sheet1.Cells[SS1_Sheet1.RowCount - 1, 9 + 1].Text = dt.Rows[i]["PANO"].ToString().Trim();
                        strPano = dt.Rows[i]["PANO"].ToString().Trim();

                        SS1_Sheet1.Cells[SS1_Sheet1.RowCount - 1, 10 + 1].Text = dt.Rows[i]["DEPTCODE"].ToString().Trim();
                        SS1_Sheet1.Cells[SS1_Sheet1.RowCount - 1, 11 + 1].Text = dt.Rows[i]["BI"].ToString().Trim();
                        SS1_Sheet1.Cells[SS1_Sheet1.RowCount - 1, 12 + 1].Text = dt.Rows[i]["SNAME"].ToString().Trim();
                        SS1_Sheet1.Cells[SS1_Sheet1.RowCount - 1, 13 + 1].Text = dt.Rows[i]["DRCODE"].ToString().Trim();
                    ...
                    for (j = 0; j < dt.Rows.Count; j++)
                    {
                        ...
                        if (GstrWardCode == "A1" || GstrWardCode == "A2" || GstrWardCode == "A3" || GstrWardCode == "A4")
                        {
                            if (GstrWardCode == "A1" || GstrWardCode == "A4")
                            {
                                ...
                                {
                                    SS1_Sheet1.Cells[nRow, 7 + 1].Value = true;
                                }
                            }
        ...
        private void SCREEN_CLEAR()
        {
            ...
            if (clsType.User.Sabun != "04349")
            {
                ...
                SS1_Sheet1.Columns[9 + 1].Visible = false;
                SS1_Sheet1.Columns[10 + 1].Visible = false;
                SS1_Sheet1.Columns[11 + 1].Visible = false;
                SS1_Sheet1.Columns[12 + 1].Visible = false;
                SS1_Sheet1.Columns[13 + 1].Visible = false;
        ...
        private void Insert_Diet_Order(FarPoint.Win.Spread.SheetView ArgSS, int argROW, string argBun)
        {
            ...
            if (argBun == "01" && (strDIETCODE == "65" || strDIETCODE == "66")   )  //경관신부전식, 경관투석식 일경우, 향후에 코드 변경되면 같이 추가해야함.(부서간 업무 이해로 인한.....)
            {
                strTemp = " [경관신부전식]과 [경관투석식]의 경우 " + ComNum.VBLF + ComNum.VBLF +
                          " ▶ 100CC는 200Kcal 입니다. " + ComNum.VBLF + ComNum.VBLF +
                          " 처방과 Kcal가 맞는 지 확인하여 주십시요.";
//                          "      ★ 참고 ★ " + ComNum.VBLF +
//                          "   경관급식   1CC = 1Kcal " + ComNum.VBLF +
//                          "   경관설사식 1CC = 1Kcal " + ComNum.VBLF +
//                          "   경관당뇨식 1CC = 1Kcal " + ComNum.VBLF +
//                          "   경관고단백식   0.65CC = 1Kcal " + ComNum.VBLF +
//                          "   경관신부전식 1CC = 2Kcal " + ComNum.VBLF +
//                          "   경관투석식 1CC = 2Kcal ";

                ComFunc.MsgBox(strTemp, "Kcal 확인!");
            }
        ...
        private void chkDietDay_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else if (chkDietDay3.Checked == true)
            {
        ...
        private bool Save()
        {
            ...
            {
                if (strChkDietDay == "'4'")       //HS는 식사가 없어도 저장되도록 보완(2020-11-23)
                {
        ...
        void after_Save()
        {
            ...
            try
            {
                ...
                if (chkDietDay3.Checked == true)
                {
                    SS1_Sheet1.Cells[FnDietROW, 6].Text = strDietOrder;
                }

                SS1_Sheet1.Cells[FnDietROW, 7 + 1].Value = false;
        ...
        private void SS1_ButtonClicked(object sender, FarPoint.Win.Spread.EditorNotifyEventArgs e)
        {
            ...
            try
            {
                if (e.Column == 6 + 1)
                {
                    if (SS1_Sheet1.Cells[e.Row, 8 + 1].Text != "심사완료" || SS1_Sheet1.Cells[e.Row, 8 + 1].Text != "계산중" || SS1_Sheet1.Cells[e.Row, 8 + 1].Text != "퇴원")
                    {
                        strDate = TxtDietDate.Text.Trim();
                        strChk = Convert.ToBoolean(SS1_Sheet1.Cells[e.Row, 6 + 1].Value) == true ? "1" : "0";
                        strPano = SS1_Sheet1.Cells[e.Row, 9 + 1].Text.Trim();
                ...
                else if (e.Column == 7 + 1)
                {
                    strDate = (TxtDietDate.Text).Trim();
                    strChk = Convert.ToBoolean(SS1_Sheet1.Cells[e.Row, 7 + 1].Value) == true ? "1" : "0";
                    strPano = SS1_Sheet1.Cells[e.Row, 9 + 1].Text.Trim();
        ...
        private void SS1_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            strInDate = SS1_Sheet1.Cells[e.Row, 15 + 1].Text.Trim();
            clsSupDiet.dst.Sex = SS1_Sheet1.Cells[e.Row, 16 + 1].Text.Trim();

            if (e.Column == 0)
            {
                FstrDietPano = "";
                FstrDietPano = SS1_Sheet1.Cells[e.Row, 9 + 1].Text;
            ...
            if (e.Column == 1)
            {
                ...
                FstrDietPano = SS1_Sheet1.Cells[e.Row, 9 + 1].Text;
                FstrDietPano = SS1_Sheet1.Cells[e.Row, 9 + 1].Text.Trim();
            ...
            try
            {
                ...
                //NEW
                if (e.Column != 3 && e.Column != 4 && e.Column != 5 && e.Column != 6)
                {
                    timer1.Enabled = true;
                    return;
                }
                ...
                FstrGbSunap = SS1_Sheet1.Cells[e.Row, 6 + 1].Text.Trim();
                GstrPANO = SS1_Sheet1.Cells[e.Row, 9 + 1].Text.Trim();
                FstrDeptCode = SS1_Sheet1.Cells[e.Row, 10 + 1].Text.Trim();
                FstrBi = SS1_Sheet1.Cells[e.Row, 11 + 1].Text.Trim();
                FstrSname = SS1_Sheet1.Cells[e.Row, 12 + 1].Text.Trim();
                FstrDrCode = SS1_Sheet1.Cells[e.Row, 13 + 1].Text.Trim();
                FNIPDNO = VB.Val(SS1_Sheet1.Cells[e.Row, 14 + 1].Text);
                FstrDietDate = TxtDietDate.Text;
                ...
                {
                    if (SS1_Sheet1.Cells[e.Row, 8 + 1].Text == "재원중" || SS1_Sheet1.Cells[e.Row, 8 + 1].Text == "퇴원등록" || SS1_Sheet1.Cells[e.Row, 8 + 1].Text == "부분심사")
                    {
                    }
                    else
                    {
                        MessageBox.Show("현재 환자는 [" + SS1_Sheet1.Cells[e.Row, 8 + 1].Text + "]상태입니다. " + ComNum.VBLF + " 식이오더를 입력할수 없습니다.", "확인");
                        timer1.Enabled = true;
                        return;
                    }
                }
                ...
                else
                {
                    ...
                    if (FstrDietDay == "4" && FstrCureFood == "OK" && string.Compare(ComFunc.FormatStrToDate(ComQuery.CurrentDateTime(clsDB.DbCon, "T"), "M"), "15:00") >= 0)
                    {
                        MessageBox.Show("지금은 치료식(경관식) 식이변경이 불가능합니다." + ComNum.VBLF + ComNum.VBLF + strMsg2);
                    }
                }
        ...
        private void SSBIGO_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            if(strBigo.Trim() == "실온보관")
            {
                SSOrder_Sheet1.Cells[FnRow - 1, 3].Text = "#######1";
            }
            else
            {
                SSOrder_Sheet1.Cells[FnRow - 1, 3].Text = "########";
        ...
        private void SSCode1_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            nOldCnt = SSOrder_Sheet1.RowCount;
            //정규식이
            Insert_Diet_Order(SSCode1_Sheet1, e.Row, "01");


            if (SSCode1_Sheet1.Cells[e.Row, 0].Text.Contains("경관") == true)
            {
                for (i = 1; i <= SSOrder_Sheet1.RowCount; i++)
                {
                    if (SSOrder_Sheet1.Cells[i - 1, 2].Text == "실온보관")
                    {
                        nOldCnt = 999;
                    }
                }

                if (nOldCnt < SSOrder_Sheet1.RowCount)
                {
                    ...
                    SSOrder_Sheet1.Cells[FnRow - 1, 1].Text = "50";
                    //SSOrder_Sheet1.Cells[FnRow - 1, 2].Text = "소독(식사 후 식기는 병실에 두세요)";
                    SSOrder_Sheet1.Cells[FnRow - 1, 2].Text = "실온보관";
                    SSOrder_Sheet1.Cells[FnRow - 1, 3].Text = "#######1";       //자동 리피트 포함시키기 위해 뒤에 1 붙임
                    SSOrder_Sheet1.Cells[FnRow - 1, 4].Text = "1";
                    SSOrder_Sheet1.Cells[FnRow - 1, 5].Text = "";
                    SSOrder_Sheet1.Cells[FnRow - 1, 6].Text = "99";
                    SSOrder_Sheet1.Cells[FnRow - 1, 7].Text = "";
        ...
        private void frmDietOrder2020_Activated(object sender, EventArgs e)
        {
        ...
        private void frmDietOrder2020_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (this.mCallForm == null)
            {
                return;

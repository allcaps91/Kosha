...
namespace ComSupLibB.SupFnEx
{
    ...
    /// File Name       : frmComSupFnExVIEW03.cs
    /// Description     : 류마티스 현미경 검사 사진 보기
    /// Author          : 윤조연
    ...
    /// 
    /// </history>
    /// <seealso cref= "\ocs\nvc\Frm사진보기.frm(frm사진보기) >> frmComSupFnExVIEW03.cs c#에서 폼 추가함" />
    public partial class frmComSupFnExVIEW03 : Form
    {
        #region 클래스 선언 및 etc....

        clsPublic cpublic  =null; //공용함수        
        clsComSQL comSql = null;
        ComFunc fun = null;
        ...
        public frmComSupFnExVIEW03(string argFiles)
        {
            InitializeComponent();

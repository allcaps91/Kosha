    ...
    public partial class frmComSupLbExVIEW07 : Form
    {
        ...
        void setCtrlSpreadPrint()
        {
            if (ComFunc.isDataTableNull(this.gDt) == false)
            {
                if (this.nGHR10 > 0)
                {
                    frmComSupLbExPRT02 f = new frmComSupLbExPRT02(this.gStrSpecNo, clsComSupLbExSQL.enmSel_EXAM_RESULTC_Print_PB.PB);
                    f.setSpreadPrint();
                }

                if (this.nGMaste > 0)
                {
                    frmComSupLbExPRT02 f = new frmComSupLbExPRT02(this.gStrSpecNo, clsComSupLbExSQL.enmSel_EXAM_RESULTC_Print_PB.NONE);
                    f.setSpreadPrint();
                }

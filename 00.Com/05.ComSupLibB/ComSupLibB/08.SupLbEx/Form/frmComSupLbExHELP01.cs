...
namespace ComSupLibB.SupLbEx
{
    ...
    public partial class frmComSupLbExHELP01 : Form
    {
        ...
        public frmComSupLbExHELP01(bool isSlip, string strPano, string strSname, string strBdate, string strDept, string strIOGu = "" )
        {
            InitializeComponent();
        ...
        void setCtrlSpread()
        {
            ...
            if (this.isSlip == true)
            {
                ds = lbExSQL.sel_OPD_SLIP(clsDB.DbCon, this.gStrPano, this.gStrDept, this.gStrBdate, this.gStrIOGu);                
                setSpdStyle(this.ssMain, ds, lbExSQL.sSel_OPD_SLIP, lbExSQL.nSel_OPD_SLIP);

                this.ssMain.ActiveSheet.Rows.Count = this.ssMain.ActiveSheet.Rows.Count + 1;

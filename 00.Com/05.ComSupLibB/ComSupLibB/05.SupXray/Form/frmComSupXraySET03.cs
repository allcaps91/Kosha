...
namespace ComSupLibB.SupXray
{
    ...
    /// File Name       : frmComSupXraySET03.cs
    /// Description     : 영상의학과 판독프로그램에 사용되는 상용결과세팅
    /// Author          : 윤조연
    ...
    /// 
    /// </history>
    /// <seealso cref= "\xray\xuread\xupacs\xuread07.frm(FrmResutSet) >> frmComSupXraySET03.cs 폼이름 재정의" />
    public partial class frmComSupXraySET03 : Form
    {
        #region 클래스 선언 및 etc....
        ...
        public frmComSupXraySET03(string argPart,string argXJong ,long argSabun)
        {
            InitializeComponent();
        ...
        void setCtrlData()
        {
            ...
            //2018-08-02 안정수, 김종민과장으로 로그인시 텍스트박스 크기조절
            if(clsType.User.IdNumber == "20845")
            {
                txtResult.Width = 670;

                txtResult.Font = new Font("굴림체", 12);
            }

            if (clsType.User.JobGroup == "JOB001008")
            {
                gXJong = "ALL";
            }
        }                

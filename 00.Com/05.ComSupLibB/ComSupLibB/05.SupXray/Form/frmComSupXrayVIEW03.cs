...
namespace ComSupLibB.SupXray
{
    ...
    /// File Name       : frmComSupXrayVIEW03.cs
    /// Description     : 영상의학과 재료코드 조회
    /// Author          : 윤조연
    ...
    /// 
    /// </history>
    /// <seealso cref= "\xray\xucode\xucode06.frm(FrmView) >> frmComSupXrayVIEW03.cs 폼이름 재정의" />
    public partial class frmComSupXrayVIEW03 : Form
    {
        #region 클래스 선언 및 etc....

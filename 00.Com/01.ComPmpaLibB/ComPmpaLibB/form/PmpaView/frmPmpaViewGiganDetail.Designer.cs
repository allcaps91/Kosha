...
{
    partial class frmPmpaViewGiganDetail
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.ssView_Sheet1});
            this.ssView.Size = new System.Drawing.Size(1264, 600);
            ...
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 1).Value = "ID";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "미수구분";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "발생일자";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "입금일자";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "일수";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "외래,입원";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "전월이월";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "당월 미수액";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "당월 입금액";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "당월 삭감액";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "당월 계산착오";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "당월 미수잔액";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "당월 반송액";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 14).Value = "비   고";
            ...
            this.ssView_Sheet1.Columns.Get(1).Label = "ID";
            this.ssView_Sheet1.Columns.Get(1).StyleName = "Static518636455866503291914";
            this.ssView_Sheet1.Columns.Get(1).Width = 70F;
            this.ssView_Sheet1.Columns.Get(2).Label = "미수구분";
            this.ssView_Sheet1.Columns.Get(2).StyleName = "Static518636455866503291914";
            this.ssView_Sheet1.Columns.Get(2).Width = 72F;
            this.ssView_Sheet1.Columns.Get(3).Label = "발생일자";
            this.ssView_Sheet1.Columns.Get(3).StyleName = "Static518636455866503291914";
            this.ssView_Sheet1.Columns.Get(3).Width = 70F;
            this.ssView_Sheet1.Columns.Get(4).Label = "입금일자";
            this.ssView_Sheet1.Columns.Get(4).Width = 70F;
            this.ssView_Sheet1.Columns.Get(5).Label = "일수";
            this.ssView_Sheet1.Columns.Get(5).StyleName = "Static644636455866503332153";
            this.ssView_Sheet1.Columns.Get(5).Width = 40F;
            this.ssView_Sheet1.Columns.Get(6).Label = "외래,입원";
            this.ssView_Sheet1.Columns.Get(6).StyleName = "Static518636455866503291914";
            this.ssView_Sheet1.Columns.Get(6).Width = 65F;
            this.ssView_Sheet1.Columns.Get(7).Label = "전월이월";
            this.ssView_Sheet1.Columns.Get(7).StyleName = "Static644636455866503332153";
            this.ssView_Sheet1.Columns.Get(7).Width = 97F;
            this.ssView_Sheet1.Columns.Get(8).Label = "당월 미수액";
            this.ssView_Sheet1.Columns.Get(8).StyleName = "Static644636455866503332153";
            this.ssView_Sheet1.Columns.Get(8).Width = 97F;
            this.ssView_Sheet1.Columns.Get(9).Label = "당월 입금액";
            this.ssView_Sheet1.Columns.Get(9).StyleName = "Static644636455866503332153";
            this.ssView_Sheet1.Columns.Get(9).Width = 97F;
            this.ssView_Sheet1.Columns.Get(10).Label = "당월 삭감액";
            this.ssView_Sheet1.Columns.Get(10).StyleName = "Static644636455866503332153";
            this.ssView_Sheet1.Columns.Get(10).Width = 97F;
            this.ssView_Sheet1.Columns.Get(11).Label = "당월 계산착오";
            this.ssView_Sheet1.Columns.Get(11).StyleName = "Static644636455866503332153";
            this.ssView_Sheet1.Columns.Get(11).Width = 97F;
            this.ssView_Sheet1.Columns.Get(12).Label = "당월 미수잔액";
            this.ssView_Sheet1.Columns.Get(12).StyleName = "Static644636455866503332153";
            this.ssView_Sheet1.Columns.Get(12).Width = 97F;
            this.ssView_Sheet1.Columns.Get(13).Label = "당월 반송액";
            this.ssView_Sheet1.Columns.Get(13).StyleName = "Static644636455866503332153";
            this.ssView_Sheet1.Columns.Get(13).Width = 97F;
            this.ssView_Sheet1.Columns.Get(14).Label = "비   고";
            this.ssView_Sheet1.Columns.Get(14).StyleName = "Static950636455866503412004";
            this.ssView_Sheet1.Columns.Get(14).Width = 211F;
            ...
            this.Name = "frmPmpaViewGiganDetail";
            this.Text = "미수금 상세내역";
            this.Load += new System.EventHandler(this.frmPmpaViewGiganDetail_Load);

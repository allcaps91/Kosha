...
namespace ComPmpaLibB
{
    ...
    /// File Name       : frmPapaViewReservedFailedSumView.cs
    /// Description     : 예약 부도자 마감 집계표
    /// Author          : 안정수
    /// Create Date     : 2017-07-06
    /// Update History  : 
    /// <history>       
    /// d:\psmh\OPD\jepres\jepres04.frm(FrmReservedFailedSumView) => frmPapaViewReservedFailedSumView.cs 으로 변경함
    /// </history>
    /// <seealso>
    /// d:\psmh\OPD\jepres\jepres04.frm(FrmReservedFailedSumView) 
    /// </seealso>
    /// </summary>
    public partial class frmPapaViewReservedFailedSumView : Form, MainFormMessage
    {
        ...
        public frmPapaViewReservedFailedSumView(MainFormMessage pform)
        {
            InitializeComponent();
        ...
        public frmPapaViewReservedFailedSumView()
        {
            InitializeComponent();
            setEvent();
        }

        public frmPapaViewReservedFailedSumView(string FstrPassId)
        {
            InitializeComponent();
            setEvent();
        ...
        void ePrint()
        {
            ...
            string strTitle = "(" + dtpDate.Text + ") 예약부도자 마감 집계표" + "\r\n\r\n";
            string strHeader = "";
            string strFooter = "";
            bool PrePrint = true;
            ...
            setMargin = new clsSpread.SpdPrint_Margin(80, 10, 50, 10, 75, 30);

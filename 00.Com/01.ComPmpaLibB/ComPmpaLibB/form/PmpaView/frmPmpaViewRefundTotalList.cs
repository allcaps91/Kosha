...
namespace ComPmpaLibB
{
    ...
    /// File Name       : frmPmpaViewRefundTotalList.cs
    /// Description     : 환불대상자 마감 집계표
    /// Author          : 안정수
    /// Create Date     : 2017-10-16
    /// Update History  : 
    /// <history>       
    /// d:\psmh\OPD\jepres\Frm환불대상자금액집계.frm(Frm환불대상자금액집계) => frmPmpaViewRefundTotalList.cs 으로 변경함
    /// </history>
    /// <seealso>
    /// d:\psmh\OPD\jepres\Frm환불대상자금액집계.frm(Frm환불대상자금액집계) => frmPmpaViewRefundTotalList.cs
    /// </seealso>
    /// </summary>
    public partial class frmPmpaViewRefundTotalList : Form, MainFormMessage
    {
        string mstrPassId = "";
        ...
        public frmPmpaViewRefundTotalList(MainFormMessage pform)
        {
            InitializeComponent();
        ...
        public frmPmpaViewRefundTotalList()
        {
            InitializeComponent();
            setEvent();
        }

        public frmPmpaViewRefundTotalList(string FstrPassId)
        {
            InitializeComponent();
            setEvent();
        ...
        void ePrint()
        {
            ...
            string strTitle = "(" + dtpDate.Text + ") 환불대상자 마감 집계표";
            string strHeader = "";
            string strFooter = "";
            bool PrePrint = true;
            ...
            setMargin = new clsSpread.SpdPrint_Margin(80, 10, 50, 10, 50, 0);
        ...
        void eGetData()
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count == 0)
                {
                    dt.Dispose();
                    dt = null;
                    ComFunc.MsgBox("해당하는 환불대상자가 없습니다.");
                    return;
                }

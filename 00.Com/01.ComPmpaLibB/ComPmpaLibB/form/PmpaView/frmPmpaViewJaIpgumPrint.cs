...
namespace ComPmpaLibB
{
    ...
    /// 
    /// </history>
    /// <seealso cref= "D:\psmh\misu\misuta.vbp\FrmIpgumPrint (FrmIpgumPrint.frm)>> frmPmpaViewJaIpgumPrint.cs 폼이름 재정의" />
    public partial class frmPmpaViewJaIpgumPrint : Form
    {
        ...
        public frmPmpaViewJaIpgumPrint()
        {
            InitializeComponent();
        }

        private void frmPmpaViewJaIpgumPrint_Load(object sender, EventArgs e)
        {
            ...
            dtpFDate.Value = Convert.ToDateTime(VB.Left(strDTP, 8) + "01");
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (strGelCode != strGelCode_NEW)
                    {
                        if (i != 0)
                        {
                            ...
                            ssView_Sheet1.Rows[nRow - 1].BackColor = Color.FromArgb(120, 240, 180);
                ...
                ssView_Sheet1.Rows[nRow - 1].BackColor = Color.FromArgb(80, 240, 180);
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            strHeader += CS.setSpdPrint_String("입금기간 : " + dtpFDate.Value.ToString("yyyy-MM-dd") + "=>" + dtpTDate.Value.ToString("yyyy-MM-dd"), new Font("굴림체", 10), clsSpread.enmSpdHAlign.Left, false, true);
            strHeader += CS.setSpdPrint_String("거 래 처 : " + cboGel.Text, new Font("굴림체", 10), clsSpread.enmSpdHAlign.Left, false, true);
            strHeader += CS.setSpdPrint_String("입금확인: 재무회계팀               (인)", new Font("굴림체", 10), clsSpread.enmSpdHAlign.Left, false, true);

            strFooter = CS.setSpdPrint_String(null, null, clsSpread.enmSpdHAlign.Center, true, true);
            

            setMargin = new clsSpread.SpdPrint_Margin(10, 10, 50, 10, 20, 10);
            setOption = new clsSpread.SpdPrint_Option(PrintOrientation.Auto, PrintType.All, 0, 0, true, false, true, true, false, false, false, 0.85f);

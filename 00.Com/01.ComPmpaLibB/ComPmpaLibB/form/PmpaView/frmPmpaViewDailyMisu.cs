...
namespace ComPmpaLibB
{
    ...
    /// File Name       : frmPmpaViewDailyMisu.cs
    /// Description     : 기타미수 계정별 집계표
    /// Author          : 박창욱
    ...
    /// 
    /// </history>
    /// <seealso cref= "\misu\misubs\misubs05.frm(FrmDailyMisu.frm) >> frmPmpaViewDailyMisu.cs 폼이름 재정의" />	
    public partial class frmPmpaViewDailyMisu : Form
    {
        clsSpread CS = new clsSpread();
        clsSpread.SpdPrint_Margin setMargin;
        clsSpread.SpdPrint_Option setOption;

        public frmPmpaViewDailyMisu()
        {
            InitializeComponent();
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                SQL = "";
                SQL = SQL + ComNum.VBLF + "SELECT a.IpdOpd, a.MisuGye, b.SuNameK,";
                SQL = SQL + ComNum.VBLF + "       COUNT(*) CNT, SUM(a.MisuAmt) MisuAmt";
                SQL = SQL + ComNum.VBLF + "  FROM " + ComNum.DB_PMPA + "MISU_BalEtcMisu a, " + ComNum.DB_PMPA + "BAS_SUN b ";
                ...
                SQL = SQL + ComNum.VBLF + "   AND a.MisuGye=b.SuNext(+) ";
                SQL = SQL + ComNum.VBLF + " GROUP BY a.IpdOpd,a.MisuGye,b.SuNameK ";
                SQL = SQL + ComNum.VBLF + " ORDER BY a.IpdOpd,a.MisuGye,b.SuNameK ";
                ...
                for (i = 0; i < nRead; i++)
                {
                    ...
                    ssView_Sheet1.Cells[nRow - 1, 3].Text = dt.Rows[i]["CNT"].ToString().Trim();
                    ssView_Sheet1.Cells[nRow - 1, 4].Text = VB.Val(dt.Rows[i]["MisuAmt"].ToString().Trim()).ToString("###,###,###,##0 ");
                ...
                ssView_Sheet1.Cells[nRow - 1, 4].Text = nTotAmt.ToString("###,###,###,##0 ");
        ...
        void Display_SubTotal(ref int nRow, ref double nSubAmt)
        {
            ...
            ssView_Sheet1.Cells[nRow - 1, 4].Text = nSubAmt.ToString("###,###,###,##0 ");
            nSubAmt = 0;
        ...
        private void frmPmpaViewDailyMisu_Load(object sender, EventArgs e)
        {

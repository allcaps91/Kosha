...
namespace ComPmpaLibB
{
    ...
    /// 
    public partial class frmPmpaMisuMast2TA : Form
    {
        #region 클래스 선언 및 etc....
        ...
        public frmPmpaMisuMast2TA()
        {
            InitializeComponent();
            setEvent();
        }

        public frmPmpaMisuMast2TA(MainFormMessage pform)
        {
            InitializeComponent();
        ...
        public frmPmpaMisuMast2TA(string argMisuGbn)
        {
        ...
        void eFormLoad(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //this.PreviewKeyDown += IpgoEntryForm_PreviewKeyDown;
        ...
        void Screen_Display(PsmhDb pDbCon, FarPoint.Win.Spread.FpSpread Spd1, FarPoint.Win.Spread.FpSpread Spd2)
        {
            ...
            for (i = 0; i < nREAD; i++)
            {
                ...
                Spd2.ActiveSheet.Cells[i, (int)clsComPmpaSpd.enmPmpaMisuMast2.Qty].Text = dt.Rows[i]["Qty"].ToString().Trim();
        ...
        void eSave(PsmhDb pDbCon, FpSpread spd2, int argRow, int argCol)
        {
            ...
            if (argCol == 1)
            {
                ...
                //strROWID = ssList2.ActiveSheet.Cells[argRow, (int)clsComPmpaSpd.enmPmpaMisuMast2.ROWID].Text.Trim();
                if (strData != "")
                {
            ...
            if(argCol == 6)
            {
                ...
                {
                    ssList2.ActiveSheet.SetActiveCell(argRow + 1, (int)clsComPmpaSpd.enmPmpaMisuMast2.A);
                }
            }

            if(argCol == 3 || argCol == 7 || argCol == 8)
            {
                ssList2.ActiveSheet.SetActiveCell(argRow, argCol + 1);
            }
        }
        ...
        private void IpgoEntryForm_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {            

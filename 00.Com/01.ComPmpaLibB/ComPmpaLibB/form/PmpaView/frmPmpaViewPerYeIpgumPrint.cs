...
namespace ComPmpaLibB
{
    ...
    /// File Name       : frmPmpaViewPerYeIpgumPrint.cs
    /// Description     : 예방접종 개인 미수 입금표
    /// Author          : 박창욱
    ...
    /// 
    /// </history>
    /// <seealso cref= "\misu\Frm접종미수입금표.FRM(Frm접종미수입금표.frm) >> frmPmpaViewPerYeIpgumPrint.cs 폼이름 재정의" />	
    public partial class frmPmpaViewPerYeIpgumPrint : Form
    {
        public frmPmpaViewPerYeIpgumPrint()
        {
            InitializeComponent();
        }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            strTitle = "예방접종 개인미수 입금표";

            strHeader = CS.setSpdPrint_String(strTitle, new Font("굴림체", 20, FontStyle.Bold), clsSpread.enmSpdHAlign.Center, false, true);

            setMargin = new clsSpread.SpdPrint_Margin(10, 10, 50, 10, 50, 10);
            setOption = new clsSpread.SpdPrint_Option(PrintOrientation.Portrait, PrintType.All, 0, 0, false, false, true, true, false, false, false, 0.9f);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "    AND GUBUN1 IN ('2')";
                SQL = SQL + ComNum.VBLF + "    AND SUBSTR(MISUDTL,4,2)='13'";
        ...
        private void frmPmpaViewPerYeIpgumPrint_Load(object sender, EventArgs e)
        {

...
namespace ComPmpaLibB
{
    ...
    /// File Name       : frmPmpaViewGyeIpgumReport2.cs
    ...
    /// 
    /// </history>
    /// <seealso cref= "\misu\MISUG306.FRM(FrmIpgumReport.frm) >> frmPmpaViewGyeIpgumReport2.cs 폼이름 재정의" />	
    public partial class frmPmpaViewGyeIpgumReport2 : Form
    {
        clsPmpaMisu cpm = new clsPmpaMisu();
        clsPmpaFunc cpf = new clsPmpaFunc();

        public frmPmpaViewGyeIpgumReport2()
        {
            InitializeComponent();
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "       MisuID, IpdOpd, TO_CHAR(MAX(Bdate),'YYYY-MM-DD') IDate,";
                ...
                //SQL = SQL + ComNum.VBLF + "  AND MISUID = '11486696' ";
                SQL = SQL + ComNum.VBLF + "GROUP BY WRTNO,Class,GelCode,IpdOpd,MisuID";
                SQL = SQL + ComNum.VBLF + "ORDER BY 2, 3, 4, 5, 6";
                SqlErr = clsDB.GetDataTable(ref dt, SQL, clsDB.DbCon);
        ...
        private void frmPmpaViewGyeIpgumReport2_Load(object sender, EventArgs e)
        {

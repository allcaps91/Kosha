...
{
    public partial class frmPmpaEntryResFail : Form
    {
        clsSpread CS = null;
        ...
        public frmPmpaEntryResFail()
        {
            InitializeComponent();
            setParam();
        }

        public frmPmpaEntryResFail(string ArgPtno = "", string ArgProgramID = "")
        {
            InitializeComponent();
            FstrPtno = ArgPtno;

...
{
    public partial class frmPmpaPoscoDetail : Form
    {
        ...
        private void Screen_Display()
        {
            ...
            try
            {
                ...
                SQL = "";
                SQL += ComNum.VBLF + " SELECT TO_CHAR(a.BDate,'YYYY-MM-DD') JepDate,b.Pano,a.WRTNO,b.SName,b.Sex,b.Bi ";
                SQL += ComNum.VBLF + "   FROM " + ComNum.DB_PMPA + "MISU_GAINSLIP A, "  + ComNum.DB_PMPA + "BAS_PATIENT B ";
                SQL += ComNum.VBLF + "  WHERE a.Pano=b.Pano(+) ";
                SQL += ComNum.VBLF + "    AND a.BDate >=TO_DATE('" + VB.Left(TxtSDate.Text, 8) + "01" + "','YYYY-MM-DD')   ";
                SQL += ComNum.VBLF + "    AND a.BDate <=TO_DATE('" + CF.READ_LASTDAY(clsDB.DbCon, TxtSDate.Text) + "','YYYY-MM-DD')   ";
                SQL += ComNum.VBLF + "    AND a.WRTNO >0 ";
                SQL += ComNum.VBLF + "  GROUP BY TO_CHAR(a.BDate,'YYYY-MM-DD') ,b.Pano,a.WRTNO,b.SName,b.Sex,b.Bi ";
                ...
                if (nRead > 0)
                {
                    for (i = 0; i < nRead; i++)
                    {
                        ...
                        SS1_Sheet1.Cells[nRow - 1, 0].Text = Dt.Rows[i]["PAno"].ToString().Trim();
                        ...
                        SS1_Sheet1.Cells[nRow - 1, 5].Text = Dt.Rows[i]["WRTNO"].ToString().Trim();
                ...
                Dt = null;
                Screen_Clear();
                READ_Posco_Exam("1","", TxtSDate.Text,0, chkSel.Checked);
        ...
        private void SS1_CellDoubleClick(object sender, CellClickEventArgs e)
        {
            ...
            //포스코 청구 상세내역
            READ_Posco_Exam("1", FstrPano, FstrJepDate, FnWRTNO, chkSel.Checked);
            lbl_Pos_Sts.Text = strSName + " " +  FstrPano + " " + FstrJepDate + "  고유번호: " + FnWRTNO.ToString();

...
{
    public partial class frmActingOld : Form, MainFormMessage
    {
        ...
        public frmActingOld(string strPtno, string strInDate, string strRoom, string strWard, string strDEPT, string strDrCode, string strEndDate, bool bolACT_OK)
        {
            InitializeComponent();
            FstrPtno = "";
            FstrInDate = "";
        ...
        public frmActingOld(string strPtno, string strInDate, string strDEPT, string strWard)
        {
            InitializeComponent();
            FstrPtno = strPtno;
        ...
        public frmActingOld(MainFormMessage pform)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        ssLine3_Sheet1.Cells[i, 8].Text = dt.Rows[i]["MONITOR"].ToString().Trim();
                        ssLine3_Sheet1.Cells[i, 9].Text = dt.Rows[i]["D_DATE"].ToString().Trim();
                        ssLine3_Sheet1.Cells[i, 10].Text = dt.Rows[i]["D_PART"].ToString().Trim();
                        ssLine3_Sheet1.Cells[i, 11].Text = dt.Rows[i]["D_STATUS"].ToString().Trim();
                        ssLine3_Sheet1.Cells[i, 12].Text = clsVbfunc.GetInSaName(clsDB.DbCon, dt.Rows[i]["ACTSABUN"].ToString().Trim());
                        ssLine3_Sheet1.Cells[i, 13].Text = dt.Rows[i]["ROWID"].ToString().Trim();
                        ssLine3_Sheet1.Cells[i, 14].Text = dt.Rows[i]["SEQNO"].ToString().Trim();

                        if (KEEP_DATA_BOLD(dt.Rows[i]["SEQNO"].ToString().Trim()) == true)
                        {
                            ssLine3_Sheet1.Rows.Get(i).Font = new Font("맑은 고딕", 10, FontStyle.Bold);
                        }
                    }
                }
                    ...
                    for (i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        for (h = 1; h <= nDiv; h++)
                        {
                            ...
                            if (Rs1.HasRows == true)
                            {
                                ...
                                ssM_Sheet1.Cells[ssM_Sheet1.RowCount - 1, 13 + h].Text = "NDC" + ComNum.VBLF + clsOpdNr.READ_INSA_NAME(clsDB.DbCon, Rs1.GetValue(0).ToString().Trim());
        ...
        private void READ_OCS_IORDER_MUTI(string argPTNO, string argBun)
        {
            ...
            try
            {
                ...
                SQL.AppendLine(" SELECT TO_CHAR(M.INDATE,'YYYY-MM-DD') INDATE, M.WARDCODE,   M.ROOMCODE,   M.PANO,       M.SNAME,      M.SEX,       ");
                ...
                else
                {
                    ...
                    SQL.AppendLine(" 		         AND PANO = '" + argPTNO + "')) M,                 ");
                }
                ...
                if (dt.Rows.Count > 0)
                {
                    for (i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        for (h = 1; h <= nDiv; h++)
                        {
                            ...
                            SQL.Clear();
                            SQL.AppendLine(" SELECT ");
                            SQL.AppendLine("    A.NURSEID, B.KORNAME AS ACTUSER ");
                                ...
                                if (dt.Rows.Count > 0)
                                {
                                    if (VB.Val(dt.Rows[0]["GBDIV"].ToString().Trim()) == 1)
                                    {
                                        if (ssM_Sheet1.Cells[i, 0].Text.Trim() == "DC")
                                        {
                                            ...
                                            dt.Dispose();
                                            dt = null;
                                            ComFunc.MsgBox("QD 처방은 의사가 DC 한경우 액팅 할 수 없습니다.  고도화 개발팀 8719 로 연락 주세요.");
                                            return;
                                        }
                                    }
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (cboWard.Text.Trim() == "ER")
                {
                    ...
                    SQL = SQL + ComNum.VBLF + " WHERE M.BDATE =TO_DATE('" + strToDate + "','YYYY-MM-DD') ";
                    SQL = SQL + ComNum.VBLF + "   AND M.DEPTCODE ='ER'  ";
                    SQL = SQL + ComNum.VBLF + "   AND M.PANO=P.PANO(+) ";
                    SQL = SQL + ComNum.VBLF + "   AND M.DRCODE=D.DRCODE(+) ";
            ...
            try
            {
                ...
                for (i = 0; i < ssM_Sheet1.RowCount; i++)
                {
                    ...
                    if (dblDQty != 0)
                    {
                        ...
                        SQL = "";
                        SQL = "UPDATE KOSMOS_OCS.OCS_IORDER  SET DCDIV = " + dblDQty + "";
                        SQL = SQL + ComNum.VBLF + " WHERE ROWID = '" + strROWID + "' ";
        ...
        private bool DELETE_NDC(ref string SQL, ref string SqlErr, string strDate
            , bool mbolD, string mstrROWID, string mstrBun, string mstrNurseID, double mdblSQty, string mstrQty, string mstrDQty, string mstrORDERCODE, double mdblCheckQty)
        {
            bool RtnVal = false;
            int intRowAffected = 0;
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 0].Text = Convert.ToString(i + 1);
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 1].Text = dt.Rows[i]["STATUS"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 2].Text = Convert.ToDateTime(strACTDATE).ToString("MM/dd HH:mm").Replace("-", "/");
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 3].Text = dt.Rows[i]["DUTY"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 4].Text = dt.Rows[i]["LOCATE"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 5].Text = dt.Rows[i]["MONITOR1"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 6].Text = dt.Rows[i]["MONITOR2"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 7].Text = dt.Rows[i]["MONITOR3"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 8].Text = dt.Rows[i]["MONITOR4"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 9].Text = dt.Rows[i]["MONITOR5"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 10].Text = VB.Left(dt.Rows[i]["D_DATE"].ToString().Trim(), 10);
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 11].Text = VB.Right(dt.Rows[i]["D_DATE"].ToString().Trim(), 5);
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 12].Text = dt.Rows[i]["D_PART"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 13].Text = dt.Rows[i]["D_STATUS1"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 14].Text = dt.Rows[i]["D_STATUS2"].ToString().Trim();
                        ...
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 15].Text = Convert.ToDateTime(strStartDate).ToString("MM/dd HH:mm").Replace("-", "/");
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 16].Text = Convert.ToString(VB.DateDiff("d", Convert.ToDateTime(VB.Left(strStartDate, 10)), Convert.ToDateTime(strDate)) + 1);
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 19].Text = dt.Rows[i]["ROWID"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 20].Text = dt.Rows[i]["SEQNO"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 23].Text = dt.Rows[i]["EMRNO"].ToString().Trim();
                        ssLine2_Sheet1.Cells[ssLine2_Sheet1.RowCount - 1, 24].Text = dt.Rows[i]["PART"].ToString().Trim();
                    }
                }
        ...
        private void DRAW_SSLINE2(int intRow)
        {
            ...
            ssLine2_Sheet1.Cells[intRow, 0].CellType = CellText;
            ssLine2_Sheet1.Cells[intRow, 0].HorizontalAlignment = CellHorizontalAlignment.Center;
            ssLine2_Sheet1.Cells[intRow, 0].VerticalAlignment = CellVerticalAlignment.Center;

            ssLine2_Sheet1.Cells[intRow, 0].Text = Convert.ToString(intRow - 1);
            ...
            ssLine2_Sheet1.Cells[intRow, 4].CellType = CellText;
            ssLine2_Sheet1.Cells[intRow, 4].HorizontalAlignment = CellHorizontalAlignment.Left;
            ssLine2_Sheet1.Cells[intRow, 4].VerticalAlignment = CellVerticalAlignment.Center;
            ...
            //SSLine2.TypeDateCentury = True
            //SSLine2.TypeEllipses = False

            ssLine2_Sheet1.Cells[intRow, 10].CellType = CellDate;
            ssLine2_Sheet1.Cells[intRow, 10].HorizontalAlignment = CellHorizontalAlignment.Center;
            ssLine2_Sheet1.Cells[intRow, 10].VerticalAlignment = CellVerticalAlignment.Center;

            //CellDate.TimeSeparator = ":";
            CellTime.DateTimeFormat = DateTimeFormat.UserDefined;
            CellTime.UserDefinedFormat = "HH:mm";
            //SSLine2.TypeDateMin = "01011990"
            //SSLine2.TypeDateMax = "12313000"
            //SSLine2.TypeDateCentury = True
            //SSLine2.TypeEllipses = False
            ssLine2_Sheet1.Cells[intRow, 11].CellType = CellTime;
            ssLine2_Sheet1.Cells[intRow, 11].HorizontalAlignment = CellHorizontalAlignment.Center;
            ssLine2_Sheet1.Cells[intRow, 11].VerticalAlignment = CellVerticalAlignment.Center;

            CellCbo.Editable = true;
            ssLine2_Sheet1.Cells[intRow, 12].CellType = CellCbo;
            clsSpread.gSpreadComboDataSetEx(ssLine2, intRow, 12, intRow, 12, VB.Split("투명필름//멸균거즈//멸균거즈+투명필름", "//"));
            ssLine2_Sheet1.Cells[intRow, 12].HorizontalAlignment = CellHorizontalAlignment.Left;
            ssLine2_Sheet1.Cells[intRow, 12].VerticalAlignment = CellVerticalAlignment.Center;

            CellCbo.Editable = true;
            ssLine2_Sheet1.Cells[intRow, 13].CellType = CellCbo;
            clsSpread.gSpreadComboDataSetEx(ssLine2, intRow, 13, intRow, 13, VB.Split("Y//N", "//"));
            ssLine2_Sheet1.Cells[intRow, 13].HorizontalAlignment = CellHorizontalAlignment.Left;
            ssLine2_Sheet1.Cells[intRow, 13].VerticalAlignment = CellVerticalAlignment.Center;

            CellCbo.Editable = true;
            ssLine2_Sheet1.Cells[intRow, 14].CellType = CellCbo;
            clsSpread.gSpreadComboDataSetEx(ssLine2, intRow, 14, intRow, 14, VB.Split("양호//불량", "//"));
            ssLine2_Sheet1.Cells[intRow, 14].HorizontalAlignment = CellHorizontalAlignment.Left;
            ssLine2_Sheet1.Cells[intRow, 14].VerticalAlignment = CellVerticalAlignment.Center;
            ...
            ssLine2_Sheet1.Cells[intRow, 17].CellType = CellBtn1;
            ssLine2_Sheet1.Cells[intRow, 18].CellType = CellBtn2;
            ssLine2_Sheet1.Cells[intRow, 21].CellType = CellBtn3;
            ssLine2_Sheet1.Cells[intRow, 22].CellType = CellBtn4;

            ssLine2_Sheet1.Cells[intRow, 23].CellType = CellText;
            ssLine2_Sheet1.Cells[intRow, 23].HorizontalAlignment = CellHorizontalAlignment.Left;
            ssLine2_Sheet1.Cells[intRow, 23].VerticalAlignment = CellVerticalAlignment.Center;
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        ssLineP2_Sheet1.Cells[ssLineP2_Sheet1.RowCount - 1, 12].Text = Convert.ToDateTime(strStartDate).ToString("MM/dd HH:mm").Replace("-", "/");
                        ssLineP2_Sheet1.Cells[ssLineP2_Sheet1.RowCount - 1, 13].Text = Convert.ToString(VB.DateDiff("d", Convert.ToDateTime(VB.Left(strStartDate, 10)), Convert.ToDateTime(strDate)) + 1);
                        ssLineP2_Sheet1.Cells[ssLineP2_Sheet1.RowCount - 1, 16].Text = dt.Rows[i]["ROWID"].ToString().Trim();
                        ssLineP2_Sheet1.Cells[ssLineP2_Sheet1.RowCount - 1, 17].Text = dt.Rows[i]["SEQNO"].ToString().Trim();
                        ssLineP2_Sheet1.Cells[ssLineP2_Sheet1.RowCount - 1, 20].Text = dt.Rows[i]["EMRNO"].ToString().Trim();
                    }
                }
        ...
        private void DRAW_SSLINEP2(int intRow)
        {
            ...
            ssLineP2_Sheet1.Cells[intRow, 12].HorizontalAlignment = CellHorizontalAlignment.Center;
            ssLineP2_Sheet1.Cells[intRow, 12].VerticalAlignment = CellVerticalAlignment.Center;

            ssLineP2_Sheet1.Cells[intRow, 13].CellType = CellText;
            ssLineP2_Sheet1.Cells[intRow, 13].HorizontalAlignment = CellHorizontalAlignment.Center;
            ssLineP2_Sheet1.Cells[intRow, 13].VerticalAlignment = CellVerticalAlignment.Center;

            ssLineP2_Sheet1.Cells[intRow, 14].CellType = CellBtn1;
            ssLineP2_Sheet1.Cells[intRow, 15].CellType = CellBtn2;
            ssLineP2_Sheet1.Cells[intRow, 18].CellType = CellBtn3;
            ssLineP2_Sheet1.Cells[intRow, 19].CellType = CellBtn4;

            ssLineP2_Sheet1.Cells[intRow, 20].CellType = CellText;
            ssLineP2_Sheet1.Cells[intRow, 20].HorizontalAlignment = CellHorizontalAlignment.Left;
            ssLineP2_Sheet1.Cells[intRow, 20].VerticalAlignment = CellVerticalAlignment.Center;
        ...
        private void ssLine2_ButtonClicked(object sender, EditorNotifyEventArgs e)
        {
            ...
            switch (e.Column)
            {
                ...
                case 9:
                    if (e.Column == 9)
                    {
                        ...
                        ssLine2_Sheet1.Cells[e.Row, 5].Value = false;
                        ssLine2_Sheet1.Cells[e.Row, 6].Value = false;
                        ssLine2_Sheet1.Cells[e.Row, 7].Value = false;
                        ssLine2_Sheet1.Cells[e.Row, 8].Value = false;
                    ...
                    else
                    {
                        ...
                        ssLine2_Sheet1.Cells[e.Row, 9].Value = false;
            ...
            if (e.Column == 21)
            {
                ...
                strROWID = ssLine2_Sheet1.Cells[e.Row, 19].Text.Trim();
            ...
            strROWID = ssLine2_Sheet1.Cells[e.Row, 19].Text.Trim();
            Line1Act.SEQNO = ssLine2_Sheet1.Cells[e.Row, 20].Text.Trim();
        ...
        private void INSERT_LINE1()
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + " EMRNO, SEQNO, USEDATE, INSERT_BUSE, DUTY) VALUES ( ";
        ...
        private bool SetSSLine2(string strROWID, int intRow)
        {
            ...
            try
            {
                ...
                Line1Act.MON1 = (Convert.ToBoolean(ssLine2_Sheet1.Cells[intRow, 5].Value) == true ? "1" : "0");
                Line1Act.MON2 = (Convert.ToBoolean(ssLine2_Sheet1.Cells[intRow, 6].Value) == true ? "1" : "0");
                Line1Act.MON3 = (Convert.ToBoolean(ssLine2_Sheet1.Cells[intRow, 7].Value) == true ? "1" : "0");
                Line1Act.MON4 = (Convert.ToBoolean(ssLine2_Sheet1.Cells[intRow, 8].Value) == true ? "1" : "0");
                Line1Act.MON5 = (Convert.ToBoolean(ssLine2_Sheet1.Cells[intRow, 9].Value) == true ? "1" : "0");
                Line1Act.D_DATE = ssLine2_Sheet1.Cells[intRow, 10].Text.Trim();
                Line1Act.D_TIME = ssLine2_Sheet1.Cells[intRow, 11].Text.Trim();
                Line1Act.D_PART = ssLine2_Sheet1.Cells[intRow, 12].Text.Trim();
                Line1Act.D_MON1 = ssLine2_Sheet1.Cells[intRow, 13].Text.Trim();
                Line1Act.D_MON2 = ssLine2_Sheet1.Cells[intRow, 14].Text.Trim();
                ...
                Line1Act.USEDATE = ssLine2_Sheet1.Cells[intRow, 16].Text.Trim();
        ...
        private void ssLine3_CellDoubleClick(object sender, CellClickEventArgs e)
        {
            ...
            READ_ACT_LINE_MODIFY(ssLine3_Sheet1.Cells[e.Row, 13].Text.Trim());
        }
        ...
        private void READ_ACT_LINE_MODIFY(string argROWID)
        {
            ...
            panActModify.Location = new Point(290, 484);
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    ssLineModify_Sheet1.Cells[2, 4].Text = dt.Rows[0]["LOCATE"].ToString().Trim();
                    ssLineModify_Sheet1.Cells[2, 5].Value = (dt.Rows[0]["MONITOR1"].ToString().Trim() == "1" ? true : false);
                    ssLineModify_Sheet1.Cells[2, 6].Value = (dt.Rows[0]["MONITOR2"].ToString().Trim() == "1" ? true : false);
                    ssLineModify_Sheet1.Cells[2, 7].Value = (dt.Rows[0]["MONITOR3"].ToString().Trim() == "1" ? true : false);
                    ssLineModify_Sheet1.Cells[2, 8].Value = (dt.Rows[0]["MONITOR4"].ToString().Trim() == "1" ? true : false);
                    ssLineModify_Sheet1.Cells[2, 9].Value = (dt.Rows[0]["MONITOR5"].ToString().Trim() == "1" ? true : false);
                    ssLineModify_Sheet1.Cells[2, 10].Text = VB.Left(dt.Rows[0]["D_DATE"].ToString().Trim(), 10);
                    ssLineModify_Sheet1.Cells[2, 11].Text = VB.Right(dt.Rows[0]["D_DATE"].ToString().Trim(), 5);
                    ssLineModify_Sheet1.Cells[2, 12].Text = dt.Rows[0]["D_PART"].ToString().Trim();
                    ssLineModify_Sheet1.Cells[2, 13].Text = dt.Rows[0]["D_STATUS1"].ToString().Trim();
                    ssLineModify_Sheet1.Cells[2, 14].Text = dt.Rows[0]["D_STATUS2"].ToString().Trim();
                    ...
                    ssLineModify_Sheet1.Cells[2, 15].Text = Convert.ToDateTime(strStartDate).ToString("MM/dd").Replace("-", "/");

                    if (dt.Rows[0]["STATUS"].ToString().Trim() == "삽입")
                    {
                        ssLineModify_Sheet1.Cells[2, 16].Text = "";
                    }
                    else
                    {
                        ssLineModify_Sheet1.Cells[2, 17].Text = Convert.ToString(VB.DateDiff("d", VB.Left(strStartDate, 10), strACTDATE) + 1);
                    }

                    ssLineModify_Sheet1.Cells[2, 17].Text = dt.Rows[0]["ROWID"].ToString().Trim();
                    ssLineModify_Sheet1.Cells[2, 18].Text = dt.Rows[0]["SEQNO"].ToString().Trim();
                    ssLineModify_Sheet1.Cells[2, 19].Text = dt.Rows[0]["EMRNO"].ToString().Trim();
                    ssLineModify_Sheet1.Cells[2, 20].Text = dt.Rows[0]["PART"].ToString().Trim();
                }
        ...
        private void ssLineP2_ButtonClicked(object sender, EditorNotifyEventArgs e)
        {
            ...
            if (e.Column == 18)
            {
                ...
                strROWID = ssLineP2_Sheet1.Cells[e.Row, 16].Text.Trim();
            ...
            strROWID = ssLineP2_Sheet1.Cells[e.Row, 16].Text.Trim();
            Line1Act.SEQNO = ssLineP2_Sheet1.Cells[e.Row, 17].Text.Trim();
        ...
        private bool SetLine1Act(string strROWID, int intRow)
        {
            ...
            try
            {
                ...
                Line1Act.USEDATE = ssLineP2_Sheet1.Cells[intRow, 13].Text.Trim();
        ...
        private void READ_ACT_LINE_MODIFY2(string argROWID)
        {
            ...
            panActModify2.Location = new Point(306, 484);
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    ssLineModify2_Sheet1.Cells[2, 12].Text = Convert.ToDateTime(strStartDate).ToString("MM/dd").Replace("-", "/");

                    if (dt.Rows[0]["STATUS"].ToString().Trim() == "삽입")
                    {
                        ssLineModify2_Sheet1.Cells[2, 13].Text = "";
                    }
                    else
                    {
                        ssLineModify2_Sheet1.Cells[2, 13].Text = Convert.ToString(VB.DateDiff("d", VB.Left(strStartDate, 10), strACTDATE) + 1);
                    }

                    ssLineModify2_Sheet1.Cells[2, 14].Text = dt.Rows[0]["ROWID"].ToString().Trim();
                    ssLineModify2_Sheet1.Cells[2, 15].Text = dt.Rows[0]["SEQNO"].ToString().Trim();
                    ssLineModify2_Sheet1.Cells[2, 16].Text = dt.Rows[0]["EMRNO"].ToString().Trim();
                }
        ...
        private void btnChangeAct_Click(object sender, EventArgs e)
        {
            ...
            strROWID = ssLineModify_Sheet1.Cells[2, 17].Text.Trim();
            ...
            try
            {
                ...
                Line1Act.MON1 = (Convert.ToBoolean(ssLineModify_Sheet1.Cells[2, 5].Value) == true ? "1" : "0");
                Line1Act.MON2 = (Convert.ToBoolean(ssLineModify_Sheet1.Cells[2, 6].Value) == true ? "1" : "0");
                Line1Act.MON3 = (Convert.ToBoolean(ssLineModify_Sheet1.Cells[2, 7].Value) == true ? "1" : "0");
                Line1Act.MON4 = (Convert.ToBoolean(ssLineModify_Sheet1.Cells[2, 8].Value) == true ? "1" : "0");
                Line1Act.MON5 = (Convert.ToBoolean(ssLineModify_Sheet1.Cells[2, 9].Value) == true ? "1" : "0");
                Line1Act.D_DATE = ssLineModify_Sheet1.Cells[2, 10].Text.Trim();
                Line1Act.D_TIME = ssLineModify_Sheet1.Cells[2, 11].Text.Trim();
                Line1Act.D_PART = ssLineModify_Sheet1.Cells[2, 12].Text.Trim();
                Line1Act.D_MON1 = ssLineModify_Sheet1.Cells[2, 13].Text.Trim();
                Line1Act.D_MON2 = ssLineModify_Sheet1.Cells[2, 14].Text.Trim();
                strStartDate = READ_STARTDATE(Line1Act.SEQNO);
                Line1Act.STARTDATE = VB.Left(strStartDate, 10);
                Line1Act.STARTTIME = VB.Right(strStartDate, 5);

                Line1Act.USEDATE = ssLineModify_Sheet1.Cells[2, 16].Text.Trim();
        ...
        private void btnChangeAct2_Click(object sender, EventArgs e)
        {
            ...
            strROWID = ssLineModify2_Sheet1.Cells[2, 14].Text.Trim();
            ...
            try
            {
                ...
                Line1Act.STARTDATE = VB.Left(strStartDate, 10);
                Line1Act.STARTTIME = VB.Right(strStartDate, 5);
                Line1Act.USEDATE = ssLineModify2_Sheet1.Cells[2, 13].Text.Trim();

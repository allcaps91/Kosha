...
namespace ComNurLibB
{
    ...
    public partial class frmEmlPatientList03 : Form
    {
        string strDTP = ComFunc.FormatStrToDate(ComQuery.CurrentDateTime(clsDB.DbCon, "D"), "D");
        //string FstrREAD = "";

        public frmEmlPatientList03()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        SS1_Sheet1.Cells[k, 20].Text = dt.Rows[i]["WOUTDATE"].ToString().Trim();
                        SS1_Sheet1.Cells[k, 21].Text = dt.Rows[i]["WOUTTIME"].ToString().Trim();

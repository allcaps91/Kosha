...
namespace ComNurLibB
{
    ...
    /// File Name       : frmNrstdEduManageViewOld.cs
    /// Description     : 개인별 교육내역 조회 화면
    /// Author          : 안정수
    /// Create Date     : 2018-02-01
    /// Update History  : 
    /// </summary>
    /// <history>  
    /// 기존 Frm교육관리조회1.frm(Frm교육관리조회1) 폼 frmNrstdEduManageViewOld.cs 으로 변경함
    /// </history>
    /// <seealso cref= "\nurse\nrstd\Frm교육관리조회1.frm(Frm교육관리조회1) >> frmNrstdEduManageViewOld.cs 폼이름 재정의" />
    public partial class frmNrstdEduManageViewOld : Form, MainFormMessage
    {
        #region 클래스 선언 및 etc....
        ...
        public frmNrstdEduManageViewOld(MainFormMessage pform)
        {
            InitializeComponent();
        ...
        public frmNrstdEduManageViewOld()
        {
            InitializeComponent();
            setEvent();
        }
        ...
        void ePrint()
        {
            ...
            strSubTitle += "\r\n" +  "인쇄일자: " + dtpPDate.Text + " ~ " + clsPublic.GstrSysTime;
        ...
        void eGetData2()
        {
            ...
            SQL += ComNum.VBLF + "  JIKJONG,EDUJONG,EDUNAME, ";
            ...
            SQL += ComNum.VBLF + "WHERE 1=1";
            SQL += ComNum.VBLF + "      AND ((GUBUN = '2' AND SIGN = '1') OR Gubun ='1')";            
            SQL += ComNum.VBLF + "      AND SDate >= TO_DATE('" + dtpFDate.Text + "','YYYY-MM-DD')";
            SQL += ComNum.VBLF + "      AND SDate <= TO_DATE('" + dtpTDate.Text + "','YYYY-MM-DD')";
            ...
            if (cboBuse.Text != "" && cboBuse.SelectedIndex != 0)
            {
                SQL += ComNum.VBLF + "  AND BuCode ='" + VB.Pstr(cboBuse.SelectedItem.ToString(), ".", 2) + "'";
            }
            ...
            if (cboManJong.Text.Trim() != "" && cboManJong.SelectedIndex != 0)
            {
                SQL += ComNum.VBLF + "  AND ManJong ='" + VB.Left(cboManJong.SelectedItem.ToString().Trim(), 2) + "'";
            }
            ...
            if(dt.Rows.Count > 0)
            {
                ssList2.ActiveSheet.Rows.Count = dt.Rows.Count;
                nREAD = dt.Rows.Count;

                for(i = 0; i < nREAD; i++)
                {
                    ssList2.ActiveSheet.Cells[i, 0].Text = dt.Rows[i]["FRDATE"].ToString().Trim();
                    ssList2.ActiveSheet.Cells[i, 1].Text = READ_필수여부(dt.Rows[i]["EduJong"].ToString().Trim());

                    switch (Convert.ToInt32(VB.Val(dt.Rows[i]["EduJong"].ToString().Trim())))
                    {
                        case 1:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "병동교육";
                            break;

                        case 2:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "감염교육";
                            break;

                        case 3:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "QI교육";
                            break;

                        case 4:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "CS교육";
                            break;

                        case 5:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "CPR교육";
                            break;

                        case 6:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "학술강좌";
                            break;

                        case 7:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "간호부주최 직무교육";
                            break;

                        case 8:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "전직원교육";
                            break;

                        case 9:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "특강(간협)";
                            break;

                        case 10:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "연수교육";
                            break;

                        case 11:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "10대질환";
                            break;

                        case 12:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "보수교육";
                            break;

                        case 13:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "기타Report";
                            break;

                        case 14:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "강사활동(교육)";
                            break;

                        case 15:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "프리셉터교육";
                            break;

                        case 16:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "Cyber교육";
                            break;

                        case 17:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "승진자교육";
                            break;

                        default:
                            ssList2.ActiveSheet.Cells[i, 3].Text = "기타";
                            break;
                    }

                    ssList2.ActiveSheet.Cells[i, 3].Text = dt.Rows[i]["EduName"].ToString().Trim();
                    ssList2.ActiveSheet.Cells[i, 4].Text = dt.Rows[i]["Man"].ToString().Trim();

                    if(dt.Rows[i]["Place"].ToString().Trim() != "")
                    {
                        ssList2.ActiveSheet.Cells[i, 5].Text = dt.Rows[i]["Place"].ToString().Trim();
                    }

                    switch (dt.Rows[i]["OptTime"].ToString().Trim())
                    {
                        case "0":
                            ssList2.ActiveSheet.Cells[i, 7].Text = "10분";
                            nSum = nSum + 10;
                            break;

                        case "1":
                            ssList2.ActiveSheet.Cells[i, 7].Text = "30분내";
                            nSum = nSum + 30;
                            break;

                        case "2":
                            ssList2.ActiveSheet.Cells[i, 7].Text = "1시간내";
                            nSum = nSum + 60;
                            break;

                        case "3":
                            ssList2.ActiveSheet.Cells[i, 7].Text = "90분";
                            nSum = nSum + 90;
                            break;

                        case "4":
                            ssList2.ActiveSheet.Cells[i, 7].Text = "2시간";
                            nSum = nSum + 180;
                            break;
                    }
                }
                ...
                //칼럼이 7개 뿐임...
                ssList2.ActiveSheet.Rows.Count += 1;
                ssList2.ActiveSheet.Cells[ssList2.ActiveSheet.Rows.Count - 1, 7].Text = nSum.ToString();
            }
        ...
        public string READ_필수여부(string ArgCode)
        {
            string rtnVal = "";
            DataTable dt2 = null;
            ...
            SQL = "";
            SQL += ComNum.VBLF + "SELECT ";
            SQL += ComNum.VBLF + "  GUBUNA";
            SQL += ComNum.VBLF + "FROM " + ComNum.DB_PMPA + "NUR_EDU_CODE_SET";
            SQL += ComNum.VBLF + "WHERE SUBSTR(CODE, 1, 2) = '" + ComFunc.SetAutoZero(ArgCode, 2) + "' ";
            ...
            if(dt2.Rows.Count > 0)
            {
                if(dt2.Rows[0]["GUBUNA"].ToString().Trim() == "1")
                {
                    rtnVal = "필수";
                }
            }

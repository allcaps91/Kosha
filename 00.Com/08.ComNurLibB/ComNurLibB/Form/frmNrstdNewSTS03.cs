...
namespace ComNurLibB
{
    ...
    /// 
    /// </history>
    /// <seealso cref= "d:\psmh\nurse\nrstd\Frm통계3New.frm >> frmNrstdNewSTS03.cs 폼이름 재정의" />


    public partial class frmNrstdNewSTS03 : Form
    {
...
new FarPoint.Win.ComplexBorderSide(FarPoint.Win.ComplexBorderSideStyle.None), false, false);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (OptTong0.Checked == true)
                {
                    ...
                    SQL = SQL + ComNum.VBLF + "     SELECT   TO_CHAR(TIME2, 'YYYY-MM-DD') TIME1, DEPTCODE DEPTCODE1, COUNT(PANO) CNT";
                    ...
                    SQL = SQL + ComNum.VBLF + "   GROUP BY DEPTCODE, TIME2) A,";
                    SQL = SQL + ComNum.VBLF + "     (SELECT   TO_CHAR(TIME2, 'YYYY-MM-DD') TIME1, DEPTCODE DEPTCODE1, COUNT(PANO) CNT";
                    SQL = SQL + ComNum.VBLF + "    From KOSMOS_PMPA.NUR_QI_DATA_LIST";
                    SQL = SQL + ComNum.VBLF + "   WHERE CODE = '52001'";
                    ...
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 >= TO_DATE('" + VB.Left(strYYMM, 4) + "-" + VB.Mid(strYYMM, 5, 2) + "-01','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 <= TO_DATE('" + CF.READ_LASTDAY(clsDB.DbCon, (VB.Left(strYYMM, 4) + "-" + VB.Mid(strYYMM, 5, 2)) + "-01") + "','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "   GROUP BY DEPTCODE, TIME2) B,";
                    SQL = SQL + ComNum.VBLF + "     (SELECT   TO_CHAR(TIME2, 'YYYY-MM-DD') TIME1, DEPTCODE DEPTCODE1, COUNT(PANO) CNT";
                    SQL = SQL + ComNum.VBLF + "    From KOSMOS_PMPA.NUR_QI_DATA_LIST";
                    SQL = SQL + ComNum.VBLF + "   WHERE CODE = '52001'";
                    ...
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 >= TO_DATE('" + VB.Left(strYYMM, 4) + "-" + VB.Mid(strYYMM, 5, 2) + "-01','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 <= TO_DATE('" + CF.READ_LASTDAY(clsDB.DbCon, (VB.Left(strYYMM, 4) + "-" + VB.Mid(strYYMM, 5, 2)) + "-01") + "','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "   GROUP BY DEPTCODE, TIME2) C,";
                    SQL = SQL + ComNum.VBLF + "     (SELECT   TO_CHAR(TIME2, 'YYYY-MM-DD') TIME1, DEPTCODE DEPTCODE1, COUNT(PANO) CNT";
                    SQL = SQL + ComNum.VBLF + "    From KOSMOS_PMPA.NUR_QI_DATA_LIST";
                    SQL = SQL + ComNum.VBLF + "   WHERE CODE = '52001'";
                    ...
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 >= TO_DATE('" + VB.Left(strYYMM, 4) + "-" + VB.Mid(strYYMM, 5, 2) + "-01','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 <= TO_DATE('" + CF.READ_LASTDAY(clsDB.DbCon, (VB.Left(strYYMM, 4) + "-" + VB.Mid(strYYMM, 5, 2)) + "-01") + "','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "   GROUP BY DEPTCODE, TIME2) D,";
                    SQL = SQL + ComNum.VBLF + "   ( SELECT TO_CHAR(ACTDATE, 'YYYY-MM-DD') ACTDATE, DEPTCODE DEPTCODE2, SUM(CNT51 + CNT52) SIL";
                    ...
                    SQL = SQL + ComNum.VBLF + "   GROUP BY DEPTCODE, ACTDATE) E";
                ...
                else if (OptTong1.Checked == true)
                {
                    SQL = " SELECT E.DEPTCODE2, E.ACTDATE, E.SIL, A.CNT CNT1, B.CNT CNT2, C.CNT CNT3, D.CNT CNT4";
                    SQL = SQL + ComNum.VBLF + "   FROM (";
                    SQL = SQL + ComNum.VBLF + "     SELECT   TO_CHAR(TIME2, 'YYYYMM') TIME1, DEPTCODE DEPTCODE1, COUNT(PANO) CNT";
                    SQL = SQL + ComNum.VBLF + "    From KOSMOS_PMPA.NUR_QI_DATA_LIST";
                    SQL = SQL + ComNum.VBLF + "   WHERE CODE = '52001'";
                    SQL = SQL + ComNum.VBLF + "     AND ITEM = '1'";
                    ...
                    SQL = SQL + ComNum.VBLF + "   GROUP BY DEPTCODE, TO_CHAR(TIME2, 'YYYYMM')) A,";
                    SQL = SQL + ComNum.VBLF + "     (SELECT   TO_CHAR(TIME2, 'YYYYMM') TIME1, DEPTCODE DEPTCODE1, COUNT(PANO) CNT";
                    SQL = SQL + ComNum.VBLF + "    From KOSMOS_PMPA.NUR_QI_DATA_LIST";
                    SQL = SQL + ComNum.VBLF + "   WHERE CODE = '52001'";
                    SQL = SQL + ComNum.VBLF + "     AND ITEM = '2'";
                    ...
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 >= TO_DATE('" + ComboYear.Text + "-01-01','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 <= TO_DATE('" + ComboYear.Text + "-12-31','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "   GROUP BY DEPTCODE, TO_CHAR(TIME2, 'YYYYMM')) B,";
                    SQL = SQL + ComNum.VBLF + "     (SELECT   TO_CHAR(TIME2, 'YYYYMM') TIME1, DEPTCODE DEPTCODE1, COUNT(PANO) CNT";
                    SQL = SQL + ComNum.VBLF + "    From KOSMOS_PMPA.NUR_QI_DATA_LIST";
                    SQL = SQL + ComNum.VBLF + "   WHERE CODE = '52001'";
                    SQL = SQL + ComNum.VBLF + "     AND ITEM = '3'";
                    ...
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 >= TO_DATE('" + ComboYear.Text + "-01-01','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 <= TO_DATE('" + ComboYear.Text + "-12-31','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "   GROUP BY DEPTCODE, TO_CHAR(TIME2, 'YYYYMM')) C,";
                    SQL = SQL + ComNum.VBLF + "     (SELECT   TO_CHAR(TIME2, 'YYYYMM') TIME1, DEPTCODE DEPTCODE1, COUNT(PANO) CNT";
                    SQL = SQL + ComNum.VBLF + "    From KOSMOS_PMPA.NUR_QI_DATA_LIST";
                    SQL = SQL + ComNum.VBLF + "   WHERE CODE = '52001'";
                    SQL = SQL + ComNum.VBLF + "     AND ITEM = '4'";
                    ...
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 >= TO_DATE('" + ComboYear.Text + "-01-01','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "     AND TIME2 <= TO_DATE('" + ComboYear.Text + "-12-31','YYYY-MM-DD')";
                    SQL = SQL + ComNum.VBLF + "   GROUP BY DEPTCODE, TO_CHAR(TIME2, 'YYYYMM')) D,";
                    SQL = SQL + ComNum.VBLF + "   ( SELECT TO_CHAR(ACTDATE, 'YYYYMM') ACTDATE, DEPTCODE DEPTCODE2, SUM(CNT51 + CNT52) SIL";
                    SQL = SQL + ComNum.VBLF + "    From KOSMOS_PMPA.NUR_JEWON";
                    ...
                    SQL = SQL + ComNum.VBLF + "   GROUP BY DEPTCODE,  TO_CHAR(ACTDATE, 'YYYYMM')) E";
                    SQL = SQL + ComNum.VBLF + "   WHERE E.ACTDATE = A.TIME1(+)";
                    SQL = SQL + ComNum.VBLF + "     AND E.DEPTCODE2 = A.DEPTCODE1(+)";
                    SQL = SQL + ComNum.VBLF + "     AND E.ACTDATE = B.TIME1(+)";
                    SQL = SQL + ComNum.VBLF + "     AND E.DEPTCODE2 = B.DEPTCODE1(+)";
        ...
        private void frmNrstdNewSTS03_Load(object sender, EventArgs e)
        {
            int i = 0;
            int nYY = 0;
            int nMM = 0;

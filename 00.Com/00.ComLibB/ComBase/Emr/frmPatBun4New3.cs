...
namespace ComBase
{
    ...
    /// </summary>
    /// <history>  
    /// 2019-07-23 인증제 기준 변경으로 고위험군 및 재평가 관련 항목 변경
    /// </history>
    /// <seealso cref= D:\psmh\mtsEmr\CarePlan\frmPatBun4New2" >> frmSupLbExSTS15.cs 폼이름 재정의" />

    public partial class frmPatBun4New3 : Form
    {
        string FstrActdate = "";
        ...
        public frmPatBun4New3(string EXENameX, string GstrHelpCodeX, string gsWardX = "")
        {
            InitializeComponent();
        ...
        private bool Save()
        {
            ...
            try
            {
                ...
                {
                    nEMRNO = EMRXML_INSERT(clsDB.DbCon, VB.Val(strIPDNO), strJUMSU1, strJUMSU2, strJUMSU3, strJUMSU4, strJUMSU5, strJUMSU6, strTOTAL, strWARNING, "", "", nEMRNO);
                }
            ...
            try
            {
               ...
               strOutDate.Replace("-", ""), strOutTime, strDeptCode, strDrCd, "0", 1, strXML) == false)
                ...
                else
                {
                    ...
                    strContent.Add("I0000037318", strWARNING);//비정기적 재평가;
        ...
        private void frmPatBun4New3_Load(object sender, EventArgs e)
        {

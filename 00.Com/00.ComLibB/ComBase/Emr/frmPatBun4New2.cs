...
namespace ComBase
{
    ...
    /// 
    /// </history>
    /// <seealso cref= D:\psmh\mtsEmr\CarePlan\frmPatBun4New2" >> frmSupLbExSTS15.cs 폼이름 재정의" />

    public partial class frmPatBun4New2 : Form
    {
        string FstrActdate = "";
        ...
        public frmPatBun4New2(string EXENameX, string GstrHelpCodeX, string gsWardX = "")
        {
            InitializeComponent();
        ...
        private bool Save()
        {
            ...
            strJUMSU2 = SS1_Sheet1.Cells[2, 4].Text.Trim();
            strJUMSU3 = SS1_Sheet1.Cells[4, 4].Text.Trim();
            strJUMSU4 = SS1_Sheet1.Cells[7, 4].Text.Trim();
            strJUMSU5 = SS1_Sheet1.Cells[9, 4].Text.Trim();
            strJUMSU6 = SS1_Sheet1.Cells[12, 4].Text.Trim();
            strROWID = SS1_Sheet1.Cells[21, 4].Text.Trim();

            strTOTAL = (VB.Val(strJUMSU1) + VB.Val(strJUMSU2) + VB.Val(strJUMSU3) + VB.Val(strJUMSU4) + VB.Val(strJUMSU5) + VB.Val(strJUMSU6)).ToString();

            if (strJUMSU1 == "" || strJUMSU2 == "" || strJUMSU3 == "" || strJUMSU4 == "" || strJUMSU5 == "" || strJUMSU6 == "")
            {
            ...
            try
            {
                ...
                if (gsWard == "ER")
                {
                    nEMRNO = EMRXML_INSERT(clsDB.DbCon, VB.Val(strIPDNO), strJUMSU1, strJUMSU2, strJUMSU3, strJUMSU4, strJUMSU5, strJUMSU6, strTOTAL, strWARNING, strACTDATE, strActTime, nEMRNO);
                }
                else
                {
                    nEMRNO = EMRXML_INSERT(clsDB.DbCon, VB.Val(strIPDNO), strJUMSU1, strJUMSU2, strJUMSU3, strJUMSU4, strJUMSU5, strJUMSU6,
                           strTOTAL, strWARNING, "", "", nEMRNO);
                }

                if (nEMRNO == 0)
                {
                    clsDB.setRollbackTran(clsDB.DbCon);
                    ComFunc.MsgBox("EMR 전송에 실패하였습니다.", SqlErr);
                    clsDB.SaveSqlErrLog(SqlErr, SQL, clsDB.DbCon); //에러로그 저장
                    Cursor.Current = Cursors.Default;
                    return rtnVal;
                }
                ...
                {
                    SQL = "";
                    SQL = " INSERT INTO " + ComNum.DB_PMPA + "NUR_FALLMORSE_SCALE";
                    ...
                    SQL = SQL + ComNum.VBLF + "  JUMSU4, JUMSU5, JUMSU6, TOTAL,";
                    SQL = SQL + ComNum.VBLF + "  ENTSABUN, ENTDATE, EMRNO, ACTTIME) VALUES(";
                    SQL = SQL + ComNum.VBLF + "'" + strPano + "'," + strIPDNO + ",TO_DATE('" + strACTDATE + "','YYYY-MM-DD'),'" + strName + "',";
                    ...
                    SQL = SQL + ComNum.VBLF + "" + NVL(strJUMSU4) + "," + NVL(strJUMSU5) + "," + NVL(strJUMSU6) + "," + NVL(strTOTAL) + ", ";
                    SQL = SQL + ComNum.VBLF + clsType.User.Sabun + ", SYSDATE," + nEMRNO + ",'" + strActTime + "') ";
                }
                else
                {
                    SQL = "";
                    SQL = " UPDATE " + ComNum.DB_PMPA + "NUR_FALLMORSE_SCALE SET ";
        ...
        private void READ_MORSEFALL(string ArgIPDNO)
        {
            ...
            {
                SQL = "";
                SQL = " SELECT PANO, JUMSU1, JUMSU2, JUMSU3, JUMSU4, ";
                SQL = SQL + ComNum.VBLF + " JUMSU5, JUMSU6, TOTAL, ACTDATE, ENTSABUN, ROWID, ACTTIME ";
                SQL = SQL + ComNum.VBLF + " FROM " + ComNum.DB_PMPA + "NUR_FALLMORSE_SCALE ";
                if (gsWard == "ER" || gsWard == "HD")
                {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        SS1_Sheet1.ColumnHeader.Cells[0, i + 5].Text = Convert.ToDateTime(dt.Rows[i]["ACTDATE"].ToString().Trim()).ToString("MM/dd") + ComNum.VBLF + dt.Rows[i]["ACTTIME"].ToString().Trim();

                        SS1_Sheet1.Cells[0, i + 5].Text = dt.Rows[i]["JUMSU1"].ToString().Trim();
                        SS1_Sheet1.Cells[2, i + 5].Text = dt.Rows[i]["JUMSU2"].ToString().Trim();
                        SS1_Sheet1.Cells[4, i + 5].Text = dt.Rows[i]["JUMSU3"].ToString().Trim();
                        SS1_Sheet1.Cells[7, i + 5].Text = dt.Rows[i]["JUMSU4"].ToString().Trim();
                        SS1_Sheet1.Cells[9, i + 5].Text = dt.Rows[i]["JUMSU5"].ToString().Trim();
                        SS1_Sheet1.Cells[12, i + 5].Text = dt.Rows[i]["JUMSU6"].ToString().Trim();
                        SS1_Sheet1.Cells[15, i + 5].Text = dt.Rows[i]["TOTAL"].ToString().Trim();
                        SS1_Sheet1.Cells[16, i + 5].Text = ComFunc.LPAD(clsVbfunc.GetInSaName(clsDB.DbCon, dt.Rows[i]["ENTSABUN"].ToString().Trim()), 5, "0");
                        SS1_Sheet1.Cells[21, i + 5].Text = dt.Rows[i]["ROWID"].ToString().Trim();
        ...
        {
            SSEval_Sheet1.Cells[1, 6].Value = false;
            SSEval_Sheet1.Cells[1, 7].Value = false;
            SSEval_Sheet1.Cells[1, 8].Value = false;

            SSEval_Sheet1.Cells[2, 3].Value = false;
            SSEval_Sheet1.Cells[2, 4].Value = false;
            SSEval_Sheet1.Cells[2, 5].Value = false;
            SSEval_Sheet1.Cells[2, 6].Value = false;
            SSEval_Sheet1.Cells[2, 7].Value = false;
            SSEval_Sheet1.Cells[2, 8].Text = "";

            SSEval_Sheet1.Cells[3, 3].Value = false;
            SSEval_Sheet1.Cells[3, 5].Value = false;

            SSEval_Sheet1.Cells[4, 3].Value = false;
            SSEval_Sheet1.Cells[4, 4].Value = false;
            SSEval_Sheet1.Cells[4, 6].Value = false;
            SSEval_Sheet1.Cells[4, 8].Value = false;
        }
        ...
        private void CLEAR_WARNING()
        {
            ...
            SSWarning_Sheet1.Cells[1, 7].Value = false;

            SSWarning_Sheet1.Cells[3, 3].Value = false;
            SSWarning_Sheet1.Cells[3, 4].Value = false;
            SSWarning_Sheet1.Cells[3, 5].Value = false;
            SSWarning_Sheet1.Cells[3, 6].Value = false;
            SSWarning_Sheet1.Cells[3, 7].Value = false;

            SSWarning_Sheet1.Cells[4, 3].Value = false;
            SSWarning_Sheet1.Cells[4, 4].Value = false;
            SSWarning_Sheet1.Cells[4, 5].Value = false;
            SSWarning_Sheet1.Cells[4, 6].Text = "";
        }
        ...
        private string MAKE_WARNING()
        {
            ...
            if (Convert.ToBoolean(SSEval_Sheet1.Cells[2, 3].Value) == true)
            {
                if (strDrug == "")
                {
                    strDrug = "낙상 초래 약물의 초기 투여 - ";
            ...
            if (Convert.ToBoolean(SSEval_Sheet1.Cells[2, 4].Value) == true)
            {
                if (strDrug == "")
                {
                    strDrug = "낙상 초래 약물의 초기 투여 - ";
            ...
            if (Convert.ToBoolean(SSEval_Sheet1.Cells[2, 5].Value) == true)
            {
                if (strDrug == "")
                {
                    strDrug = "낙상 초래 약물의 초기 투여 - ";
            ...
            if (Convert.ToBoolean(SSEval_Sheet1.Cells[2, 6].Value) == true)
            {
                if (strDrug == "")
                {
                    strDrug = "낙상 초래 약물의 초기 투여 - ";
            ...
            if (Convert.ToBoolean(SSEval_Sheet1.Cells[2, 7].Value) == true)
            {
                if (strDrug == "")
                {
                    strDrug = "낙상 초래 약물의 초기 투여 - ";
            ...
            if (Convert.ToBoolean(SSEval_Sheet1.Cells[2, 8].Value) == true)
            {
                if (strDrug == "")
                {
                    strDrug = "낙상 초래 약물의 초기 투여 - ";
                    strDrug += "(" + (Convert.ToBoolean(SSEval_Sheet1.Cells[2, 8].Value) == true ? "1" : "0") + ") ";
                }
            }
            ...
            if (Convert.ToBoolean(SSEval_Sheet1.Cells[4, 3].Value) == true)
            {
                strTemp += "전동";
            }
            if (Convert.ToBoolean(SSEval_Sheet1.Cells[4, 4].Value) == true)
            {
                strTemp += "진정 치료(검사)";
            }
            if (Convert.ToBoolean(SSEval_Sheet1.Cells[4, 6].Value) == true)
            {
                strTemp += "수술/시술";
            }
            if (Convert.ToBoolean(SSEval_Sheet1.Cells[4, 8].Value) == true)
            {
                strTemp += "낙상 발생 ";
            }
        ...
        private bool SAVE_WARNING(PsmhDb pDbCon, string ArgIPDNO, string ArgPano, string argACTDATE, string argACTTIME)
        {
            ...
            strWARNING1 = Convert.ToBoolean(SSWarning_Sheet1.Cells[1, 3].Value) == true ? "1" : "0";
            strWARNING2 = Convert.ToBoolean(SSWarning_Sheet1.Cells[1, 4].Value) == true ? "1" : "0";
            strWARNING3 = Convert.ToBoolean(SSWarning_Sheet1.Cells[1, 5].Value) == true ? "1" : "0";
            strWARNING4 = Convert.ToBoolean(SSWarning_Sheet1.Cells[1, 6].Value) == true ? "1" : "0";
            strWARNING5 = Convert.ToBoolean(SSWarning_Sheet1.Cells[1, 7].Value) == true ? "1" : "0";

            strDRUG01 = Convert.ToBoolean(SSWarning_Sheet1.Cells[3, 3].Value) == true ? "1" : "0";
            strDRUG02 = Convert.ToBoolean(SSWarning_Sheet1.Cells[3, 4].Value) == true ? "1" : "0";
            strDRUG03 = Convert.ToBoolean(SSWarning_Sheet1.Cells[3, 5].Value) == true ? "1" : "0";
            strDRUG04 = Convert.ToBoolean(SSWarning_Sheet1.Cells[3, 6].Value) == true ? "1" : "0";
            strDRUG05 = Convert.ToBoolean(SSWarning_Sheet1.Cells[3, 7].Value) == true ? "1" : "0";

            strDRUG06 = Convert.ToBoolean(SSWarning_Sheet1.Cells[4, 3].Value) == true ? "1" : "0";
            strDRUG07 = Convert.ToBoolean(SSWarning_Sheet1.Cells[4, 4].Value) == true ? "1" : "0";
            strDRUG08 = Convert.ToBoolean(SSWarning_Sheet1.Cells[4, 5].Value) == true ? "1" : "0";
            strDRUG08ETC = SSWarning_Sheet1.Cells[4, 6].Text.Trim();
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    SQL = SQL + ComNum.VBLF + " WARNING4, WARNING5, DRUG_01, DRUG_02,";
                ...
                SQL = SQL + ComNum.VBLF + "'" + strWARNING4 + "','" + strWARNING5 + "','" + strDRUG01 + "','" + strDRUG02 + "', ";
        ...
        private bool SAVE_EVAL(PsmhDb pDbCon, string ArgIPDNO, string ArgPano, string argACTDATE, string argACTTIME)
        {
            ...
            strDRUG_01 = Convert.ToBoolean(SSEval_Sheet1.Cells[1, 6].Value) == true ? "1" : "0";
            strDRUG_02 = Convert.ToBoolean(SSEval_Sheet1.Cells[1, 7].Value) == true ? "1" : "0";
            strDRUG_03 = Convert.ToBoolean(SSEval_Sheet1.Cells[1, 8].Value) == true ? "1" : "0";

            strDRUG_04 = Convert.ToBoolean(SSEval_Sheet1.Cells[2, 3].Value) == true ? "1" : "0";
            strDRUG_05 = Convert.ToBoolean(SSEval_Sheet1.Cells[2, 4].Value) == true ? "1" : "0";
            strDRUG_06 = Convert.ToBoolean(SSEval_Sheet1.Cells[2, 5].Value) == true ? "1" : "0";
            strDRUG_07 = Convert.ToBoolean(SSEval_Sheet1.Cells[2, 6].Value) == true ? "1" : "0";
            strDRUG_08 = Convert.ToBoolean(SSEval_Sheet1.Cells[2, 7].Value) == true ? "1" : "0";
            strDRUG_08ETC = SSEval_Sheet1.Cells[2, 8].Text.Trim();

            strPAT_CHANGE = Convert.ToBoolean(SSEval_Sheet1.Cells[3, 3].Value) == true ? "1" : "0";
            strPAT_CHANGE2 = Convert.ToBoolean(SSEval_Sheet1.Cells[3, 5].Value) == true ? "1" : "0";

            strTRANFOR = Convert.ToBoolean(SSEval_Sheet1.Cells[4, 3].Value) == true ? "1" : "0";
            strRELEX = Convert.ToBoolean(SSEval_Sheet1.Cells[4, 4].Value) == true ? "1" : "0";
            strOP = Convert.ToBoolean(SSEval_Sheet1.Cells[4, 6].Value) == true ? "1" : "0";
            strFall = Convert.ToBoolean(SSEval_Sheet1.Cells[4, 8].Value) == true ? "1" : "0";
        ...
        private double EMRXML_INSERT(PsmhDb pDbCon, double ArgIPDNO, string strIT1, string strIT2, string strIT3, string strIT4, string strIT5, string strIT6, string strTOTAL, string strWARNING, string strACTDATE = "", string strActTime = "", double newEmrNo = 0)
        {
            int intRowAffected = 0;
            string SqlErr = "";
            DataTable dt = null;
            ...
            try
            {
                ...
                EmrForm pForm   = SerEmrFormUpdateNo(clsDB.DbCon, "2477");
                ...
                if (pForm.FmOLDGB == 1)
                {
                    ...
                    strTagHead = "<it1 type=" + VB.Chr(34) + "inputText" + VB.Chr(34) + " label=" + VB.Chr(34) + "과거낙상경험" + VB.Chr(34) + "><![CDATA[";
                    strTagVal = strIT1;
                    strTagTail = "]]></it1>";
                    strXML = strXML + strTagHead + strTagVal + strTagTail;

                    strTagHead = "<it2 type=" + VB.Chr(34) + "inputText" + VB.Chr(34) + " label=" + VB.Chr(34) + "이차진단(부진단)" + VB.Chr(34) + "><![CDATA[";
                    strTagVal = strIT2;
                    strTagTail = "]]></it2>";
                    strXML = strXML + strTagHead + strTagVal + strTagTail;

                    strTagHead = "<it3 type=" + VB.Chr(34) + "inputText" + VB.Chr(34) + " label=" + VB.Chr(34) + "보행보조" + VB.Chr(34) + "><![CDATA[";
                    strTagVal = strIT3;
                    strTagTail = "]]></it3>";
                    strXML = strXML + strTagHead + strTagVal + strTagTail;

                    strTagHead = "<it4 type=" + VB.Chr(34) + "inputText" + VB.Chr(34) + " label=" + VB.Chr(34) + "정맥수액요법/헤파린록(LOCK)" + VB.Chr(34) + "><![CDATA[";
                    strTagVal = strIT4;
                    strTagTail = "]]></it4>";
                    strXML = strXML + strTagHead + strTagVal + strTagTail;

                    strTagHead = "<it5 type=" + VB.Chr(34) + "inputText" + VB.Chr(34) + " label=" + VB.Chr(34) + "걸음걸이/이동" + VB.Chr(34) + "><![CDATA[";
                    strTagVal = strIT5;
                    strTagTail = "]]></it5>";
                    strXML = strXML + strTagHead + strTagVal + strTagTail;

                    strTagHead = "<it6 type=" + VB.Chr(34) + "inputText" + VB.Chr(34) + " label=" + VB.Chr(34) + "의식/정신상태" + VB.Chr(34) + "><![CDATA[";
                    strTagVal = strIT6;
                    strTagTail = "]]></it6>";
                    strXML = strXML + strTagHead + strTagVal + strTagTail;

                    strTagHead = "<it17 type=" + VB.Chr(34) + "inputText" + VB.Chr(34) + " label=" + VB.Chr(34) + "총점" + VB.Chr(34) + "><![CDATA[";
                    strTagVal = strTOTAL;
                    strTagTail = "]]></it17>";
                    strXML = strXML + strTagHead + strTagVal + strTagTail;

                    strTagHead = "<it30 type=" + VB.Chr(34) + "inputText" + VB.Chr(34) + " label=" + VB.Chr(34) + "비정기적 재평가" + VB.Chr(34) + "><![CDATA[";
                    ...
                    if (CREATE_EMR_XMLINSRT3(nEMRNO, "2477", clsType.User.IdNumber, strChartDate.Replace("-", ""), strChartTime.Replace(":", ""),
               ...
               strOutDate.Replace("-", ""), strOutTime, strDeptCode, strDrCd, "0", 1, strXML) == false)
                ...
                else
                {
                    ...
                    strContent.Add("I0000037695", strIT1);
                    strContent.Add("I0000002140", strIT2);
                    strContent.Add("I0000027083", strIT3);
                    strContent.Add("I0000037696", strIT4);
                    strContent.Add("I0000037697", strIT5);
                    strContent.Add("I0000037698", strIT6);
        ...
        private void DATA_READ()
        {
            ...
            {
                SQL = "";
                SQL = " SELECT A.PANO, A.SNAME, A.SEX, A.AGE, A.DEPTCODE, A.ROOMCODE, A.ENTDATE, A.ENTSABUN, B.JUMIN1, A.ACTDATE, A.ROWID, A.ACTTIME   ";
                ...
                else
                {
                    ...
                    SQL = SQL + ComNum.VBLF + "   AND A.ACTDATE >= TO_DATE('" + Convert.ToDateTime(ComFunc.FormatStrToDateEx(ComQuery.CurrentDateTime(clsDB.DbCon, "D"), "D", "-")).AddDays(-10).ToString("yyyy-MM-dd") + "','YYYY-MM-DD') ";
                }
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (gsWard == "HD" || gsWard == "ER")
                    {
                        SS2_Sheet1.Cells[1, 7].Text = FstrActdate;
                    }
                    else
                    {
                    ...
                    if (nAge >= 70)
                    {
                        SSWarning_Sheet1.Cells[1, 3].Value = true;
                    }
                }
                else
                {
                    ...
                    if (gsWard == "HD" || gsWard == "ER")
                    {
                        ...
                        if (chkJ.Checked == true)
                        {
                            SQL = SQL + ComNum.VBLF + "   AND A.ACTDATE = TO_DATE('" + (TxtJDATE.Text).Trim() + "','YYYY-MM-DD') ";
                        }
                        else
                        {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (nAge >= 70)
                        {
                            SSWarning_Sheet1.Cells[0, 3].Value = true;
                        }
                    }
                    else
                    {
        ...
        private void READ_WARNING(string ArgGubun, string ArgPano, string ArgIPDNO, string argROWID = "")
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + " WARNING4, WARNING5, DRUG_01, DRUG_02,";
                SQL = SQL + ComNum.VBLF + " DRUG_03, DRUG_04, DRUG_05, DRUG_06,";
                SQL = SQL + ComNum.VBLF + " DRUG_07, DRUG_08, DRUG_08_ETC";
                ...
                if (dt.Rows.Count > 0)
                {
                    SSWarning_Sheet1.Cells[1, 3].Value = dt.Rows[0]["WARNING1"].ToString().Trim() == "1" ? true : false;
                    SSWarning_Sheet1.Cells[1, 4].Value = dt.Rows[0]["WARNING2"].ToString().Trim() == "1" ? true : false;
                    SSWarning_Sheet1.Cells[1, 5].Value = dt.Rows[0]["WARNING3"].ToString().Trim() == "1" ? true : false;
                    SSWarning_Sheet1.Cells[1, 6].Value = dt.Rows[0]["WARNING4"].ToString().Trim() == "1" ? true : false;
                    SSWarning_Sheet1.Cells[1, 7].Value = dt.Rows[0]["WARNING5"].ToString().Trim() == "1" ? true : false;

                    SSWarning_Sheet1.Cells[3, 3].Value = dt.Rows[0]["DRUG_01"].ToString().Trim() == "1" ? true : false;
                    SSWarning_Sheet1.Cells[3, 4].Value = dt.Rows[0]["DRUG_02"].ToString().Trim() == "1" ? true : false;
                    SSWarning_Sheet1.Cells[3, 5].Value = dt.Rows[0]["DRUG_03"].ToString().Trim() == "1" ? true : false;
                    SSWarning_Sheet1.Cells[3, 6].Value = dt.Rows[0]["DRUG_04"].ToString().Trim() == "1" ? true : false;
                    SSWarning_Sheet1.Cells[3, 7].Value = dt.Rows[0]["DRUG_05"].ToString().Trim() == "1" ? true : false;

                    SSWarning_Sheet1.Cells[4, 3].Value = dt.Rows[0]["DRUG_06"].ToString().Trim() == "1" ? true : false;
                    SSWarning_Sheet1.Cells[4, 4].Value = dt.Rows[0]["DRUG_07"].ToString().Trim() == "1" ? true : false;
                    SSWarning_Sheet1.Cells[4, 5].Value = dt.Rows[0]["DRUG_08"].ToString().Trim() == "1" ? true : false;
                    SSWarning_Sheet1.Cells[4, 6].Text = dt.Rows[0]["DRUG_08_ETC"].ToString().Trim();
                }
        ...
        private void READ_EVAL(string ArgGubun, string ArgPano, string ArgIPDNO, string argROWID = "")
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    SSEval_Sheet1.Cells[1, 6].Value = dt.Rows[0]["DRUG_01"].ToString().Trim() == "1" ? true : false;
                    SSEval_Sheet1.Cells[1, 7].Value = dt.Rows[0]["DRUG_02"].ToString().Trim() == "1" ? true : false;
                    SSEval_Sheet1.Cells[1, 8].Value = dt.Rows[0]["DRUG_03"].ToString().Trim() == "1" ? true : false;

                    SSEval_Sheet1.Cells[2, 3].Value = dt.Rows[0]["DRUG_04"].ToString().Trim() == "1" ? true : false;
                    SSEval_Sheet1.Cells[2, 4].Value = dt.Rows[0]["DRUG_05"].ToString().Trim() == "1" ? true : false;
                    SSEval_Sheet1.Cells[2, 5].Value = dt.Rows[0]["DRUG_06"].ToString().Trim() == "1" ? true : false;
                    SSEval_Sheet1.Cells[2, 6].Value = dt.Rows[0]["DRUG_07"].ToString().Trim() == "1" ? true : false;
                    SSEval_Sheet1.Cells[2, 7].Value = dt.Rows[0]["DRUG_08"].ToString().Trim() == "1" ? true : false;
                    SSEval_Sheet1.Cells[2, 8].Text = dt.Rows[0]["DRUG_08ETC"].ToString().Trim();

                    SSEval_Sheet1.Cells[3, 3].Value = dt.Rows[0]["PAT_CHANGE"].ToString().Trim() ==  "1" ? true : false;
                    SSEval_Sheet1.Cells[3, 5].Value = dt.Rows[0]["PAT_CHANGE2"].ToString().Trim() == "1" ? true : false;

                    SSEval_Sheet1.Cells[4, 3].Value = dt.Rows[0]["TRANFOR"].ToString().Trim() == "1" ? true : false;
                    SSEval_Sheet1.Cells[4, 4].Value = dt.Rows[0]["RELEX"].ToString().Trim() == "1" ? true : false;
                    SSEval_Sheet1.Cells[4, 6].Value = dt.Rows[0]["OP"].ToString().Trim() == "1" ? true : false;
                    SSEval_Sheet1.Cells[4, 8].Value = dt.Rows[0]["FALL"].ToString().Trim() == "1" ? true : false;
                }
        ...
        private void SS1_CellDoubleClick(object sender, CellClickEventArgs e)
        {
            ...
            if (e.ColumnHeader == true)
            {
                ...
                strROWID = SS1_Sheet1.Cells[21, e.Column].Text.Trim();
            ...
            if (strSCORE == SS1_Sheet1.Cells[eRow, 4].Text.Trim())
            {
                SS1_Sheet1.Cells[eRow, 4].Text = "";
            }
            else
            {
                SS1_Sheet1.Cells[eRow, 4].Text = strSCORE;
            }
        }
        ...
        private void DELETE_낙상(string argROWID)
        {
            ...
            {
                SQL = "";
                SQL = " SELECT EMRNO, PANO, ACTDATE, ACTTIME ";
                SQL = SQL + ComNum.VBLF + " FROM " + ComNum.DB_PMPA + "NUR_FALLMORSE_SCALE";
                SQL = SQL + ComNum.VBLF + " WHERE ROWID = '" + argROWID + "' ";
        ...
        private void TxtJTime_ValueChanged(object sender, EventArgs e)
        {
        
        }

        private void frmPatBun4New2_Load(object sender, EventArgs e)
        {

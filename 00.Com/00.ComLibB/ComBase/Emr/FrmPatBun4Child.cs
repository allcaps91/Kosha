...
namespace ComBase
{
    ...
    public partial class FrmPatBun4Child : Form
    {
        string FstrActdate = "";
        ...
        public FrmPatBun4Child(string EXENameX, string GstrHelpCodeX, string gsWardX = "")
        {
            InitializeComponent();
            EXEName = EXENameX;
            gsWard = gsWardX;
        ...
        public FrmPatBun4Child()
        {
            InitializeComponent();
        }

        private void FrmPatBun4Child_Load(object sender, EventArgs e)
        {
        ...
        private bool SAVE_EVAL(PsmhDb pDbCon, string ArgIPDNO, string ArgPano, string argACTDATE, string argACTTIME)
        {
            ...
            strDRUG_08ETC = SSEval_Sheet1.Cells[1, 8].Text.Trim();
        ...
        private double EMRXML_INSERT(PsmhDb pDbCon, double ArgIPDNO, string strIT1, string strIT2, string strIT3, string strIT4, string strIT5, string strIT6, string strIT7, string strTOTAL, 
                                     string strWARNING, double newEmrNo = 0)
        {
            string SqlErr = "";
            DataTable dt = null;
            string SQL = "";
        ...
        private void DATA_READ()
        {
            ...
            {
                SQL = "";
                SQL = " SELECT A.PANO, A.SNAME, A.SEX, A.AGE, A.DEPTCODE, A.ROOMCODE, A.ENTDATE, A.ENTSABUN, B.JUMIN1, A.ACTDATE, A.ROWID   ";

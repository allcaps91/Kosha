    ...
    public partial class frmCarePlan : Form
    {
            ...
            try
            {
                ...
                switch (strFormNo)
                {
                    ...
                    case "2356":
                        ...
                        SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000002168') AS A,  --주증상";
                        SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000028908') AS B,  --입원동기";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true) FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034374') AS C1, --과거병력 없음";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true) FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034376') AS C2, --과거병력 모름";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true) FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034378') AS C3, --과거병력 고혈압";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true) FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034379') AS C4, --과거병력 당뇨";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true) FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034770') AS C5, --과거병력 결핵";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true) FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034771') AS C6, --과거병력 간염";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true) FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMCD = 'I0000034383_1') AS C7, --과거병력 기타";
                        SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMCD = 'I0000034383_2') AS C8, --과거병력 기타 내용";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true) FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034772') AS C9, --과거병력 뇌졸중";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true) FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034773') AS C10, --과거병력 심장질환";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true) FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034774') AS C11,  --과거병력 암";
                        SQL = SQL + ComNum.VBLF + " CHARTUSEID, CHARTDATE, CHARTTIME";
                    ...
                    case "2305":
                        ...
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034374') AS C1, --과거병력 없음";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034376') AS C2, --과거병력 모름";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034377') AS C3, --과거병력 폐렴";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034378') AS C4, --과거병력 장염";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034379') AS C5, --과거병력 경련";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034380') AS C6, --과거병력 미숙아";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034381') AS C7, --과거병력 황달";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034382') AS C8, --과거병력 패혈증";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMCD = 'I0000034383_1') AS C9, --과거병력 기타";
                        SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMCD = 'I0000034383_2') AS C10, --과거병력 기타 내용";
                        SQL = SQL + ComNum.VBLF + " CHARTUSEID, CHARTDATE, CHARTTIME";
                        SQL = SQL + ComNum.VBLF + " FROM " + ComNum.DB_EMR + "AEMRCHARTMST A";
                        SQL = SQL + ComNum.VBLF + " WHERE EMRNO = " + strEmrNo;
                    ...
                    case "2294":
                        ...
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034374') AS C1, --과거병력 없음";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034376') AS C2, --과거병력 모름";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000035316') AS C3, --과거병력 폐렴";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000035317') AS C4, --과거병력 장염";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000035070') AS C5, --과거병력 요로감염";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000035318') AS C6, --과거병력 경련";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034773') AS C7, --과거병력 심장질환";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000034774') AS C8, --과거병력 암";
                        SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMCD = 'I0000034383_1') AS C9, --과거병력 기타";
                        SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMCD = 'I0000034383_2') AS C10, --과거병력 기타 내용";
                        SQL = SQL + ComNum.VBLF + " CHARTUSEID, CHARTDATE, CHARTTIME";
                        SQL = SQL + ComNum.VBLF + " FROM " + ComNum.DB_EMR + "AEMRCHARTMST A";
        ...
        void Nur_Info_Er(string argPano, string argInDate, string argOutDate)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + " UNION ALL";
                SQL = SQL + ComNum.VBLF + " SELECT ";
                SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000002018') AS A1,  --혈압 SBP";
                SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000001765') AS A2,  --혈압 DBP";
                SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000014815') AS A3,  --맥박";
                SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000002009') AS A4,  --호흡";
                SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000001811') AS A5,  --체온";
                SQL = SQL + ComNum.VBLF + " '' AS A6,  --?";

                SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000011727') AS B1,   --의식상태 ";
                SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000010573') AS B2,   --의식상태 ";
                SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = 'I0000014736') AS B3,   --의식상태 ";
                SQL = SQL + ComNum.VBLF + " (SELECT DECODE(ITEMVALUE, '0', 'False', 'true') FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMCD = 'I0000034157') AS B4,   --의식상태 ";
                SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMCD = 'I0000034158') AS C,    --내원동기";
                SQL = SQL + ComNum.VBLF + " CHARTUSEID, CHARTDATE, CHARTTIME";
                SQL = SQL + ComNum.VBLF + " FROM " + ComNum.DB_EMR + "AEMRCHARTMST A";
                SQL = SQL + ComNum.VBLF + " WHERE EMRNO = " + strEmrNo;
        ...
        void Ipwon_Info_Er(string argPano, string argInDate, string argOutDate)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + " UNION ALL";
                SQL = SQL + ComNum.VBLF + " SELECT ";
                SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMCD = 'I0000014279') AS A1,  --최종진단";
                SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMCD = 'I0000014623_2') AS A2,  --O_2";
                SQL = SQL + ComNum.VBLF + " CHARTUSEID, CHARTDATE, CHARTTIME";
                SQL = SQL + ComNum.VBLF + " FROM " + ComNum.DB_EMR + "AEMRCHARTMST A";
                SQL = SQL + ComNum.VBLF + " WHERE EMRNO = " + strEmrNo;
        ...
        void Ipwon_Info(string argPano, string argInDate, string argOutDate)
        {
            ...
            try
            {
                #region 신규          
                SQL = "SELECT ";
                SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = B.PART01) A,";               
                SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = B.PART02) B, ";
                SQL = SQL + ComNum.VBLF + " (SELECT ITEMVALUE FROM ADMIN.AEMRCHARTROW WHERE EMRNO = A.EMRNO AND EMRNOHIS = A.EMRNOHIS AND ITEMNO = B.PART02_2) B2, ";
                SQL = SQL + ComNum.VBLF + " CHARTUSEID, CHARTDATE, CHARTTIME";
                SQL = SQL + ComNum.VBLF + "  FROM " + ComNum.DB_EMR + "AEMRCHARTMST A";
        ...
        private void ssDiet_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + " FROM ADMIN.DIET_RATING_PATIENT_NEW ";
                SQL = SQL + ComNum.VBLF + " WHERE IPDNO = " + fstrIPDNO;
                SQL = SQL + ComNum.VBLF + "  ORDER BY BUILDDATE DESC";

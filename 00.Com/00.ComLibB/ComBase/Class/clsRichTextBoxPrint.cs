...
namespace ComBase
{
    ...
    /// 
    /// </summary>
    public class clsRichTextBoxPrint : MTSDisposable
    {
        ...
        RichTextBox control;
        public clsRichTextBoxPrint(RichTextBox controlToPrint)
        {
        ...
        public void PrintRTF(PrintDocument printDocument)
        {
            try
            {
                ...
                printDocument.EndPrint += new PrintEventHandler(this.printDocument_EndPrint);
        ...
        private void printDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            if (m_nFirstCharOnPage < control.Text.Length)
                e.HasMorePages = true;
            else

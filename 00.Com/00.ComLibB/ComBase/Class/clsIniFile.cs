...
namespace ComBase
{
    ...
    public class clsIniFile : MTSDisposable
    {
        ...
        //Constructor
        public clsIniFile(string iniFileName)
        {
    ...
    {
        // You can use this class to manupulate a ini file directly
        // Methods :
        //	* WriteProfileValue -> writes the value in the section & key into the inifile
        //	* ReadProfileValue -> returns the value from the inifile specified
        public static bool WriteProfileValue(string iniFileName, string section, string key, string keyValue)
        {
            Debug.Assert(iniFileName.Length > 0 && iniFileName.Length <= 255); //255 = Max Length File Name in Windows System File
            Debug.Assert(section != null && section != "");
            Debug.Assert(key != null && key != "" && key.IndexOf("=") < 0);//char = not permit in key 
            clsIniFile myIniFile = new clsIniFile(iniFileName);
            bool retValue = myIniFile.WriteValue(section, key, keyValue);
            if (retValue) retValue = myIniFile.FlushToDisk();
            return (retValue);
        }
        ...
        public static string ReadProfileValue(string iniFileName, string section, string key, string defaultValue)
        {
            ...
            Debug.Assert(key != null && key != "" && key.IndexOf("=") < 0);//char = not permit in key 
            clsIniFile myIniFile = new clsIniFile(iniFileName);
            return (myIniFile.ReadValue(section, key, defaultValue));
        }
        public static double ReadProfileValue(string iniFileName, string section, string key, double defaultValue)
        {
            Debug.Assert(iniFileName.Length > 0 && iniFileName.Length <= 255); //255 = Max Length File Name in Windows System File
            Debug.Assert(section != null && section != "");
            Debug.Assert(key != null && key != "" && key.IndexOf("=") < 0);//char = not permit in key 
    ...
    //{		
    //    // This Class is to test the class IniFile and DirectIniFile	
    //    static void Main(string[] args)
    //    {

    //        //DirectIniFile
    //        string IniFile = "c:\\TEST.ini";
    //        DirectIniFile.WriteProfileValue(IniFile,"SEC1","KEY1","Value1");
    //        DirectIniFile.WriteProfileValue(IniFile,"SEC2","KEY2","Value2");
    //        DirectIniFile.WriteProfileValue(IniFile,"SEC2","KEY3","Value2");
    //        DirectIniFile.WriteProfileValue(IniFile,"SEC2","KEY4","Value2");
    //        DirectIniFile.WriteProfileValue(IniFile,"SEC2","KEY7","Value2");
    //        DirectIniFile.WriteProfileValue(IniFile,"SEC3","KEY1","Value1");
    //        DirectIniFile.WriteProfileValue(IniFile,"SEC4","KEY2","Value2");
    //        DirectIniFile.WriteProfileValue(IniFile,"SEC5","KEY1","Value1");
    //        DirectIniFile.WriteProfileValue(IniFile,"SEC6","KEY2","Value2");
    //        DirectIniFile.WriteProfileValue(IniFile,"SEC6","KEY2","Value2");			
    //        Debug.Assert (DirectIniFile.ReadProfileValue("c:\\TEST.ini","SEC1","KEY1", "DefaultValue1") == "Value1");			
    //        //clsIniFile
    //        clsIniFile myIniFile = new clsIniFile(IniFile);
    //        bool retValue = myIniFile.WriteValue("SEC6","KEY2","Value2");			
    //        retValue = myIniFile.EraseSection("SEC6");
    //        Debug.Assert(!myIniFile.ExistsSection("SEC6"));
    //        Debug.Assert(!myIniFile.ExistsSectionKey("SEC6","KEY2"));
    //        retValue = myIniFile.EraseSection("Sec11");
    //        retValue = myIniFile.EraseSectionKey("SEC2","KEY3");
    //        retValue = myIniFile.WriteValue("SEC1","Key3","NewValue3");			
    //        retValue = myIniFile.WriteValue("SEC1","Key2","NewValue3.2");	
    //        retValue = myIniFile.WriteValue("SEC1","Key3",555);	
    //        retValue = myIniFile.WriteValue("SEC1","Key5",555);

    //        Debug.Assert(myIniFile.ReadValue("SEC1","Key3","") == "555");
    //        Debug.Assert(myIniFile.ReadValue("SEC1","Key3",0) == 555);			
    //        retValue = myIniFile.EraseSectionKey("SEC1","Key3");
    //        Debug.Assert(myIniFile.ReadValue("SEC1","Key3","") == "");
    //        retValue =myIniFile.FlushToDisk();				
    //        myIniFile.IniFileName = "c:\\TEST2.ini";
    //        Debug.Assert(myIniFile.ReadValue("SEC1","Key3","") == "");						
    //    }
    //}
}

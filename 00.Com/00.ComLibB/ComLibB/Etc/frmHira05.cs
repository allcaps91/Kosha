...
namespace ComLibB
{
    ...
    /// 
    /// </history>
    /// <seealso cref= " \basic\busuga\busuga.vbp(FrmHira05) >> frmHira05.cs 폼이름 재정의" />
    public partial class frmHira05 : Form
    {
        public frmHira05()
        {
            InitializeComponent();
        ...
        private void frmHira05_Load(object sender, EventArgs e)
        {
            //폼 권한 조회
        ...
        void GetSearchData()
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "     AND A.GUBUN_CD = '2' "; //'최대기간

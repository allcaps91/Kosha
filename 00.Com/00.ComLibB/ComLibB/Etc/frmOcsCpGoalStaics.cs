    ...
    public partial class frmOcsCpGoalStaics : Form, MainFormMessage
    {
        ...
        private void GetDataAllQuery(FarPoint.Win.Spread.SheetView Spd)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "    INNER JOIN KOSMOS_OCS.OCS_CP_VALUE V ";
                SQL = SQL + ComNum.VBLF + "        ON R.CPNO = V.CPNO ";
                SQL = SQL + ComNum.VBLF + "        AND V.VALGB = '0' ";
                SQL = SQL + ComNum.VBLF + "        AND V.CPRSTN > 0 ";
                SQL = SQL + ComNum.VBLF + "    INNER JOIN KOSMOS_OCS.OCS_CP_SUB S ";
        ...
        private void GetDataViolSubQuery(FarPoint.Win.Spread.SheetView Spd)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "        AND B.GRPCDB = 'CP관리'   "                                             ;
                SQL = SQL + ComNum.VBLF + "        AND B.GRPCD = 'CP코드관리' "                                            ;
                SQL = SQL + ComNum.VBLF + "    INNER JOIN KOSMOS_PMPA.BAS_BASCD BS   "                                     ;
        ...
        private void GetDataResultAllQuery(FarPoint.Win.Spread.SheetView Spd)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "    SELECT   ";
                SQL = SQL + ComNum.VBLF + "        CASE   ";
                SQL = SQL + ComNum.VBLF + "            WHEN KOSMOS_OCS.FC_GET_CP_RESULT(R.PTNO, TO_CHAR(R.INTIME, 'YYYYMMDD'), TO_CHAR(R.INTIME, 'HH24MI')) = '귀가' THEN 1  ";
                SQL = SQL + ComNum.VBLF + "            ELSE 0  ";
                SQL = SQL + ComNum.VBLF + "        END GHOME,  ";
                SQL = SQL + ComNum.VBLF + "        CASE   ";
                SQL = SQL + ComNum.VBLF + "            WHEN KOSMOS_OCS.FC_GET_CP_RESULT(R.PTNO, TO_CHAR(R.INTIME, 'YYYYMMDD'), TO_CHAR(R.INTIME, 'HH24MI')) = '전원' THEN 1 ";
                SQL = SQL + ComNum.VBLF + "            ELSE 0  ";
                SQL = SQL + ComNum.VBLF + "        END TRS,   ";
                SQL = SQL + ComNum.VBLF + "        CASE   ";
                SQL = SQL + ComNum.VBLF + "            WHEN KOSMOS_OCS.FC_GET_CP_RESULT(R.PTNO, TO_CHAR(R.INTIME, 'YYYYMMDD'), TO_CHAR(R.INTIME, 'HH24MI')) = '입원' THEN 1 ";
                SQL = SQL + ComNum.VBLF + "            ELSE 0  ";
                SQL = SQL + ComNum.VBLF + "        END INCNT,  ";
                SQL = SQL + ComNum.VBLF + "        CASE   ";
                SQL = SQL + ComNum.VBLF + "            WHEN KOSMOS_OCS.FC_GET_CP_RESULT(R.PTNO, TO_CHAR(R.INTIME, 'YYYYMMDD'), TO_CHAR(R.INTIME, 'HH24MI')) = '사망' THEN 1 ";
                SQL = SQL + ComNum.VBLF + "            ELSE 0  ";
                SQL = SQL + ComNum.VBLF + "        END DOA , ";
                SQL = SQL + ComNum.VBLF + "        CASE   ";
                SQL = SQL + ComNum.VBLF + "            WHEN KOSMOS_OCS.FC_GET_CP_RESULT(R.PTNO, TO_CHAR(R.INTIME, 'YYYYMMDD'), TO_CHAR(R.INTIME, 'HH24MI')) = '귀가' THEN 0 ";
                SQL = SQL + ComNum.VBLF + "            WHEN KOSMOS_OCS.FC_GET_CP_RESULT(R.PTNO, TO_CHAR(R.INTIME, 'YYYYMMDD'), TO_CHAR(R.INTIME, 'HH24MI')) = '전원' THEN 0 ";
                SQL = SQL + ComNum.VBLF + "            WHEN KOSMOS_OCS.FC_GET_CP_RESULT(R.PTNO, TO_CHAR(R.INTIME, 'YYYYMMDD'), TO_CHAR(R.INTIME, 'HH24MI')) = '입원' THEN 0 ";
                SQL = SQL + ComNum.VBLF + "            WHEN KOSMOS_OCS.FC_GET_CP_RESULT(R.PTNO, TO_CHAR(R.INTIME, 'YYYYMMDD'), TO_CHAR(R.INTIME, 'HH24MI')) = '사망' THEN 0 ";
        ...
        private void CpList_Head(FarPoint.Win.Spread.SheetView Spd)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "FROM KOSMOS_OCS.OCS_CP_SUB S   ";

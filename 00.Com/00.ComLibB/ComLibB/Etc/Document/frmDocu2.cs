...
namespace ComLibB
{
    public partial class frmDocu2 : Form, MainFormMessage
    {
        ...
        public frmDocu2(MainFormMessage pform)
        {
            InitializeComponent();
            mCallForm = pform;
        }

        public frmDocu2(MainFormMessage pform, string sPara1)
        {
            InitializeComponent();
            mCallForm = pform;
            mPara1 = sPara1;
        ...
        private void frmDocu2_Load(object sender, EventArgs e)
        {
            string strBuse = "";
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    SsList.ActiveSheet.Cells[i, 3].Text = cPlaceName2;
                    SsList.ActiveSheet.Cells[i, 4].Text = cPlaceName;
        ...
        private void frmDocu2_Activated(object sender, EventArgs e)
        {
            if (mCallForm != null)
            {
        ...
        private void frmDocu2_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (mCallForm != null)
            {

...
namespace ComLibB
{
    public partial class frmCertView : Form
    {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            SQL += "  FROM ADMIN.BAS_CERTPOOL_" + VB.Replace(cpublic.strSysDate, "-", "") + " " + ComNum.VBLF;
            ...
            SQL += "  , (SELECT EMP_NM FROM ADMIN.HR_EMP_BASIS WHERE EMP_ID = A.CHARTUSEID) AS USER_NAME " + ComNum.VBLF;
            SQL += "  , C.CERTDATA AS CERT_DATA                 " + ComNum.VBLF;
            SQL += "  , C.EMRDATA  AS EMR_DATA                  " + ComNum.VBLF;
            SQL += "   FROM ADMIN.AEMRCHARTMST A " + ComNum.VBLF;
            SQL += "   LEFT OUTER JOIN ADMIN.AEMRFORM F " + ComNum.VBLF;

namespace ComLibB
{
    partial class frmSupDrstDifDown
    {
        /// <summary>
        ...
        {
            FarPoint.Win.Spread.NamedStyle namedStyle1 = new FarPoint.Win.Spread.NamedStyle("Color308636479858547703992", "DataAreaDefault");
            FarPoint.Win.Spread.NamedStyle namedStyle2 = new FarPoint.Win.Spread.NamedStyle("Text372636479858547904003", "DataAreaDefault");
            ...
            this.label1.Text = "DIF Reference 다운로드 중입니다. 잠시만 기다리시면 자동 실행 됩니다.";
            ...
            this.progressBar1.Size = new System.Drawing.Size(674, 22);
            this.progressBar1.TabIndex = 0;
            // 
            // ssView
            // 
            this.ssView.AccessibleDescription = "fpSpread1, Sheet1, Row 0, Column 0, c:\\cmd\\dif\\";
            this.ssView.Location = new System.Drawing.Point(648, 14);
            ...
            this.ssView_Sheet1.Cells.Get(0, 0).Value = "c:\\cmd\\dif\\";
            this.ssView_Sheet1.Cells.Get(0, 1).Value = "ClinicalRef.exe";
            this.ssView_Sheet1.Cells.Get(1, 0).Value = "c:\\cmd\\dif\\";
            this.ssView_Sheet1.Cells.Get(1, 1).Value = "fdsConnect.dll";
            this.ssView_Sheet1.Cells.Get(2, 0).Value = "c:\\cmd\\dif\\";
            this.ssView_Sheet1.Cells.Get(2, 1).Value = "fdsRef.dll";
            this.ssView_Sheet1.Cells.Get(3, 0).Value = "c:\\cmd\\dif\\";
            this.ssView_Sheet1.Cells.Get(3, 1).Value = "Firstdis.ini";
            this.ssView_Sheet1.Cells.Get(4, 0).Value = "c:\\cmd\\dif\\";
            this.ssView_Sheet1.Cells.Get(4, 1).Value = "Microsoft.Office.Interop.Excel.dll";
            this.ssView_Sheet1.Cells.Get(5, 0).Value = "c:\\cmd\\dif\\";
            this.ssView_Sheet1.Cells.Get(5, 1).Value = "Office.dll";
            ...
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 0).Value = "경로";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 1).Value = "파일명";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "아이콘 및 실행";
            this.ssView_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "다운로드확인";
            ...
            this.ssView_Sheet1.Columns.Get(0).Label = "경로";
            this.ssView_Sheet1.Columns.Get(0).Width = 81F;
            this.ssView_Sheet1.Columns.Get(1).Label = "파일명";
            this.ssView_Sheet1.Columns.Get(1).Width = 96F;
            this.ssView_Sheet1.Columns.Get(3).Label = "다운로드확인";
            ...
            this.ClientSize = new System.Drawing.Size(684, 62);
            this.Controls.Add(this.ssView);
            this.Controls.Add(this.panel1);
            this.Controls.Add(this.label1);
            this.Font = new System.Drawing.Font("맑은 고딕", 10F);
            this.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
            this.Name = "frmSupDrstDifDown";
            this.Text = "First DIS DIF-Reference 다운로더";
            this.Load += new System.EventHandler(this.frmSupDrstDifDown_Load);

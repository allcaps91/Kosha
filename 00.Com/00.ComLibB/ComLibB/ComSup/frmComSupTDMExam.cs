...
namespace ComLibB
{
    public partial class frmComSupTDMExam : Form
    {
        string PANO = string.Empty;
        ...
        /// <param name="INDATE">입원/내원일자</param>
        public frmComSupTDMExam(string PANO, string INDATE)
        {
            InitializeComponent();
            this.PANO = PANO;
            this.INDATE = INDATE;
        ...
        private void frmComSupTDMExam_Load(object sender, EventArgs e)
        {
            READ_PATIENT(PANO);
            SetList();
        }

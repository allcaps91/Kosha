    ...
    public partial class frmSupDrstDrugMedicineList : Form
    {
        ...
        private void READ_DATA_B(string strGubun)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + " FROM ADMIN.OCS_DRUGINFO_NEW A ";
                ...
                SQL = SQL + ComNum.VBLF + "                FROM ADMIN.DRUG_MASTER5 M ";
                SQL = SQL + ComNum.VBLF + "              INNER JOIN ADMIN.BAS_BCODE_DRUG B ";
                ...
                SQL = SQL + ComNum.VBLF + "  AND EXISTS ";
                SQL = SQL + ComNum.VBLF + "      (SELECT * FROM ADMIN.BAS_SUT S ";
                SQL = SQL + ComNum.VBLF + "          WHERE DELDATE IS NULL ";
            ...
            try
            {
                switch (strGubun1)
                {
                    ...
                    case "3":
                        ...
                        {                            
                            case "9774":    // 유사코드
                                ...
                                //SQL = SQL + ComNum.VBLF + "       (SELECT HNAME FROM ADMIN.OCS_DRUGINFO_NEW M1 ";
                                ...
                                SQL = SQL + ComNum.VBLF + " FROM ADMIN.DRUG_MASTER_SETCODE A                   ";
                                SQL = SQL + ComNum.VBLF + " INNER JOIN ADMIN.OCS_DRUGINFO_NEW B                ";
                            ...
                            case "9775":    //유사외관
                                ...
                                //SQL = SQL + ComNum.VBLF + "          B.CODE, B.MCODE, B.MNAME,                                                         ";
                                //SQL = SQL + ComNum.VBLF + "          M.CODE01,                                                                         ";
                                //SQL = SQL + ComNum.VBLF + "          (SELECT BCODE FROM ADMIN.BAS_SUN                                            ";
                                //SQL = SQL + ComNum.VBLF + "            WHERE TRIM(SUNEXT) = CODE01) AS EDICODE01,                                      ";
                                //SQL = SQL + ComNum.VBLF + "          (SELECT HNAME FROM ADMIN.OCS_DRUGINFO_NEW M1                                 ";
                                //SQL = SQL + ComNum.VBLF + "          WHERE TRIM(M1.SUNEXT) = CODE01) AS NAME01,                                        ";
                                //SQL = SQL + ComNum.VBLF + "          (SELECT JEHENG2 FROM ADMIN.OCS_DRUGINFO_NEW M1                               ";
                                ...
                                //SQL = SQL + ComNum.VBLF + "          FROM ADMIN.OCS_DRUGINFO_NEW M1 WHERE TRIM(M1.SUNEXT) = CODE01)  AS REMARK01, ";
                                //SQL = SQL + ComNum.VBLF + "          M.CODE02,                                                                         ";
                                //SQL = SQL + ComNum.VBLF + "          (SELECT BCODE FROM ADMIN.BAS_SUN                                            ";
                                ...
                                //SQL = SQL + ComNum.VBLF + "          (SELECT '앞)' || JEHENG3_1 || CHR(13) || CHR(10) || '뒤)' || JEHENG3_2            ";
                                //SQL = SQL + ComNum.VBLF + "          FROM ADMIN.OCS_DRUGINFO_NEW M1 WHERE TRIM(M1.SUNEXT) = CODE02)  AS REMARK02, ";
                                //SQL = SQL + ComNum.VBLF + "          M.CODE03,                                                                         ";
                                //SQL = SQL + ComNum.VBLF + "          (SELECT BCODE FROM ADMIN.BAS_SUN                                            ";
                                ...
                                //SQL = SQL + ComNum.VBLF + "          (SELECT '앞)' || JEHENG3_1 || CHR(13) || CHR(10) || '뒤)' || JEHENG3_2            ";
                                //SQL = SQL + ComNum.VBLF + "          FROM ADMIN.OCS_DRUGINFO_NEW M1 WHERE TRIM(M1.SUNEXT) = CODE03)  AS REMARK03, ";
                                //SQL = SQL + ComNum.VBLF + "          M.CODE04,                                                                         ";
                                //SQL = SQL + ComNum.VBLF + "          (SELECT BCODE FROM ADMIN.BAS_SUN                                            ";
                                ...
                                //SQL = SQL + ComNum.VBLF + "          (SELECT '앞)' || JEHENG3_1 || CHR(13) || CHR(10) || '뒤)' || JEHENG3_2            ";
                                //SQL = SQL + ComNum.VBLF + "          FROM ADMIN.OCS_DRUGINFO_NEW M1 WHERE TRIM(M1.SUNEXT) = CODE04)  AS REMARK04  ";
                                //SQL = SQL + ComNum.VBLF + "    FROM ADMIN.DRUG_MASTER5 M                                                          ";
                                //SQL = SQL + ComNum.VBLF + "  INNER JOIN ADMIN.BAS_BCODE_DRUG B                                                   ";
                                //SQL = SQL + ComNum.VBLF + "     ON M.GUBUN = B.MCODE                                                                   ";
                                //SQL = SQL + ComNum.VBLF + "     AND CODE = 'A002'                                                                      ";
                                ...
                                SQL = SQL + ComNum.VBLF + "                     ON A.JEPCODE = C.SUNEXT                                             ";
                                SQL = SQL + ComNum.VBLF + "                 WHERE CLASS = '9775'                                                    ";
                                SQL = SQL + ComNum.VBLF + "                   AND EXISTS(SELECT * FROM ADMIN.BAS_SUT S                        ";
                                SQL = SQL + ComNum.VBLF + "                           WHERE DELDATE IS NULL                                         ";
                                SQL = SQL + ComNum.VBLF + "                               AND S.SUGBJ IN('2', '3', '4')                             ";
                                SQL = SQL + ComNum.VBLF + "                               AND A.JEPCODE = S.SUNEXT)                                 ";
                                SQL = SQL + ComNum.VBLF + "                 GROUP BY GRP                                                            ";
                            ...
                            case "9777":    // 동일성분/다함량 의약품
                                ...
                                //SQL = SQL + ComNum.VBLF + "     (SELECT HAMYANG1 || HAMYANG2 FROM ADMIN.DRUG_MASTER1   ";
                                ...
                                //SQL = SQL + ComNum.VBLF + " LEFT OUTER JOIN ADMIN.OCS_DRUGINFO_NEW C1                  ";
                                //SQL = SQL + ComNum.VBLF + "     ON TRIM(M.CODE01) = TRIM(C1.SUNEXT)                         ";
                                //SQL = SQL + ComNum.VBLF + " LEFT OUTER JOIN ADMIN.OCS_DRUGINFO_NEW C2                  ";
                                //SQL = SQL + ComNum.VBLF + "     ON TRIM(M.CODE02) = TRIM(C2.SUNEXT)                         ";
                                //SQL = SQL + ComNum.VBLF + " LEFT OUTER JOIN ADMIN.OCS_DRUGINFO_NEW C3                  ";
                                //SQL = SQL + ComNum.VBLF + "     ON TRIM(M.CODE03) = TRIM(C3.SUNEXT)                         ";
                                //SQL = SQL + ComNum.VBLF + " LEFT OUTER JOIN ADMIN.OCS_DRUGINFO_NEW C4                  ";
                                //SQL = SQL + ComNum.VBLF + "     ON TRIM(M.CODE04) = TRIM(C4.SUNEXT)                         ";
                                //SQL = SQL + ComNum.VBLF + " LEFT OUTER JOIN ADMIN.OCS_DRUGINFO_NEW C5                  ";
                                ...
                                SQL = SQL + ComNum.VBLF + "    FROM ADMIN.OCS_DRUGINFO_COMPONENT A                         ";
                                SQL = SQL + ComNum.VBLF + "    INNER JOIN ADMIN.OCS_DRUGINFO_NEW B                         ";
                                SQL = SQL + ComNum.VBLF + "      ON A.SUNEXT = B.SUNEXT                                         ";
                                SQL = SQL + ComNum.VBLF + "    INNER JOIN ADMIN.BAS_SUN C                                 ";
                                SQL = SQL + ComNum.VBLF + "      ON A.SUNEXT = C.SUNEXT                                         ";
                                SQL = SQL + ComNum.VBLF + "    INNER JOIN ADMIN.DRUG_MASTER1 D                             ";
                                SQL = SQL + ComNum.VBLF + "      ON TRIM(B.SUNEXT) = TRIM(D.JEPCODE)                            ";
                                SQL = SQL + ComNum.VBLF + "    INNER JOIN ADMIN.DRUG_MASTER2 E                             ";
                    ...
                    case "4":
                        ...
                        SQL = SQL + ComNum.VBLF + "     DECODE(B.SAVEBRIGHT, '1', '차광', '') AS SAVEBRIGHT, B.SAVEBRIGHTETC ";
                        SQL = SQL + ComNum.VBLF + " FROM ADMIN.OCS_DRUGINFO_NEW A, ADMIN.DRUG_MASTER2 B, ADMIN.DRUG_MASTER5 C ";
                        SQL = SQL + ComNum.VBLF + "      WHERE A.SUNEXT = B.JEPCODE(+) ";
        ...
        private void READ_DATA_H()
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + ",    (SELECT LISTAGG(SUNGBUN, ', ')  WITHIN GROUP(ORDER BY RANKING) FROM ADMIN.DRUG_MASTER1_SUNGBUN WHERE JEPCODE = A.JEPCODE) AS SUNGBUN  ";
                SQL = SQL + ComNum.VBLF + ",    (SELECT UNIT FROM ADMIN.OCS_DRUGINFO_NEW WHERE SUNEXT = A.JEPCODE) AS UNIT             ";
        ...
        private void READ_DATA_G()
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "    , (SELECT CLASSNAME FROM ADMIN.BAS_CLASS WHERE CLASSCODE = A.BUNCODE) AS BUN_NM";
        ...
        private void SETCOMBO_Antibiotic(PsmhDb pDbCon, ComboBox cbo)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + " INNER JOIN ADMIN.DRUG_JEP B    ";
                SQL = SQL + ComNum.VBLF + "    ON A.JEPCODE = B.JEPCODE         ";

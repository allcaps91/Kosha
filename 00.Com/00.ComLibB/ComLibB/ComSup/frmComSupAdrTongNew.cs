    ...
    public partial class frmComSupAdrTongNew : Form
    {
        ...
        private void GetData()
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "          FROM KOSMOS_ADM.DRUG_ADR1 A                                                    ";
                SQL = SQL + ComNum.VBLF + "               INNER JOIN KOSMOS_ADM.DRUG_ADR1_ORDER B                                   ";
                SQL = SQL + ComNum.VBLF + "                       ON A.SEQNO = B.SEQNO                                              ";
                SQL = SQL + ComNum.VBLF + "               INNER JOIN KOSMOS_OCS.OCS_DRUGINFO_NEW C                                  ";
                SQL = SQL + ComNum.VBLF + "                       ON B.SUCODE = C.SUNEXT                                            ";
                SQL = SQL + ComNum.VBLF + "               INNER JOIN KOSMOS_PMPA.BAS_CLASS D                                        ";
                ...
                SQL = SQL + ComNum.VBLF + "               WDATE                                                                     ";
                SQL = SQL + ComNum.VBLF + "          FROM KOSMOS_ADM.DRUG_ADR1 A                                                    ";
                SQL = SQL + ComNum.VBLF + "               INNER JOIN KOSMOS_ADM.DRUG_ADR1_ORDER_JO B                                ";
                SQL = SQL + ComNum.VBLF + "                       ON A.SEQNO = B.SEQNO                                              ";
                SQL = SQL + ComNum.VBLF + "               INNER JOIN KOSMOS_OCS.OCS_DRUGINFO_NEW C                                  ";
                SQL = SQL + ComNum.VBLF + "                       ON B.SUCODE = C.SUNEXT                                            ";
                SQL = SQL + ComNum.VBLF + "               INNER JOIN KOSMOS_PMPA.BAS_CLASS D                                        ";
                ...
                if (dt.Rows.Count > 0)
                {
                    for (i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        SQL = SQL + ComNum.VBLF + "    FROM KOSMOS_PMPA.BAS_BCODE B1                                                                        ";
                        ...
                        SQL = SQL + ComNum.VBLF + "    FROM KOSMOS_ADM.DRUG_ADR1 T1                                                                         ";

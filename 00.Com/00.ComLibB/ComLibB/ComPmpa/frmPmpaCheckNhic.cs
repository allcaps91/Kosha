...
/// <summary>
/// Description : 건강보험,의료급여 자격관리
/// Author : 박병규
/// Create Date : 2017.06.23
/// </summary>
/// <history>
/// </history>
/// <seealso cref="frm보험자격확인new2.frm"/>

namespace ComLibB
{
    public partial class frmPmpaCheckNhic : Form
    {
        ...
        public frmPmpaCheckNhic()
        {
            InitializeComponent();
            setEvent();
        }

        public frmPmpaCheckNhic(string ArgPtno, string ArgDept, string ArgSname, string ArgJumin1, string ArgJumin2, string ArgDate, string ArgGkiho)
        {
            InitializeComponent();
        ...
        private void eForm_Load(object sender, EventArgs e)
        {
            ...
            frmPmpaCheckNhic frm = new frmPmpaCheckNhic();
            ...
            frmPmpaCheckNhic frmNhic = new frmPmpaCheckNhic();
        ...
        private void Search_Process(PsmhDb pDbCon)
        {
            ...
            txtTimer.Text = FnTimerCnt.ToString();
            Timer1.Enabled = false;
            ...
            SQL += ComNum.VBLF + "        M2_DISREG20                                               --잠복결핵 ";
                ...
                if (strJOB_STS == "2")      //확인완료
                {
                    ...
                    switch (Dt.Rows[0]["M2_BONIN"].ToString().Trim())
                    {
                        ...
                        default:
                            ...
                            if (Dt.Rows[0]["M2_SANGSIL"].ToString().Trim() != "") { lblMsg.Text = "02.급여제한 대상자"; }
                            break;
                    }
                    ...
                    if (Dt.Rows[0]["M2_RESTRICT"].ToString().Trim() == "01") { lblMsg.Text = "01.무자격자"; }
                    if (Dt.Rows[0]["M2_RESTRICT"].ToString().Trim() == "02") { lblMsg.Text = "02.6회 이상 체납에 의한 급여제한"; }
                    if (Dt.Rows[0]["M2_RESTRICT"].ToString().Trim() == "03") { lblMsg.Text = "03.외국인, 재외국민 보험료 체납에 의한 급여제한"; }
                    if (Dt.Rows[0]["M2_RESTRICT"].ToString().Trim() == "04") { lblMsg.Text = "04.사망자"; }
                    if (Dt.Rows[0]["M2_RESTRICT"].ToString().Trim() == "05") { lblMsg.Text = "05.국외이민자"; }
                    ...
                    if (Dt.Rows[0]["M2_DISREG4"].ToString().Trim() != "")
                    {
                        ...
                        FstrSdate = VB.Mid(Dt.Rows[0]["M2_DISREG4"].ToString().Trim(), 20, 8);
                        ...
                        FstrEdate = VB.Mid(Dt.Rows[0]["M2_DISREG4"].ToString().Trim(), 28, 8);
                        ...
                        string strIcode = VB.Mid(Dt.Rows[0]["M2_DISREG4"].ToString().Trim(), 36, 5); ;
                        ...
                        FstrJcode = VB.Mid(Dt.Rows[0]["M2_DISREG4"].ToString().Trim(), 5, 15); ;

                        if (clsPublic.GstrPassProgramID == "OUMSAD")
                        {

                            CQ.AUTO_BAS_CANCER_INSERT(pDbCon, "1", FstrPtno, FstrSname, FstrJumin, FstrDept, FstrSdate, FstrEdate, FstrJcode, strIcode, FstrSpcCode,"");
                        }
                    ...
                    if (Dt.Rows[0]["M2_DISREG2"].ToString().Trim() != "")
                    {
                        ...
                        if (clsPublic.GstrPassProgramID == "OUMSAD")
                        {
                            ...
                            CQ.AUTO_BAS_CANCER_INSERT(pDbCon, "2", FstrPtno, FstrSname, FstrJumin, FstrDept, FstrSdate, FstrEdate, FstrJcode, "", "","2");
                        }
                    ...
                    if (Dt.Rows[0]["M2_DISREG2_B"].ToString().Trim() != "")
                    {
                         ...
                         if (clsPublic.GstrPassProgramID == "OUMSAD")
                        {
                            ...
                            CQ.AUTO_BAS_CANCER_INSERT(pDbCon, "2", FstrPtno, FstrSname, FstrJumin, FstrDept, FstrSdate, FstrEdate, FstrJcode, "", "","3");
                        }
                    ...
                    #region 산정특례(잠복결핵)등록대상자 2021-11-09
                    string strReg20 = string.Empty;
                    if (Dt.Rows[0]["M2_DISREG20"].ToString().Trim() != "")
                    {
                        ssPrint_Sheet1.RowCount = ssPrint_Sheet1.RowCount + 1;
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 0].Text = "산정특례(잠복결핵)등록대상자";

                        ssPrint_Sheet1.RowCount = ssPrint_Sheet1.RowCount + 1;
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 0].Text = "특정기호 : ";
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 1].Text = VB.Left(Dt.Rows[0]["M2_DISREG20"].ToString().Trim(), 4);

                        ssPrint_Sheet1.RowCount = ssPrint_Sheet1.RowCount + 1;
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 0].Text = "등 록 일 : ";
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 1].Text = VB.Mid(Dt.Rows[0]["M2_DISREG20"].ToString().Trim(), 20, 8);


                        strDate = ComFunc.FormatStrToDate(VB.Mid(Dt.Rows[0]["M2_DISREG20"].ToString().Trim(), 20, 8), "D");

                        ssPrint_Sheet1.RowCount = ssPrint_Sheet1.RowCount + 1;
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 0].Text = "종 료 일 : ";
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 1].Text = VB.Mid(Dt.Rows[0]["M2_DISREG20"].ToString().Trim(), 28, 8);

                        ssPrint_Sheet1.RowCount = ssPrint_Sheet1.RowCount + 1;
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 0].Text = "등록코드 : ";
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 1].Text = VB.Mid(Dt.Rows[0]["M2_DISREG20"].ToString().Trim(), 5, 15);

                        ssPrint_Sheet1.RowCount = ssPrint_Sheet1.RowCount + 1;
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 0].Text = "상병코드 : ";
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 1].Text = VB.Mid(Dt.Rows[0]["M2_DISREG20"].ToString().Trim(), 36, 10);

                        ssPrint_Sheet1.RowCount = ssPrint_Sheet1.RowCount + 1;
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 0].Text = "일련번호 : ";
                        ssPrint_Sheet1.Cells[ssPrint_Sheet1.RowCount - 1, 1].Text = VB.Mid(Dt.Rows[0]["M2_DISREG20"].ToString().Trim(), 46, 2);


                        if (Dt.Rows[0]["M2_JAGEK"].ToString().Trim() == "7" || Dt.Rows[0]["M2_JAGEK"].ToString().Trim() == "8")
                        {
                            if (VB.Left(Dt.Rows[0]["M2_DISREG20"].ToString().Trim(), 1) == "V")
                                ComFunc.MsgBox("의료급여환자이나, 희귀난치 [V000] 대상자입니다.");
                        }
                        else
                        {
                    ...
                    if (Dt.Rows[0]["M2_DISREG10"].ToString().Trim() != "")
                    {
                        ...
                        if (clsPublic.GstrPassProgramID == "OUMSAD" && VB.Len(FstrJcode1) == 10)
                        {
                            CQ.AUTO_BAS_CANCER_INSERT(pDbCon, "4", FstrPtno, FstrSname, FstrJumin, FstrDept, FstrSdate1, FstrEdate1, FstrJcode1, "", "",""); 
                        } 
                    }
                    #endregion
        ...
        private void Save_Process(PsmhDb pDbCon)
        {
            ...
            string strDdate = string.Empty;
            string strMcode = string.Empty;

            //if (ComQuery.IsJobAuth(this, "C", pDbCon) == false) { return; }     //권한확인

            //의료급여만
            strBi = VB.Left(ssList_Sheet1.Cells[3, 1].Text.Trim(), 1);

            // 의료급여-산정특례(희귀)등록자 자동등록
            // if (clsPublic.GstrPassProgramID == "OUMSAD" && VB.Len(FstrJcode) == 15 && (strBi == "7" || strBi == "8"))
            //     CQ.AUTO_BAS_CANCER_INSERT(pDbCon, "2", FstrPtno, FstrSname, FstrJumin, FstrDept, FstrSdate, FstrEdate, FstrJcode);
            ...
            //급여제한일자
            strDdate = ssList_Sheet1.Cells[7, 1].Text.Trim();
            //본인부담여부
            strMcode = ssList_Sheet1.Cells[9, 1].Text.Trim();

            if (strDdate != "")
            {
                if (strMcode == "M001" || strMcode == "M002" || strMcode == "B001" || strMcode == "B002")
                    ComFunc.MsgBox("본 환자는 조건부 연장 또는 자발적 참여자입니다." + '\r' + "수납시 승인요청을 할 수 있습니다.", "확인");
                else
                {
                    ComFunc.MsgBox("본 환자는 자격이 상실되었습니다.", "확인");
                    this.Close();
                }
            }

            clsPublic.GstrHelpCode = "";
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[2, 1].Text.Trim() + ";";    //세대주성명
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[3, 1].Text.Trim() + ";";    //자격여부
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[4, 1].Text.Trim() + ";";    //자격취득일자
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[5, 1].Text.Trim() + ";";    //보장기관기호
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[6, 1].Text.Trim() + ";";    //시설(증번호)
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[7, 1].Text.Trim() + ";";    //급여제한일자
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[8, 1].Text.Trim() + ";";    //건강생활유지비 잔액
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[9, 1].Text.Trim() + ";";    //본인부담여부
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[11, 1].Text.Trim() + ";";   //장애인여부
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[12, 1].Text.Trim() + ";";   //출국자여부
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[13, 1].Text.Trim() + ";";   //선택의료급여기관1
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[14, 1].Text.Trim() + ";";   //선택의료급여기관2
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[15, 1].Text.Trim() + ";";   //선택의료급여기관3
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[16, 1].Text.Trim() + ";";   //선택의료급여기관4
            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[1, 1].Text.Trim() + ";";    //수신자성명

            clsPublic.GstrHelpCode += FstrJanamt + ";";                               //산전지원금 잔액
            clsPublic.GstrHelpCode += FstrVcode + ";";                                //희귀 V코드
            clsPublic.GstrHelpCode += FstrSpcCode + ";";                              //특정코드 전체

            clsPublic.GstrHelpCode += ssList_Sheet1.Cells[17, 1].Text.Trim() + ";";   //주민등록번호
            clsPublic.GstrHelpCode += FstrDentNo + ";";                               //노인틀니 등록번호

            clsPublic.GstrHelpCode += VB.Pstr(lblMsg.Text, ".", 1) + ";";             //급여제한대상자

            clsPublic.GstrHelpCode += FstrEdate1 + ";";                               //조산 및 저체중아등록자 종료일

            //보험내역 History 저장
            INSERT_BAS_MIH_OPD(pDbCon);

            this.Close();
        }

        //보험내역 History 저장
        private void INSERT_BAS_MIH_OPD(PsmhDb pDbCon)
        {
            string strBi = string.Empty;
            ...
            if (clsPublic.GstrHelpCode == "") { return; }
            ...
            if (strKiho == "" && strGkiho == "") { return; }
            switch (VB.Left(strJagek, 1))
            {
                case "1":
                case "2":
                    strBi = "13";
                    strKiho = "00000000000";
                    strGkiho = VB.Left(strGkiho, 1) + "-" + VB.Mid(strGkiho, 2, 20);
            ...
            if (Dt.Rows.Count == 0)
            {
                ...
                try
                {
                    ...
                    SQL += ComNum.VBLF + " VALUES ('" + FstrPtno + "', ";
                    SQL += ComNum.VBLF + "         '" + strBi + "', ";
                    SQL += ComNum.VBLF + "         TO_DATE('" + ComFunc.FormatStrToDate(ComQuery.CurrentDateTime(pDbCon, "D"),"D") + "','YYYY-MM-DD'), ";
                    SQL += ComNum.VBLF + "         '" + strPname + "', ";
                    SQL += ComNum.VBLF + "         '0', ";
                    SQL += ComNum.VBLF + "         '" + strKiho + "', ";
                    SQL += ComNum.VBLF + "         '" + strGkiho + "' ) ";
                    SqlErr = clsDB.ExecuteNonQuery(SQL, ref intRowCnt, pDbCon);

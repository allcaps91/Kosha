...
namespace ComLibB
{
    ...
    /// </summary>
    /// <vbp>
    /// default : Z:\차세대 의료정보시스템\1-0 착수단계\1-5 참고 소스\포항성모병원 VB Source(2017.01.11)_분석설계제작용\basic\busuga\BuSuga06.frm
    /// </vbp>
    public partial class PmpaMirNUHelp : Form
    {
        string GstrHelpCode = "";
        ...
        public PmpaMirNUHelp()
        {
            InitializeComponent();
        }

        public PmpaMirNUHelp(string rGstrHelpCode)
        {
            InitializeComponent();
            GstrHelpCode = rGstrHelpCode;
        }

        private void PmpaMirNUHelp_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "WHERE JONG ='2'"; //누적
                ...
                {
                    strList = VB.Left(dt.Rows[i]["CODE"] + VB.Space(5), 5);

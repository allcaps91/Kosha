...
/// 완료
/// </history>
/// <summary> 입원 청구상병 자동발생 등록 </summary>
namespace ComLibB
{
    public partial class frmIpdMill : Form
    {
        public frmIpdMill()
        {
            InitializeComponent();
        ...
        void frmIpdMill_Load(object sender, EventArgs e)
        {
        ...
        void ScreenDisplay()
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "      TO_CHAR(a.EntDate,'YYYY-MM-DD') EntDate,a.ROWID, A.SEX ";
        ...
        void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                for (i = 0; i < ssView_Sheet1.NonEmptyRowCount; i++)
                {
                    ...
                    strDeptCode = ssView_Sheet1.Cells[i, 3].Text.Trim();
                    strSex = ssView_Sheet1.Cells[i, 5].Text.Trim();
                    strRO1 = ssView_Sheet1.Cells[i, 6].Text.Trim();
                    strIllCode1 = ssView_Sheet1.Cells[i, 7].Text.Trim();
                    strRO2 = ssView_Sheet1.Cells[i, 9].Text.Trim();
                    strIllCode2 = ssView_Sheet1.Cells[i, 10].Text.Trim();
                    strRO2 = ssView_Sheet1.Cells[i, 12].Text.Trim();
                    strIllCode3 = ssView_Sheet1.Cells[i, 13].Text.Trim();
                    strROWID = ssView_Sheet1.Cells[i, 16].Text.Trim();
                    strChange = ssView_Sheet1.Cells[i, 17].Text.Trim();
                    ...
                    else if (strChange == "Y")
                    {
                        if (strROWID == "" && strSuCode != "")
                        {
                            ...
                            SQL = "";
                            SQL = "INSERT INTO " + ComNum.DB_PMPA + "BAS_MILL (SuCode,DeptCode,IllCode1,IllCode2,IllCode3,EntDate,SEX, RO1, RO2, RO3,GBIO) ";
                            SQL = SQL + ComNum.VBLF + "VALUES ('" + strSuCode + "','" + strDeptCode + "',";
                            SQL = SQL + ComNum.VBLF + "'" + strIllCode1 + "','" + strIllCode2 + "','" + strIllCode3 + "',SYSDATE," + "'" + strSex + "', ";
                            SQL = SQL + ComNum.VBLF + " '" + strRO1 + "', '" + strRO2 + "','" + strRO3 + "','I') ";
                        }
                        else if (strROWID != "")
                        {
                            ...
                            SQL = "";
                            SQL = "UPDATE " + ComNum.DB_PMPA + "BAS_MILL SET SuCode='" + strSuCode + "',";
        ...
        void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            strHead1 = "/n" + "/c/f1" + "입원 청구상병 자동발생 내역(BAS_MILL)" + "1/n";
        ...
        void ssView_Change(object sender, ChangeEventArgs e)
        {
            ...
            try
            {
                ...
                strData = VB.UCase(ssView_Sheet1.Cells[e.Row, e.Column].Text);
                ...
                switch (e.Column)
                {
                    case 1:
                        ...
                        else
                        {
                            ...
                            ComFunc.MsgBox(strData + " 수가코드 등록 않됨", "확인");
                        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            ssView.Search(0, txtSearch.Text.Trim(), false, false, false, false, 0, 0, ssView_Sheet1.RowCount - 1, ssView_Sheet1.ColumnCount - 1,
            ref foundRow, ref foundColum);
        ...
        private void ssView_ClipboardPasted(object sender, ClipboardPastedEventArgs e)
        {
            ...
            try
            {
                ...
                strData = VB.UCase(ssView_Sheet1.Cells[e.CellRange.Row, e.CellRange.Column].Text);

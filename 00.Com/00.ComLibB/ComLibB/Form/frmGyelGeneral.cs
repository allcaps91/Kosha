...
namespace ComLibB
{
    ...
    /// 결핵환자 교육삼당료1 서식
    /// </summary>
    public partial class frmGyelGeneral : Form
    {
        ...
        public frmGyelGeneral()
        {
            InitializeComponent();
        }

        public frmGyelGeneral(string strPANO, string strIllcode, string strSaveGu = "")
        {
            InitializeComponent();
        ...
        private void frmGyelGeneral_Load(object sender, EventArgs e)
        {
            //폼 권한 조회
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(GstrROWID) == false)
            {
                ...
                try
                {
                    ...
                    SQL = "";
                    SQL = "DELETE " + ComNum.DB_PMPA + "NUR_STD_INFECT11  WHERE ROWID = '" + GstrROWID + "'";
        ...
        private bool SaveData()
        {
            ...
            try
            {
                ...
                {
                    SQL = "";
                    SQL = "UPDATE " + ComNum.DB_PMPA + "NUR_STD_INFECT11";
                ...
                {
                    SQL = "";
                    SQL = "INSERT INTO " + ComNum.DB_PMPA + "NUR_STD_INFECT11";

...
namespace ComLibB
{
    ...
    /// 결핵환자 교육삼당료1 서식
    /// </summary>
    public partial class frmGyelGeneral2 : Form
    {
        ...
        public frmGyelGeneral2()
        {
            InitializeComponent();
        }

        public frmGyelGeneral2(string strPANO,  string strIllcode, string strSaveGu = "")
        {
            InitializeComponent();
        ...
        private void frmGyelGeneral2_Load(object sender, EventArgs e)
        {
            //폼 권한 조회
        ...
        private void Screen_display()
        {
            ...
            try
            {
                ...
                {
                    //의사성명
                    ssView2_Sheet1.Cells[16, 2].Text = dt.Rows[0]["DRNAME"].ToString().Trim();
                    ssView2_Sheet1.Cells[16, 4].Text = dt.Rows[0]["DRBUNHO"].ToString().Trim();
                    ssView2_Sheet1.Cells[16, 6].Text = dt.Rows[0]["DEPTCODE"].ToString().Trim();
                }
                else
                {
                    dt.Dispose();
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ssView2_Sheet1.Cells[16, 2].Text = dt.Rows[0]["KORNAME"].ToString().Trim();
                    }
                }
                ...
                ssView2_Sheet1.Cells[17, 2].Text = cpublic.strSysDate;
        ...
        private void SCREEN_CLEAR()
        {
            ...
            ssView2_Sheet1.Cells[18, 4].Value = false;
            ssView2_Sheet1.Cells[18, 7].Value = false;
            ssView2_Sheet1.Cells[18, 8].Value = null;

            ssView2_Sheet1.Cells[20, 2].Value = null;
            ssView2_Sheet1.Cells[20, 6].Value = null;
            ssView2_Sheet1.Cells[20, 8].Value = null;
            ssView2_Sheet1.Cells[20, 9].Value = null;

            ssView2_Sheet1.Cells[21, 4].Value = null;
            ssView2_Sheet1.Cells[22, 4].Value = null;
            ssView2_Sheet1.Cells[23, 2].Value = null;
            ssView2_Sheet1.Cells[24, 2].Value = null;
            ...
            ssView2_Sheet1.Cells[29, 9].Value = null;

            ssView2_Sheet1.Cells[30, 2].Value = false;
            ssView2_Sheet1.Cells[30, 7].Value = false;

            ssView2_Sheet1.Cells[31, 2].Value = false;
            ssView2_Sheet1.Cells[31, 7].Value = false;

            ssView2_Sheet1.Cells[32, 2].Value = false;
            ssView2_Sheet1.Cells[32, 7].Value = false;
            ...
            ssView2_Sheet1.Cells[36, 8].Value = null;

            ssView2_Sheet1.Cells[37, 2].Value = null;
            ssView2_Sheet1.Cells[39, 2].Value = null;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(GstrROWID) == false)
            {
                ...
                try
                {
                    ...
                    SQL = "";
                    SQL = "DELETE " + ComNum.DB_PMPA + "NUR_STD_INFECT12  WHERE ROWID = '" + GstrROWID + "'";
        ...
        private bool SaveData()
        {
            ...
            //시행일자
            strGDate = ssView2_Sheet1.Cells[17, 2].Text.Trim();

            //관리방법
            strGhow = ssView2_Sheet1.Cells[18, 2].Text.Trim() == "True" ? "1" : "0";
            strGhow2 = ssView2_Sheet1.Cells[18, 4].Text.Trim() == "True" ? "1" : "0";
            strGhow3 = ssView2_Sheet1.Cells[18, 8].Text.Trim();

            //교육제공대상
            if (ssView2_Sheet1.Cells[20, 2].Value != null)
            {
                strSuJect = ssView2_Sheet1.Cells[20, 2].Value.ToString();
            }
            else
            {
                strSuJect = "";
            }
            if (ssView2_Sheet1.Cells[20, 8].Value != null)
            {
                strSuJect1 = ssView2_Sheet1.Cells[20, 8].Value.ToString();
            }
            else
            {
                strSuJect1 = "";
            ...
            strSuJect2 = ssView2_Sheet1.Cells[20, 6].Text.Trim();
            strSuJect3 = ssView2_Sheet1.Cells[20, 10].Text.Trim();

            //음주흡연여부
            if (ssView2_Sheet1.Cells[21, 4].Value != null)
            {
                strSmokeGu = ssView2_Sheet1.Cells[21, 4].Value.ToString();
            }
            else
            {
                strSmokeGu = "";
            }
            if (ssView2_Sheet1.Cells[22, 4].Value != null)
            {
                strAlcoholGu = ssView2_Sheet1.Cells[22, 4].Value.ToString();
            }
            else
            {
                strAlcoholGu = "";
            ...
            {
                strDegreecom = ssView2_Sheet1.Cells[23, 2].Value.ToString();
            }
            else
            {
                strDegreecom = "";
            ...
            //약제부작용여부
            if (ssView2_Sheet1.Cells[24, 2].Value != null)
            {
                strSeffect = ssView2_Sheet1.Cells[24, 2].Value.ToString();
            }
            else
            {
                strSeffect = "";
            ...
            strSeffect01 = ssView2_Sheet1.Cells[25, 2].Text.Trim() == "True" ? "1" : "0";
            strSeffect02 = ssView2_Sheet1.Cells[26, 2].Text.Trim() == "True" ? "1" : "0";
            strSeffect03 = ssView2_Sheet1.Cells[27, 2].Text.Trim() == "True" ? "1" : "0";
            strSeffect04 = ssView2_Sheet1.Cells[28, 2].Text.Trim() == "True" ? "1" : "0";
            strSeffect05 = ssView2_Sheet1.Cells[29, 2].Text.Trim() == "True" ? "1" : "0";

            strSeffect06 = ssView2_Sheet1.Cells[25, 5].Text.Trim() == "True" ? "1" : "0";
            strSeffect07 = ssView2_Sheet1.Cells[26, 5].Text.Trim() == "True" ? "1" : "0";
            strSeffect08 = ssView2_Sheet1.Cells[27, 5].Text.Trim() == "True" ? "1" : "0";
            strSeffect09 = ssView2_Sheet1.Cells[28, 5].Text.Trim() == "True" ? "1" : "0";
            strSeffect10 = ssView2_Sheet1.Cells[29, 5].Text.Trim() == "True" ? "1" : "0";

            strSeffect11 = ssView2_Sheet1.Cells[25, 8].Text.Trim() == "True" ? "1" : "0";
            strSeffect12 = ssView2_Sheet1.Cells[26, 8].Text.Trim() == "True" ? "1" : "0";
            strSeffect13 = ssView2_Sheet1.Cells[27, 8].Text.Trim() == "True" ? "1" : "0";
            strSeffect14 = ssView2_Sheet1.Cells[29, 9].Text.Trim();

            //교육상담내용
            strEduContents01 = ssView2_Sheet1.Cells[30, 2].Text.Trim() == "True" ? "1" : "0";
            strEduContents02 = ssView2_Sheet1.Cells[31, 2].Text.Trim() == "True" ? "1" : "0";
            strEduContents03 = ssView2_Sheet1.Cells[32, 2].Text.Trim() == "True" ? "1" : "0";
            strEduContents04 = ssView2_Sheet1.Cells[33, 2].Text.Trim() == "True" ? "1" : "0";
            strEduContents05 = ssView2_Sheet1.Cells[34, 2].Text.Trim() == "True" ? "1" : "0";
            strEduContents06 = ssView2_Sheet1.Cells[35, 2].Text.Trim() == "True" ? "1" : "0";

            strEduContents07 = ssView2_Sheet1.Cells[30, 7].Text.Trim() == "True" ? "1" : "0";
            strEduContents08 = ssView2_Sheet1.Cells[31, 7].Text.Trim() == "True" ? "1" : "0";
            strEduContents09 = ssView2_Sheet1.Cells[32, 7].Text.Trim() == "True" ? "1" : "0";
            strEduContents10 = ssView2_Sheet1.Cells[33, 7].Text.Trim() == "True" ? "1" : "0";
            strEduContents11 = ssView2_Sheet1.Cells[35, 7].Text.Trim() == "True" ? "1" : "0";
            strEduContents12 = ssView2_Sheet1.Cells[36, 8].Text.Trim();

            //교육내용이해정도
            if (ssView2_Sheet1.Cells[37, 2].Value != null)
            {
                strEduEvende = ssView2_Sheet1.Cells[37, 2].Value.ToString();
            }
            else
            {
                strEduEvende = "";
            ...
            //기타기재사항
            strRemark = ssView2_Sheet1.Cells[39, 2].Text.Trim();
            ...
            //if (strGDate == "")
            //{
            //    ComFunc.MsgBox("시행일자를 반드시 입력 해주십시오.");
            //    return rtnVal;
            //}

            //if (strSuJect == "" && strSuJect1 == "")
            //{
            //    ComFunc.MsgBox("관리제공대상을 반드시 체크해주십시오.");
            //    return rtnVal;
            //}
            //if (strSmokeGu == "")
            //{
            ...
            try
            {
                ...
                {
                    SQL = "";
                    SQL = "UPDATE " + ComNum.DB_PMPA + "NUR_STD_INFECT12";
                    ...
                    SQL = SQL + ComNum.VBLF + "         GHOW = '" + strGhow + "', ";
                    SQL = SQL + ComNum.VBLF + "         GHOW2 = '" + strGhow2 + "', ";
                    SQL = SQL + ComNum.VBLF + "         GHOW3 = '" + strGhow3 + "', ";
                    ...
                    SQL = SQL + ComNum.VBLF + "         GDATE = TO_DATE('" + strGDate + "','YYYY-MM-DD'), ";
                ...
                {
                    SQL = "";
                    SQL = "INSERT INTO " + ComNum.DB_PMPA + "NUR_STD_INFECT12";
                    SQL = SQL + ComNum.VBLF + " (ACTDATE, PANO, SNAME, ILLCODE,  GUNGU, M2_DISREG9, PATGU1, PATGU2, PATGU3, PATGU4, PATGU5, GHOW, GHOW2, GHOW3, EDUCATOR, ";
                    ...
                    SQL = SQL + ComNum.VBLF + " SEFFECT09, SEFFECT10, SEFFECT11, SEFFECT12, SEFFECT13, SEFFECT14, GDATE, EDUSUJECT, EDUSUJECT1, EDUSUJECT2, EDUSUJECT3, ";
                    ...
                    SQL = SQL + ComNum.VBLF + " EDUCONTENTS09, EDUCONTENTS10, EDUCONTENTS11, EDUCONTENTS12, EDUEVENDE, BIGO1, ENTDATE, ENTSABUN) ";
                    ...
                    SQL = SQL + ComNum.VBLF + "         '" + strGhow + "', ";
                    SQL = SQL + ComNum.VBLF + "         '" + strGhow2 + "', ";
                    SQL = SQL + ComNum.VBLF + "         '" + strGhow3 + "', ";
                    ...
                    SQL = SQL + ComNum.VBLF + "         TO_DATE('" + strGDate + "','YYYY-MM-DD'), ";
        ...
        private void ssList_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            try
            {
                SQL = "";
                SQL = "SELECT";
                SQL = SQL + ComNum.VBLF + "     A.ACTDATE, A.PANO, A.SNAME, A.ILLCODE,  A.GUNGU, A.M2_DISREG9, A.PATGU1, A.PATGU2, A.PATGU3, A.PATGU4, A.PATGU5, A.GHOW, A.GHOW2, A.GHOW3, A.EDUCATOR, ";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //ssView2_Sheet1.Cells[16, 2].Text = clsVbfunc.GetOCSDrNameSabun(clsDB.DbCon, dt.Rows[0]["EDUCATOR"].ToString().Trim());
                    //ssView2_Sheet1.Cells[16, 4].Text = clsVbfunc.GetOCSDoctorDRBUNHO(clsDB.DbCon, dt.Rows[0]["EDUCATOR"].ToString().Trim());
                    //ssView2_Sheet1.Cells[16, 2].Text = clsVbfunc.GetInSaName(clsDB.DbCon, dt.Rows[0]["EDUCATOR"].ToString().Trim());
                    ...
                    else
                    {
                        ssView2_Sheet1.Cells[16, 2].Text = clsVbfunc.GetOCSDrNameSabun(clsDB.DbCon, dt.Rows[0]["EDUCATOR"].ToString().Trim());
                        ssView2_Sheet1.Cells[16, 4].Text = clsVbfunc.GetOCSDoctorDRBUNHO(clsDB.DbCon, dt.Rows[0]["EDUCATOR"].ToString().Trim());
                        ssView2_Sheet1.Cells[16, 6].Text = clsVbfunc.GetOCSDrDeptcodeSabun(clsDB.DbCon, dt.Rows[0]["EDUCATOR"].ToString().Trim());
                    }

                    ssView2_Sheet1.Cells[17, 2].Value = dt.Rows[0]["GDATE"].ToString().Trim();
                    //
                    ssView2_Sheet1.Cells[18, 2].Value = dt.Rows[0]["GHOW"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[18, 4].Value = dt.Rows[0]["GHOW2"].ToString().Trim() == "1" ? true : false;
                    if (string.IsNullOrEmpty(dt.Rows[0]["GHOW3"].ToString().Trim()) == false)
                    {
                        ssView2_Sheet1.Cells[18, 7].Value = true;
                        ssView2_Sheet1.Cells[18, 8].Value = dt.Rows[0]["GHOW3"].ToString().Trim();
                    }


                    //
                    ssView2_Sheet1.Cells[20, 2].Value = dt.Rows[0]["EDUSUJECT"].ToString().Trim() == "" ? null : dt.Rows[0]["EDUSUJECT"].ToString().Trim();
                    ssView2_Sheet1.Cells[20, 6].Value = dt.Rows[0]["EDUSUJECT2"].ToString().Trim() == "" ? null : dt.Rows[0]["EDUSUJECT2"].ToString().Trim();
                    ssView2_Sheet1.Cells[20, 8].Value = dt.Rows[0]["EDUSUJECT1"].ToString().Trim() == "" ? null : dt.Rows[0]["EDUSUJECT1"].ToString().Trim();
                    ssView2_Sheet1.Cells[20, 10].Value = dt.Rows[0]["EDUSUJECT3"].ToString().Trim() == "" ? null : dt.Rows[0]["EDUSUJECT3"].ToString().Trim();

                    ssView2_Sheet1.Cells[21, 4].Value = dt.Rows[0]["SMOKEGU"].ToString().Trim() == "" ? null : dt.Rows[0]["SMOKEGU"].ToString().Trim();
                    ssView2_Sheet1.Cells[22, 4].Value = dt.Rows[0]["ALCOHOLGU"].ToString().Trim() == "" ? null : dt.Rows[0]["ALCOHOLGU"].ToString().Trim();
                    ssView2_Sheet1.Cells[23, 2].Value = dt.Rows[0]["DEGREECOM"].ToString().Trim() == "" ? null : dt.Rows[0]["DEGREECOM"].ToString().Trim();
                    ssView2_Sheet1.Cells[24, 2].Value = dt.Rows[0]["SEFFECT"].ToString().Trim() == "" ? null : dt.Rows[0]["SEFFECT"].ToString().Trim();

                    ssView2_Sheet1.Cells[25, 2].Value = dt.Rows[0]["SEFFECT01"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[25, 5].Value = dt.Rows[0]["SEFFECT06"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[25, 8].Value = dt.Rows[0]["SEFFECT11"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[26, 2].Value = dt.Rows[0]["SEFFECT02"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[26, 5].Value = dt.Rows[0]["SEFFECT07"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[26, 8].Value = dt.Rows[0]["SEFFECT12"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[27, 2].Value = dt.Rows[0]["SEFFECT03"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[27, 5].Value = dt.Rows[0]["SEFFECT08"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[27, 8].Value = dt.Rows[0]["SEFFECT13"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[28, 2].Value = dt.Rows[0]["SEFFECT04"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[28, 5].Value = dt.Rows[0]["SEFFECT09"].ToString().Trim() == "1" ? true : false;
                    if (string.IsNullOrEmpty(dt.Rows[0]["SEFFECT14"].ToString().Trim()) == false)
                    {
                        ssView2_Sheet1.Cells[28, 8].Value = true;
                        ssView2_Sheet1.Cells[29, 9].Value = dt.Rows[0]["SEFFECT14"].ToString().Trim();
                    }

                    ssView2_Sheet1.Cells[29, 2].Value = dt.Rows[0]["SEFFECT05"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[29, 5].Value = dt.Rows[0]["SEFFECT10"].ToString().Trim() == "1" ? true : false;



                    ssView2_Sheet1.Cells[30, 2].Value = dt.Rows[0]["EDUCONTENTS01"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[30, 7].Value = dt.Rows[0]["EDUCONTENTS07"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[31, 2].Value = dt.Rows[0]["EDUCONTENTS02"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[31, 7].Value = dt.Rows[0]["EDUCONTENTS08"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[32, 2].Value = dt.Rows[0]["EDUCONTENTS03"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[32, 7].Value = dt.Rows[0]["EDUCONTENTS09"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[33, 2].Value = dt.Rows[0]["EDUCONTENTS04"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[33, 7].Value = dt.Rows[0]["EDUCONTENTS10"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[34, 2].Value = dt.Rows[0]["EDUCONTENTS05"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[35, 2].Value = dt.Rows[0]["EDUCONTENTS06"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[35, 7].Value = dt.Rows[0]["EDUCONTENTS11"].ToString().Trim() == "1" ? true : false;

                    if (string.IsNullOrEmpty(dt.Rows[0]["EDUCONTENTS12"].ToString().Trim()) == false)
                    {
                        ssView2_Sheet1.Cells[36, 7].Value = true;
                        ssView2_Sheet1.Cells[36, 8].Value = dt.Rows[0]["EDUCONTENTS12"].ToString().Trim();
                    }

                    ssView2_Sheet1.Cells[37, 2].Value = dt.Rows[0]["EDUEVENDE"].ToString().Trim() == "" ? null : dt.Rows[0]["EDUEVENDE"].ToString().Trim();
                    ssView2_Sheet1.Cells[39, 2].Value = dt.Rows[0]["BIGO1"].ToString().Trim();

...
namespace ComLibB
{
    ...
    /// 결핵환자 교육삼당료1 서식
    /// </summary>
    public partial class frmGyelEdu : Form
    {
        ...
        public frmGyelEdu(string strPANO, string strIllcode , string strSaveGu = "")
        {
            InitializeComponent();
        ...
        private void frmGyelEdu_Load(object sender, EventArgs e)
        {
            //폼 권한 조회
        ...
        private void Screen_display()
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    ssView2_Sheet1.Cells[18, 5].Text = strTemp;
                    ssView2_Sheet1.Cells[18, 8].Text = strTemp2;

                    if (dt.Rows[0]["IT10"].ToString().Trim() != "" && dt.Rows[0]["IT11"].ToString().Trim() != "")
                    {
                        ssView2_Sheet1.Cells[18, 11].Value = Math.Round((double.Parse(strTemp2) * 10000) / (double.Parse(strTemp) * double.Parse(strTemp)), 1);
                    }
                ...
                ssView2_Sheet1.Cells[29, 2].Text = cpublic.strSysDate;
        ...
        private void SCREEN_CLEAR()
        {
            ...
            ssView2_Sheet1.Cells[19, 4].Value = null;
            ssView2_Sheet1.Cells[20, 4].Value = null;
            ssView2_Sheet1.Cells[21, 2].Value = null;
            ...
            ssView2_Sheet1.Cells[38, 7].Value = false;


            ssView2_Sheet1.Cells[39, 7].Value = false;
            ssView2_Sheet1.Cells[39, 8].Value = null;


            ssView2_Sheet1.Cells[40, 2].Value = null;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(GstrROWID) == false)
            {
                ...
                try
                {
                    ...
                    SQL = "";
                    SQL = "DELETE " + ComNum.DB_PMPA + "NUR_STD_INFECT9  WHERE ROWID = '" + GstrROWID + "'";
        ...
        private bool SaveData()
        {
            ...
            //키몸무게비엠아이
            strHeight = ssView2_Sheet1.Cells[18, 5].Text.Trim();
            strWeight = ssView2_Sheet1.Cells[18, 8].Text.Trim();
            strBmi = ssView2_Sheet1.Cells[18, 11].Text.Trim();

            //음주흡연여부
            if (ssView2_Sheet1.Cells[19, 4].Value != null)
            {
                strSmokeGu = ssView2_Sheet1.Cells[19, 4].Value.ToString();
            }
            else
            {
                strSmokeGu = "";
            ...
            {
                strAlcoholGu = ssView2_Sheet1.Cells[20, 4].Value.ToString();
            }
            else
            {
                strAlcoholGu = "";
            ...
            //복양순응도
            if (ssView2_Sheet1.Cells[21, 2].Value != null)
            {
                strDegreecom = ssView2_Sheet1.Cells[21, 2].Value.ToString();
            }
            else
            {
                strDegreecom = "";
            ...
            {
                strSeffect = ssView2_Sheet1.Cells[22, 2].Value.ToString();
            }
            else
            {
                strSeffect = "";
            ...
            strSeffect01 = ssView2_Sheet1.Cells[23, 2].Text.Trim() == "True" ? "1" : "0";
            strSeffect02 = ssView2_Sheet1.Cells[24, 2].Text.Trim() == "True" ? "1" : "0";
            strSeffect03 = ssView2_Sheet1.Cells[25, 2].Text.Trim() == "True" ? "1" : "0";
            strSeffect04 = ssView2_Sheet1.Cells[26, 2].Text.Trim() == "True" ? "1" : "0";
            strSeffect05 = ssView2_Sheet1.Cells[27, 2].Text.Trim() == "True" ? "1" : "0";

            strSeffect06 = ssView2_Sheet1.Cells[23, 5].Text.Trim() == "True" ? "1" : "0";
            strSeffect07 = ssView2_Sheet1.Cells[24, 5].Text.Trim() == "True" ? "1" : "0";
            strSeffect08 = ssView2_Sheet1.Cells[25, 5].Text.Trim() == "True" ? "1" : "0";
            strSeffect09 = ssView2_Sheet1.Cells[26, 5].Text.Trim() == "True" ? "1" : "0";
            strSeffect10 = ssView2_Sheet1.Cells[27, 5].Text.Trim() == "True" ? "1" : "0";

            strSeffect11 = ssView2_Sheet1.Cells[23, 8].Text.Trim() == "True" ? "1" : "0";
            strSeffect12 = ssView2_Sheet1.Cells[24, 8].Text.Trim() == "True" ? "1" : "0";
            strSeffect13 = ssView2_Sheet1.Cells[25, 8].Text.Trim() == "True" ? "1" : "0";
            strSeffect14 = ssView2_Sheet1.Cells[27, 9].Text.Trim();

            //교육일자
            strEduDate = ssView2_Sheet1.Cells[29, 2].Text.Trim();
            //교육회차
            if (ssView2_Sheet1.Cells[30, 2].Value != null)
            {
                strEduCount = ssView2_Sheet1.Cells[30, 2].Value.ToString();
            }
            else
            {
                strEduCount = "";
            ...
            //교육소요시간
            strEduTime = ssView2_Sheet1.Cells[31, 2].Text.Trim();

            //교육제공대상
            if (ssView2_Sheet1.Cells[32, 2].Value != null)
            {
                strSuJect = ssView2_Sheet1.Cells[32, 2].Value.ToString();
            }
            else
            {
                strSuJect = "";
            }
            if (ssView2_Sheet1.Cells[32, 8].Value != null)
            {
                strSuJect1 = ssView2_Sheet1.Cells[32, 8].Value.ToString();
            }
            else
            {
                strSuJect1 = "";
            ...
            strSuJect2 = ssView2_Sheet1.Cells[32, 6].Text.Trim();
            strSuJect3 = ssView2_Sheet1.Cells[32, 10].Text.Trim();

            //교육상담내용
            strEduContents01 = ssView2_Sheet1.Cells[33, 2].Text.Trim() == "True" ? "1" : "0";
            strEduContents02 = ssView2_Sheet1.Cells[34, 2].Text.Trim() == "True" ? "1" : "0";
            strEduContents03 = ssView2_Sheet1.Cells[35, 2].Text.Trim() == "True" ? "1" : "0";
            strEduContents04 = ssView2_Sheet1.Cells[36, 2].Text.Trim() == "True" ? "1" : "0";
            strEduContents05 = ssView2_Sheet1.Cells[37, 2].Text.Trim() == "True" ? "1" : "0";
            strEduContents06 = ssView2_Sheet1.Cells[38, 2].Text.Trim() == "True" ? "1" : "0";

            strEduContents07 = ssView2_Sheet1.Cells[33, 7].Text.Trim() == "True" ? "1" : "0";
            strEduContents08 = ssView2_Sheet1.Cells[34, 7].Text.Trim() == "True" ? "1" : "0";
            strEduContents09 = ssView2_Sheet1.Cells[35, 7].Text.Trim() == "True" ? "1" : "0";
            strEduContents10 = ssView2_Sheet1.Cells[36, 7].Text.Trim() == "True" ? "1" : "0";
            strEduContents11 = ssView2_Sheet1.Cells[38, 7].Text.Trim() == "True" ? "1" : "0";
            strEduContents12 = ssView2_Sheet1.Cells[39, 8].Text.Trim();

            //교육자료제공여부
            if (ssView2_Sheet1.Cells[40, 2].Value != null)
            {
                strEduMatPro = ssView2_Sheet1.Cells[40, 2].Value.ToString();
            }
            else
            {
                strEduMatPro = "";
            ...
            {
                strEduEvende = ssView2_Sheet1.Cells[41, 2].Value.ToString();
            }
            else
            {
                strEduEvende = "";
            ...
            //기타기재사항
            strRemark = ssView2_Sheet1.Cells[42, 2].Text.Trim();
            ...
            try
            {
                ...
                {
                    SQL = "";
                    SQL = "UPDATE " + ComNum.DB_PMPA + "NUR_STD_INFECT9";
                ...
                {
                    SQL = "";
                    SQL = "INSERT INTO " + ComNum.DB_PMPA + "NUR_STD_INFECT9";
                    SQL = SQL + ComNum.VBLF + " (ACTDATE, PANO, SNAME, ILLCODE,  GUNGU, M2_DISREG9, PATGU1, PATGU2, PATGU3, PATGU4, PATGU5, EDUCATOR, HEIGHT, WEIGHT, BMI, ";
        ...
        private void ssList_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            try
            {
                SQL = "";
                SQL = "SELECT";
                SQL = SQL + ComNum.VBLF + "     A.ACTDATE, A.PANO, A.SNAME, A.ILLCODE,  A.GUNGU, A.M2_DISREG9, A.PATGU1, A.PATGU2, A.PATGU3, A.PATGU4, A.PATGU5, A.EDUCATOR, A.HEIGHT, A.WEIGHT, A.BMI, ";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //
                    //
                    ssView2_Sheet1.Cells[18, 5].Value = dt.Rows[0]["HEIGHT"].ToString().Trim();
                    ssView2_Sheet1.Cells[18, 8].Value = dt.Rows[0]["WEIGHT"].ToString().Trim();
                    ssView2_Sheet1.Cells[18, 11].Value = dt.Rows[0]["BMI"].ToString().Trim();

                    ssView2_Sheet1.Cells[19, 4].Value = dt.Rows[0]["SMOKEGU"].ToString().Trim() == "" ? null : dt.Rows[0]["SMOKEGU"].ToString().Trim();
                    ssView2_Sheet1.Cells[20, 4].Value = dt.Rows[0]["ALCOHOLGU"].ToString().Trim() == "" ? null : dt.Rows[0]["ALCOHOLGU"].ToString().Trim();
                    ssView2_Sheet1.Cells[21, 2].Value = dt.Rows[0]["DEGREECOM"].ToString().Trim() == "" ? null : dt.Rows[0]["DEGREECOM"].ToString().Trim();
                    ssView2_Sheet1.Cells[22, 2].Value = dt.Rows[0]["SEFFECT"].ToString().Trim() == "" ? null : dt.Rows[0]["SEFFECT"].ToString().Trim();

                    ssView2_Sheet1.Cells[23, 2].Value = dt.Rows[0]["SEFFECT01"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[23, 5].Value = dt.Rows[0]["SEFFECT06"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[23, 8].Value = dt.Rows[0]["SEFFECT11"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[24, 2].Value = dt.Rows[0]["SEFFECT02"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[24, 5].Value = dt.Rows[0]["SEFFECT07"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[24, 8].Value = dt.Rows[0]["SEFFECT12"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[25, 2].Value = dt.Rows[0]["SEFFECT03"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[25, 5].Value = dt.Rows[0]["SEFFECT08"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[25, 8].Value = dt.Rows[0]["SEFFECT13"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[26, 2].Value = dt.Rows[0]["SEFFECT04"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[26, 5].Value = dt.Rows[0]["SEFFECT09"].ToString().Trim() == "1" ? true : false;
                    if (string.IsNullOrEmpty(dt.Rows[0]["SEFFECT14"].ToString().Trim()) == false)
                    {
                        ssView2_Sheet1.Cells[26, 8].Value = true;
                        ssView2_Sheet1.Cells[27, 9].Value = dt.Rows[0]["SEFFECT14"].ToString().Trim();
                    }

                    ssView2_Sheet1.Cells[27, 2].Value = dt.Rows[0]["SEFFECT05"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[27, 5].Value = dt.Rows[0]["SEFFECT10"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[29, 2].Value = dt.Rows[0]["EDUDATE"].ToString().Trim();
                    ssView2_Sheet1.Cells[30, 2].Value = dt.Rows[0]["EDUCOUNT"].ToString().Trim() == "" ? null : dt.Rows[0]["EDUCOUNT"].ToString().Trim();
                    ssView2_Sheet1.Cells[31, 2].Value = dt.Rows[0]["EDUTIME"].ToString().Trim();

                    ssView2_Sheet1.Cells[32, 2].Value = dt.Rows[0]["EDUSUJECT"].ToString().Trim() == "" ? null : dt.Rows[0]["EDUSUJECT"].ToString().Trim();
                    ssView2_Sheet1.Cells[32, 6].Value = dt.Rows[0]["EDUSUJECT2"].ToString().Trim();
                    ssView2_Sheet1.Cells[32, 8].Value = dt.Rows[0]["EDUSUJECT1"].ToString().Trim() == "" ? null : dt.Rows[0]["EDUSUJECT1"].ToString().Trim();
                    ssView2_Sheet1.Cells[32, 10].Value = dt.Rows[0]["EDUSUJECT3"].ToString().Trim();

                    ssView2_Sheet1.Cells[33, 2].Value = dt.Rows[0]["EDUCONTENTS01"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[33, 7].Value = dt.Rows[0]["EDUCONTENTS07"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[34, 2].Value = dt.Rows[0]["EDUCONTENTS02"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[34, 7].Value = dt.Rows[0]["EDUCONTENTS08"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[35, 2].Value = dt.Rows[0]["EDUCONTENTS03"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[35, 7].Value = dt.Rows[0]["EDUCONTENTS09"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[36, 2].Value = dt.Rows[0]["EDUCONTENTS04"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[36, 7].Value = dt.Rows[0]["EDUCONTENTS10"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[37, 2].Value = dt.Rows[0]["EDUCONTENTS05"].ToString().Trim() == "1" ? true : false;

                    ssView2_Sheet1.Cells[38, 2].Value = dt.Rows[0]["EDUCONTENTS06"].ToString().Trim() == "1" ? true : false;
                    ssView2_Sheet1.Cells[38, 7].Value = dt.Rows[0]["EDUCONTENTS11"].ToString().Trim() == "1" ? true : false;

                    if (string.IsNullOrEmpty(dt.Rows[0]["EDUCONTENTS12"].ToString().Trim()) == false)
                    {
                        ssView2_Sheet1.Cells[39, 7].Value = true;
                        ssView2_Sheet1.Cells[39, 8].Value = dt.Rows[0]["EDUCONTENTS12"].ToString().Trim();
                    }

                    ssView2_Sheet1.Cells[40, 2].Value = dt.Rows[0]["EDUMATPRO"].ToString().Trim() == "" ? null : dt.Rows[0]["EDUMATPRO"].ToString().Trim();
                    ssView2_Sheet1.Cells[41, 2].Value = dt.Rows[0]["EDUEVENDE"].ToString().Trim() == "" ? null : dt.Rows[0]["EDUEVENDE"].ToString().Trim();
                    ssView2_Sheet1.Cells[42, 2].Value = dt.Rows[0]["BIGO1"].ToString().Trim();

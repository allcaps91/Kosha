...
namespace ComLibB
{
    ...
    /// </vbp>
    public partial class frmBupPatEntry_new_Backup : Form
    {
        ...
        public frmBupPatEntry_new_Backup()
        {
            InitializeComponent();
        }

        public frmBupPatEntry_new_Backup(string strPtNo, int intIndex, bool bolOrder = false)
        {
            InitializeComponent();
        ...
        public frmBupPatEntry_new_Backup(string strPtNo, string strIO, string strDept, string strDrCode, string strOP, string strRare, string strSabun)
        {
            InitializeComponent();
        ...
        private void frmBupPatEntry_new_Load(object sender, EventArgs e)
        {
            ...
            #region 2018-12-26 안정수, 실행시 각 컨트롤 설정부분 
            //this.Height = 1100 - 141;

            //grbTongbo.Text = "통보구분";
            //rdoTongbo0.Text = "문자";
            //rdoTongbo1.Text = "E-Mail";
            ...
            //#region 요양기관 확인란
            //PanChkOld.Visible = true;
            //PanChkNew.Visible = false;

            //PanChkOld.Dock = DockStyle.Fill;
            //PanChkNew.Dock = DockStyle.None;
            //#endregion

            //#region 최초진단 or 최종확진방법
            //panel17.Height = 160;

            //PanExamOld.Visible = true;
            //PanExamNew.Visible = false;

            //PanExamOld.Dock = DockStyle.Fill;
            //PanExamNew.Dock = DockStyle.None;
            //#endregion

            //label15.Text = "최초진단 - 중복체크가능";
            ...
            toolGub5.Visible = false;
            toolBohum3.Text = "3. 결핵,화상 건강보험 신청서";
            toolGub2.Text = "2. 희귀난치치매 의료급여 신청서";
            toolGub3.Text = "3. 결핵,화상 의료급여 신청서";

            #endregion

            if (optBasic.Checked == true)
            { 
                if (GintIndex == 0)
                {
                    rdo3.Checked = true;
            ...
            try
            {
                ...
                if(optBasic.Checked == true && (cboDept.Text == "**.전체" || cboDept.SelectedIndex == 0))
                {
                    read_DeptInfo("Basic", clsType.User.IdNumber);
                }
                else if(optNew.Checked == true && (cboDept.Text == "**.전체" || cboDept.SelectedIndex == 0))
                {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                if(optNew.Checked == true && rdo7.Checked == true)
                {
                    var result = MessageBox.Show("신규 암 신청서는 2019년 3월 1일 이후부터 사용이 가능합니다. 다시 작성하시겠습니까?", "확인", MessageBoxButtons.YesNo);
                ...
                if (optNew.Checked == true && rdo9.Checked == true && cboGubun.Text == "결핵")
                {
                    var result = MessageBox.Show("신규 결핵 신청서는 2019년 3월 1일 이후부터 사용이 가능합니다. 다시 작성하시겠습니까?", "확인", MessageBoxButtons.YesNo);
            ...
            //else if (cpublic.strSysDate.CompareTo("2019-03-01") >= 1 || cpublic.strSysDate.CompareTo("2019-04-01") < 0)
            //{
            //    if (optNew.Checked == true && rdo7.Checked == true)
            //    {
            //        MessageBox.Show("암, 결핵 신청서는 진단일이 2019년 2월 28일 이전은 기존서식지로 작성하시고," + ComNum.VBLF
            //                      + " 진단일이 2019년 3월 1일 이후는 신규서식지로 작성하시면 됩니다.", "확인");
            //    }
        ...
        private bool SaveDataNew()
        {
            ...
            try
            {
                ...
                {                    
                    ...
                    SQL += ComNum.VBLF + "   ,ILLCODE = '" + txtIllCodeNew.Text + "'                                               ";
                ...
                {                    
                    ...
                    SQL = SQL + ComNum.VBLF + "         JINDAN_NEW_09, JINDAN_NEW_091 ,JINDAN_NEW_092 ,JINDAN_NEW_093 ,JINDAN_NEW_094 ,GUBUN2, JINDAN_NEW_10, JINDAN_NEW_11)";                        
                    SQL = SQL + ComNum.VBLF + "VALUES ";
                    SQL = SQL + ComNum.VBLF + "         (";
                    ...
                    SQL = SQL + ComNum.VBLF + "         '" + txtIllCodeNew.Text + "', ";                                            //ILLCODE
        ...
        private void rdo_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (optNew.Checked == true)
            {
                ...
                if (rdo7.Checked == true)
                {
                    ...
                    if(cpublic.strSysDate.CompareTo("2019-03-01") < 0)
                    {
                        ...
                        MessageBox.Show("암 신청서는 2019년 3월 1일 이 후 신규 서식지 사용이 가능합니다." + ComNum.VBLF + 
                                        "왼쪽 상단 '양식구분'에서 '기존'을 선택하신 후 암 신청서를 작성하시면 됩니다.");
                ...
                else if (rdo9.Checked == true)
                {
                    ...
                    //2019-01-24
                    if (cpublic.strSysDate.CompareTo("2019-03-01") < 0 && cboGubun.Text == "결핵")
                    {
                        MessageBox.Show("결핵 신청서는 2019년 3월 1일 이 후 신규 서식지 사용이 가능합니다." + ComNum.VBLF + 
                                        "왼쪽 상단 양식구분에서 '기존'을 선택하신 후 결핵신청서를 작성하시면 됩니다.");
                        //optBasic.Checked = true;
                        //return;
                    }
                    else
            ...
            else
            {
                ...
                {
                    if (cpublic.strSysDate.CompareTo("2018-12-31") > 0 )
                    {
                        MessageBox.Show("기타 산정특례 신청서는 2019년 1월 1일 이 후 부터 신규 서식지로 변경되었습니다.." + ComNum.VBLF +
                                        "왼쪽 상단 양식구분에서 '신규'을 선택하신 후 작성하시면 됩니다.");
                        //optNew.Checked = true;
                        //return;
                    }
                ...
                else if (rdo2.Checked == true)
                {
                    if (cpublic.strSysDate.CompareTo("2018-12-31") > 0 )
                    {
                        MessageBox.Show("중증화상 신청서는 2019년 1월 1일 이 후 부터 신규 서식지로 변경되었습니다.." + ComNum.VBLF +
                                        "왼쪽 상단 양식구분에서 '신규'을 선택하신 후 작성하시면 됩니다.");
                        //optNew.Checked = true;
                        //return;
                    }
                ...
                else if (rdo3.Checked == true)
                {
                    ...
                    if (cpublic.strSysDate.CompareTo("2018-12-31") > 0 )
                    {
                        MessageBox.Show("희귀난치 신청서는 2019년 1월 1일 이 후 부터 신규 서식지로 변경되었습니다.." + ComNum.VBLF +
                                        "왼쪽 상단 양식구분에서 '신규'을 선택하신 후 작성하시면 됩니다.");
                        //optNew.Checked = true;
                        //return;
                    }
        ...
        {
            if (optBasic.Checked == true && VB.Split(cboDept.Text.Trim(), "전체").Length > 1) { return; }
            if (optNew.Checked == true && VB.Split(cboDeptNew.Text.Trim(), "전체").Length > 1) { return; }

            if ((optBasic.Checked == true && cboDept.Text.Trim() == "")|| (optNew.Checked == true && cboDeptNew.Text.Trim() == ""))
            {
        ...
        private void toolBohum_Click(object sender, EventArgs e)
        {
            ...
            else if(strIndex == "3")
            {
                ...
                else if (optNew.Checked == true)
                {
                    ...
                    if (rdo9.Checked == true && cboGubun.Text == "")
                    {
                        ComFunc.MsgBox("버튼 옆 콤보박스에 값을 선택하세요!");
                        return;
                    }
            ...
            if (optBasic.Checked == true)
            {
                ...
                ssBohum1new_Sheet1.PrintInfo.Preview = false;
        ...
        private void DATA_SET3_new2_NEW(string strIndex)
        {
            ...
            if (strIndex == "1")
            {
                ...
                {
                    ssBohumNew1.ActiveSheet.Cells[7, 9].Text = "■ SMS       □ 이메일";
                }
        ...
        #region 당뇨 인쇄_1 과거 서식 사용안함(2019-03-13)


        //private void toolBst1_Click_old(object sender, EventArgs e)
        //{
        //    if (ComQuery.IsJobAuth(this, "P", clsDB.DbCon) == false) return; //권한 확인
        ...
        //    else if (optNew.Checked == true)
        //    {
        //        ssDiabetes1_Sheet1.Cells[7, 3].Text = clsVbfunc.GetBASClinicDeptNameK(clsDB.DbCon, VB.Left(cboDeptNew.Text, 2));
        //    }
        ...
        //        if (cboDoct.Text.Trim() != "")
        //        {
        //            if (cboDoct.Text.Replace(".", "").Trim() != "")
        //            {
        //                strSabun = VB.Left(cboDoct.Text, 4);

        //                ssDiabetes1_Sheet1.Cells[29, 6].Text = VB.Split(cboDoct.Text, ".")[1] + "(" + clsVbfunc.GetOCSDrBunhoDrCode(clsDB.DbCon, VB.Split(cboDoct.Text, ".")[0]) + ")";
        //            }
        //            else
        //            {
        //                ssDiabetes1_Sheet1.Cells[29, 6].Text = VB.Split(cboDoct.Text, ".")[1] + "(" + VB.Space(5) + ")";
        //            }
        //        }
        //    }
        ...
        //    else if (optNew.Checked == true)
        //    {
        //        ssDiabetes1_Sheet1.Cells[45, 5].Text = clsVbfunc.GetBASClinicDeptNameK(clsDB.DbCon, VB.Left(cboDeptNew.Text, 2));
        //    }
        ...
        private void optBasic_CheckedChanged(object sender, EventArgs e)
        {
            this.Height = 1100 - 141;
            ...
            panel27.Visible = false;    // 버튼 옆 콤보박스
            ...
            //상단버튼설정
            toolBohum4.Visible = true;
            toolGub4.Visible = true;
            toolGub5.Visible = true;

            //기존
            toolBohum1.Text = "1. 암 신청서";
            toolBohum2.Text = "2. 기타 산정특례(희귀포함) 신청서";
            toolBohum3.Text = "3. 중증화상 건강보험 신청서";

            toolGub2.Text = "2. 희귀난치 의료급여 신청서";
            toolGub3.Text = "3. 중증화상 의료급여 신청서";
            toolGub4.Text = "4. 기타 산정특례 의료급여 신청서";
            toolGub5.Text = "5. 결핵 의료급여 신청서";
        ...
        private void optNew_CheckedChanged(object sender, EventArgs e)
        {
            ...
            toolBohum1.Text = "1. 암 건강보험 신청서";
            toolBohum2.Text = "2. 희귀,난치,치매 건강보험 신청서";
            toolBohum3.Text = "3. 결핵,화상 건강보험 신청서";

            //toolBohum3.Text = "3. 결핵,화상 건강보험 신청서";
            toolGub2.Text = "2. 희귀,난치,치매 의료급여 신청서";
            toolGub3.Text = "3. 결핵,화상 의료급여 신청서";
        }
        ...
        private string Read_Bas_IllsToVCode(string argIlls)
        {
            ...
            SQL += ComNum.VBLF + " FROM KOSMOS_PMPA.BAS_ILLS_H2 ";

...
namespace ComEmrBase
{
    public partial class frmAnForm
    {
        ...
        private bool EmrChartMstSave(double dblEmrHisNo, string emrNo, string saveCert)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "  , '1'                                                  --  UPDATENO    업데이트 번호";
        ...
        private void SetData()
        {
            ...
            try
            {
                ...
                #region 기본정보 불러오기
                SQL = "";
                SQL = SQL + ComNum.VBLF + "SELECT EMRNO, EMRNOHIS, FORMNO, CHARTDATE, CHARTTIME, CHARTUSEID";
                SQL = SQL + ComNum.VBLF + "  FROM " + ComNum.DB_EMR + "AEMRCHARTMST";
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    if (row["ITEM"].ToString() == "호흡")
                    {
                        ssView.ActiveSheet.Cells[rowIndex + 1, colInde].Text = row["UNIT"].ToString();
                    }
                ...
                ssView.ActiveSheet.Columns[1].Width = 40;
    ...
    {
        public string Pano = string.Empty;                 //환자번호
        public string OpDate = string.Empty;               //수술일자
        public string AsaAdd = string.Empty;               //ASA
        public string Emergency = string.Empty;            //응급여부
        public string NpoY = string.Empty;                  //NPO_Y
        public string NpoN = string.Empty;                  //NPO_N

        public string OpRoom = string.Empty;               //수술방번호
        public string PreOpDx = string.Empty;              //수술전 상병
        public string PostOpDx = string.Empty;             //수술후 상병
        public string PreOpTitle = string.Empty;           //수술전 수술명
        public string PostOpTitle = string.Empty;          //수술후 수술명
        public string AnesDr = string.Empty;               //마취의
        public string Surgeon = string.Empty;              //집도의1
        public string Assist = string.Empty;               //어시스트
        public string AnesNr = string.Empty;               //간호사1
        public string ScrubNr = string.Empty;              //간호사2
        public string CirNr = string.Empty;                //간호사3

        public string Sbp = string.Empty;                  //SBP
        public string Dbp = string.Empty;                  //DBP
        public string Pr = string.Empty;                    //PR
        public string Bw = string.Empty;                    //BW
        public string Bt = string.Empty;                   //BT

        public string ExamHb = string.Empty;               //HB
        public string ExamHct = string.Empty;              //HCT
        public string ExamNa = string.Empty;               //NA
        public string ExamK = string.Empty;                //K
        public string ExamGOT = string.Empty;               //GOT
        public string ExamGPT = string.Empty;              //GPT
        public string ExamPT = string.Empty;               //PT
        public string ExamPTT = string.Empty;              //PTT
        public string ExamPLT = string.Empty;              //PLT
        public string ExamWBC = string.Empty;              //WBC

        public string PastHxHTM = string.Empty;             // 과거력 고혈압
        public string PastHxDM = string.Empty;              // 과거력 당뇨
        public string PastHxTC = string.Empty;              // 과거력 결핵
        public string PastHxCC = string.Empty;              // 과거력 암
        public string PastHxLC = string.Empty;              // 과거력 간질환
        public string PastHxCD = string.Empty;              // 과거력 심장질환
        public string PastHxOTHER = string.Empty;           // 과거력 기타
        public string PastHxOTHERTXT = string.Empty;        // 과거력 기타 텍스트

        public string Leave = string.Empty;                //병실 출발
        public string Arrive = string.Empty;               //수술장 도착

        public string ABO = string.Empty;                  //혈액형
        public string OpCode = string.Empty;
        public string OpPosition = string.Empty;
        public string WrtNo = string.Empty;
    }
}

    ...
    public partial class frmTextEmrWardAll : Form, EmrChartForm
    {
        ...
        void GetUserChart()
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "  FROM KOSMOS_EMR.EMRGRPFORM A ";
                SQL = SQL + ComNum.VBLF + "      INNER JOIN KOSMOS_EMR.EMRFORM B";
        ...
        void GetUchartHis(string strPtno, string strFormNo, FarPoint.Win.Spread.FpSpread objSpread, int lngRow)
        {
            ...
            try
            {
                ...
                SQL += ComNum.VBLF + "      AND A.EMRNO = (SELECT MAX(X.EMRNO) FROM KOSMOS_EMR.EMRXMLMST X";
                            ...
                            )
        {
            ...
            SQL.Clear();
            SQL.AppendLine(" INSERT INTO KOSMOS_EMR.EMRXML");

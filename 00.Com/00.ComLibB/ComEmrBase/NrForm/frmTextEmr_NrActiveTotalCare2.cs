...
namespace ComEmrBase
{
    ...
    /// 낙상 예방 간호활동기록지
    /// FORMNO = 2476
    /// \mtsEmrf\frmTextEmr_NrActiveTotalCare2.frm
    /// </summary>
    public partial class frmTextEmr_NrActiveTotalCare2 : Form, EmrChartForm
    {
        #region // TopMenu관련 선언
        ...
        {
            if (mstrMode.Equals("W") == false || mLoading == false)
                return;
        ...
        #region //생성자
        public frmTextEmr_NrActiveTotalCare2()
        {
            InitializeComponent();
        }

        public frmTextEmr_NrActiveTotalCare2(string pMake, int pItemCnt, int pHeadCnt, FormFlowSheet[] pFormFlowSheet, FormFlowSheetHead[,] pFormFlowSheetHead)
        {
            InitializeComponent();
            mFLOWGB = pMake;
        ...
        public frmTextEmr_NrActiveTotalCare2(string strFormNo, string strUpdateNo, string strEmrNo, int pCallFormGb)
        {
            InitializeComponent();
        ...
        public frmTextEmr_NrActiveTotalCare2(string strFormNo, string strUpdateNo, EmrPatient po, string strEmrNo, string strMode, string strOrderDate, FormEmrMessage pEmrCallForm) //절대 수정하시 마시요(서식생성기 에러남)
        {
            mstrFormNo = strFormNo;
            mstrUpdateNo = strUpdateNo;
            pAcp = po;
        ...
        public frmTextEmr_NrActiveTotalCare2(string strFormNo, string strUpdateNo, EmrPatient po, string strEmrNo, string strMode, FormEmrMessage pEmrCallForm) //절대 수정하시 마시요(서식생성기 에러남)
        {
            mstrFormNo = strFormNo;
            mstrUpdateNo = strUpdateNo;
            pAcp = po;
        ...
        private void frmTextEmr_NrActiveTotalCare2_Load(object sender, EventArgs e)
        {
            ...
            if (pAcp.ptNo.Length > 0)
            {
                ...
                string strFall = clsVbfunc.READ_WARNING_FALL(clsDB.DbCon, pAcp.ptNo, ComQuery.CurrentDateTime(clsDB.DbCon, "D"), 0, pAcp.age);
        ...
        void GetDcur(string strPtNo, string strChartDate)
        {
            ...
            SQL = SQL + ComNum.VBLF + "   FROM KOSMOS_PMPA.NUR_BRADEN_SCALE B INNER JOIN KOSMOS_PMPA.IPD_NEW_MASTER M  ";
            ...
            SQL = SQL + ComNum.VBLF + "   FROM KOSMOS_PMPA.NUR_BRADEN_SCALE_CHILD B INNER JOIN KOSMOS_PMPA.IPD_NEW_MASTER M  ";
            SQL = SQL + ComNum.VBLF + "                    ON B.IPDNO = M.IPDNO  ";
            SQL = SQL + ComNum.VBLF + "                  AND M.PANO = '" + strPtNo + "' ";
            SQL = SQL + ComNum.VBLF + "                  AND TRUNC(B.ACTDATE) =  TO_DATE('" + strChartDate + "','YYYY-MM-DD') ";
            SQL = SQL + ComNum.VBLF + " UNION ALL        ";
            SQL = SQL + ComNum.VBLF + "  SELECT Total, B.ACTDATE, DECODE(ENTDATE, NULL, TO_DATE('2011-04-01','YYYY-MM-DD'), ENTDATE) ENTDATE";
            SQL = SQL + ComNum.VBLF + "   FROM KOSMOS_PMPA.NUR_BRADEN_SCALE_BABY B INNER JOIN KOSMOS_PMPA.IPD_NEW_MASTER M  ";
            SQL = SQL + ComNum.VBLF + "                    ON B.IPDNO = M.IPDNO  ";
            SQL = SQL + ComNum.VBLF + "                  AND M.PANO = '" + strPtNo + "' ";
            SQL = SQL + ComNum.VBLF + "                  AND TRUNC(B.ACTDATE) =  TO_DATE('" + strChartDate + "','YYYY-MM-DD') ";
            ...
            if (dataReader.HasRows)
            {
                ...
                {
                    ssUserChartIO_Sheet1.Cells[3, 4].Text = dataReader.GetValue(0).ToString().Trim() == "" ? "0" : dataReader.GetValue(0).ToString().Trim();
                }
            }
            dataReader.Dispose();
            #endregion
            ...
            {
                SQL = "  SELECT Total   ";
                SQL = SQL + ComNum.VBLF + "   FROM KOSMOS_PMPA.NUR_FALLMORSE_SCALE B INNER JOIN KOSMOS_PMPA.IPD_NEW_MASTER M  ";
                SQL = SQL + ComNum.VBLF + "                    ON B.IPDNO = M.IPDNO  ";
                SQL = SQL + ComNum.VBLF + "                  AND M.PANO = '" + strPtNo + "' ";
                SQL = SQL + ComNum.VBLF + "                  AND TRUNC(B.ACTDATE) =  TO_DATE('" + strChartDate + "','YYYY-MM-DD') ";
            ...
            {
                SQL = "  SELECT Total   ";
                SQL = SQL + ComNum.VBLF + "   FROM KOSMOS_PMPA.NUR_FALLHUMPDUMP_SCALE B INNER JOIN KOSMOS_PMPA.IPD_NEW_MASTER M  ";
                SQL = SQL + ComNum.VBLF + "                    ON B.IPDNO = M.IPDNO  ";
                SQL = SQL + ComNum.VBLF + "                  AND M.PANO = '" + strPtNo + "' ";
                SQL = SQL + ComNum.VBLF + "                  AND TRUNC(B.ACTDATE) =  TO_DATE('" + strChartDate + "','YYYY-MM-DD') ";
                SQL = SQL + ComNum.VBLF + "  ORDER BY B.ACTDATE DESC, DECODE(B.ENTDATE, NULL, TO_DATE('2011-04-01','YYYY-MM-DD'), B.ENTDATE) DESC ";
            ...
            if (dataReader.HasRows)
            {
                while (dataReader.Read())
                {
                    ssUserChartIO_Sheet1.Cells[4, 4].Text = dataReader.GetValue(0).ToString().Trim() == "" ? "0" : dataReader.GetValue(0).ToString().Trim();
                }
            }
            dataReader.Dispose();
            #endregion
        ...
        void ClearForm()
        {
            ...
            ssUserChartIO_Sheet1.Cells[17, 3].Text = "욕창유무";
            ssUserChartIO_Sheet1.Cells[19, 3].Text = "식욕";
            ssUserChartIO_Sheet1.Cells[36, 3].Text = "교환시간";
            ssUserChartIO_Sheet1.Cells[42, 3].Text = "체위변경";
            ssUserChartIO_Sheet1.Cells[43, 3].Text = "이동";
            ssUserChartIO_Sheet1.Cells[44, 3].Text = "식사섭취";
            ssUserChartIO_Sheet1.Cells[45, 3].Text = "배변";
            ssUserChartIO_Sheet1.Cells[46, 3].Text = "경구약" + ComNum.VBLF + "복용확인";
            ssUserChartIO_Sheet1.Cells[47, 3].Text = "주사부위" + ComNum.VBLF + "점검";
            ssUserChartIO_Sheet1.Cells[48, 3].Text = "각종 Line" + ComNum.VBLF + "상태확인";
        }
        ...
        void GetLastValue(int lngCol)
        {
            ...
            ssUserChartIO_Sheet1.Cells[2, 1].Text = strDuty;

            string strEmrNo = ssUserChartHisIO_Sheet1.Cells[52, lngCol].Text.Trim();
            
            for (int xCol1 = 0; xCol1 < ssUserChartHisIO_Sheet1.ColumnCount - 1; xCol1++)
            {
                if (strEmrNo == ssUserChartHisIO_Sheet1.Cells[52, xCol1].Text.Trim())
                {
                    for (int xRow1 = 3; xRow1 < 51; xRow1++)
                    {
                        ssUserChartIO_Sheet1.Cells[xRow1, 3].Text = ssUserChartHisIO_Sheet1.Cells[xRow1, xCol1].Text.Trim();
                        ssUserChartIO_Sheet1.Cells[xRow1, 4].Text = ssUserChartHisIO_Sheet1.Cells[xRow1, xCol1 + 1].Text.Trim();
                    }
        ...
        string MkValue()
        {
            ...
            strVal += MkHaT(109, ssUserChartIO_Sheet1.Cells[50, 3].Text.Trim());
            strVal += MkHaT(110, ssUserChartIO_Sheet1.Cells[50, 4].Text.Trim());
        ...
        void GetChartHistory()
        {
            ...
            DesignFunc.DefaultDuty(ssUserChartIO, 3);
        ...
        void READ_INIT_FALL()
        {
            ...
            try
            {
                ...
                ssUserChartIO_Sheet1.Cells[3, 3].Text = READ_DETAIL_FALL(pAcp.ptNo,
                  Convert.ToDateTime(ComQuery.CurrentDateTime(clsDB.DbCon, "S")).ToShortDateString(), strIpdNo,
                  pAcp.age);

                if (ssUserChartIO_Sheet1.Cells[3, 3].Text.Trim().Length == 0)
                {
                    ssUserChartIO_Sheet1.Cells[3, 3].Text = "미해당";
                }

                ssUserChartIO_Sheet1.Cells[4, 3].Text = READ_DETAIL_EVAL_FALL_NEW(strIpdNo);

                if (ssUserChartIO_Sheet1.Cells[4, 3].Text.Trim().Length == 0)
                {
                    ssUserChartIO_Sheet1.Cells[4, 3].Text = "미해당";
                }
        ...
        void ConVIoData()
        {
            ...
            for (int xRow1 = 0; xRow1 < ssUserChartHis_Sheet1.RowCount; xRow1++)
            {
                ...
                //작성자
                ssConV_Sheet1.Cells[51, 0].Text = string.Format("{0} / {1}", ssUserChartHis_Sheet1.Cells[xRow1, 113].Text.Trim(), strTime);
                ssConV_Sheet1.Cells[51, 1].Text = string.Format("{0} / {1}", ssUserChartHis_Sheet1.Cells[xRow1, 113].Text.Trim(), strTime);

                //EMRNO
                ssConV_Sheet1.Cells[52, 0].Text = ssUserChartHis_Sheet1.Cells[xRow1, 11].Text.Trim();
                ssConV_Sheet1.Cells[52, 1].Text = ssUserChartHis_Sheet1.Cells[xRow1, 11].Text.Trim();

                //USEID
                ssConV_Sheet1.Cells[53, 0].Text = ssUserChartHis_Sheet1.Cells[xRow1, 12].Text.Trim();
                ssConV_Sheet1.Cells[53, 1].Text = ssUserChartHis_Sheet1.Cells[xRow1, 12].Text.Trim();
        ...
        void SetssConV(int lngCol, string strValue)
        {
            ...
            {
                ssConV_Sheet1.Cells[50, 0].Text = strValue;
            }
            else if (lngCol == 112)
            {
                ssConV_Sheet1.Cells[50, 1].Text = strValue;
            }
        }
        ...
        void SetIoHis(int intColorInfo)
        {
            ...
            ssUserChartHisIO_Sheet1.Columns[ssUserChartHisIO_Sheet1.ColumnCount - 2, ssUserChartHisIO_Sheet1.ColumnCount - 1].Width = 80;
            ssUserChartHisIO_Sheet1.Cells[0, ssUserChartHisIO_Sheet1.ColumnCount - 2, ssUserChartHisIO_Sheet1.RowCount - 1, ssUserChartHisIO_Sheet1.ColumnCount - 1].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            ssUserChartHisIO_Sheet1.Cells[0, ssUserChartHisIO_Sheet1.ColumnCount - 2, ssUserChartHisIO_Sheet1.RowCount - 1, ssUserChartHisIO_Sheet1.ColumnCount - 1].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;

            #region 셀 합치기 및 중앙 정렬
            ...
            ssUserChartHisIO_Sheet1.AddSpanCell(51, ssUserChartHisIO_Sheet1.ColumnCount - 2, 1, 2);

            ssUserChartHisIO_Sheet1.Cells[0, ssUserChartHisIO_Sheet1.ColumnCount - 2, 0, ssUserChartHisIO_Sheet1.ColumnCount - 1].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            ssUserChartHisIO_Sheet1.Cells[0, ssUserChartHisIO_Sheet1.ColumnCount - 2, 0, ssUserChartHisIO_Sheet1.ColumnCount - 1].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;

            ssUserChartHisIO_Sheet1.Cells[51, ssUserChartHisIO_Sheet1.ColumnCount - 2, 51, ssUserChartHisIO_Sheet1.ColumnCount - 1].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            ssUserChartHisIO_Sheet1.Cells[51, ssUserChartHisIO_Sheet1.ColumnCount - 2, 51, ssUserChartHisIO_Sheet1.ColumnCount - 1].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            #endregion
            ...
            for (int xCol1 = 0; xCol1 < ssConV_Sheet1.ColumnCount; xCol1++)
            {
                for (int xRow1 = 0; xRow1 < ssConV_Sheet1.RowCount; xRow1++)
                {
                    ...
                    if (xCol1 == 0)
                    {
                        ssUserChartHisIO_Sheet1.Cells[xRow1, lngMCol1].Text = ssConV_Sheet1.Cells[xRow1, xCol1].Text;
                    }
                    else if (xCol1 == 1)
                    {
                        ssUserChartHisIO_Sheet1.Cells[xRow1, lngMCol1 + 1].Text = ssConV_Sheet1.Cells[xRow1, xCol1].Text;
                    }
            ...
            for (int xRow1 = ssUserChartHisIO_Sheet1.ColumnCount - 1; xRow1 >= ssUserChartHisIO_Sheet1.ColumnCount - 2; xRow1--)
            {
                if (intColorInfo == -1)
                {
                    ssUserChartHisIO_Sheet1.Columns[xRow1].BackColor = System.Drawing.Color.White;
                }
                else if (intColorInfo == 1)
                {
                    ssUserChartHisIO_Sheet1.Columns[xRow1].BackColor = System.Drawing.ColorTranslator.FromOle((int)new Int32Converter().ConvertFromString("0xBFFFEF"));
                }
            }
            ...
            ssUserChartHisIO_Sheet1.Cells[51, ssUserChartHisIO_Sheet1.ColumnCount - 1].CellType = new TextCellType();
            ssUserChartHisIO_Sheet1.Cells[51, ssUserChartHisIO_Sheet1.ColumnCount - 1].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            ssUserChartHisIO_Sheet1.Cells[51, ssUserChartHisIO_Sheet1.ColumnCount - 1].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
        ...
        private void SsUserChartHisIO_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            string strEmrNo = ssUserChartHisIO_Sheet1.Cells[52, e.Column].Text.Trim();
            mstrEmrNo = strEmrNo;

            mEmrUseId = ssUserChartHisIO_Sheet1.Cells[53, e.Column].Text.Trim();
        ...
        {
            if (ssUserChartHisIO_Sheet1.ActiveColumnIndex <= 2)
                return;

            ClearSp();

            int intActiveCol = ssUserChartHisIO_Sheet1.ActiveColumnIndex;
            string strDuty = ssUserChartHisIO_Sheet1.Cells[1, intActiveCol].Text.Trim();

            ssUserChartIO_Sheet1.Cells[1, 1].Text = strDuty;

            string strEmrNo = ssUserChartHisIO_Sheet1.Cells[52, intActiveCol].Text.Trim();
            int i = 0;
            int intCol = 0;
        ...
        private void frmTextEmr_NrActiveTotalCare2_Resize(object sender, EventArgs e)
        {
        ...
        private void SSPT_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(strCTime))
                return;

            ssUserChartIO_Sheet1.Cells[9, 3].Text = "물리치료";
            ssUserChartIO_Sheet1.Cells[9, 4].Text = VB.Right(strCTime, 5);
        ...
        {
            if ((e.Row == 10 || e.Row == 14 || e.Row == 15 || e.Row == 26 || e.Row == 28 || e.Row == 33 ||
                 e.Row == 36 || e.Row == 40 || e.Row == 41 || e.Row == 46 || e.Row == 49 || e.Row == 50)
        ...
        void ComboSelChagne(int Col, int Row)
        {
            if (Col == 3 && Row == 1)
            {
                ...
                ssUserChartIO_Sheet1.Cells[18, 3].Text = "";
                ssUserChartIO_Sheet1.Cells[20, 3].Text = "";
                ...
                try
                {
                    ...
                    {
                        ssUserChartIO_Sheet1.Cells[18, 3].Text =
                        (ssUserChartIO_Sheet1.Cells[18, 3].Text.Length == 0 ? strDiet1 : ssUserChartIO_Sheet1.Cells[18, 3].Text) +
                        (strDiet1Qty > 100 ? "(" + strDiet1Qty + ")" : "");

                        ssUserChartIO_Sheet1.Cells[20, 3].Text =
                        (ssUserChartIO_Sheet1.Cells[20, 3].Text.Length == 0 ? strDiet2 : ssUserChartIO_Sheet1.Cells[20, 3].Text) +
                        (strDiet2Qty > 100 ? "(" + strDiet2Qty + ")" : "");

                        ssUserChartIO_Sheet1.Cells[21, 3].Text = strDiet1Etc.Length != 0 ? "아)" + strDiet1Etc : "";
                        ssUserChartIO_Sheet1.Cells[21, 3].Text = ssUserChartIO_Sheet1.Cells[21, 3].Text + " " +
                    ...
                    {
                        ssUserChartIO_Sheet1.Cells[18, 3].Text =
                        (ssUserChartIO_Sheet1.Cells[18, 3].Text.Length == 0 ? strDiet3 : ssUserChartIO_Sheet1.Cells[18, 3].Text) +
                        (strDiet3Qty > 100 ? "(" + strDiet3Qty + ")" : "");

                        ssUserChartIO_Sheet1.Cells[21, 3].Text = strDiet3Etc.Length != 0 ? "저)" + strDiet3Etc : "";
                    }
                }
        ...
        void READ_NEBULIZER(string argPTNO, string ArgInDate, string argChartDate, string ArgGubun)
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "  FROM KOSMOS_OCS.OCS_IORDER_ACT A,";
                SQL = SQL + ComNum.VBLF + "   (SELECT C.PTNO, TRIM(extractValue(chartxml, '//it1')) BDATE, extractValue(chartxml, '//it2') SUCODE";
                SQL = SQL + ComNum.VBLF + "     FROM KOSMOS_EMR.EMRXML B, KOSMOS_EMR.EMRXMLMST C";
                ...
                SQL = SQL + ComNum.VBLF + "          AND A.DOSCODE IN ( SELECT DOSCODE FROM KOSMOS_OCS.OCS_ODOSAGE";

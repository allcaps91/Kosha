...
namespace ComEmrBase
{
    ...
    /// 낙상 예방 간호활동기록지
    /// FORMNO = 2476
    /// \mtsEmrf\frmTextEmr_NrActFall.frm
    /// </summary>
    public partial class frmTextEmr_NrActPchy : Form, EmrChartForm
    {
        #region // TopMenu관련 선언
        ...
        #region //생성자
        public frmTextEmr_NrActPchy()
        {
            InitializeComponent();
        }

        public frmTextEmr_NrActPchy(string pMake, int pItemCnt, int pHeadCnt, FormFlowSheet[] pFormFlowSheet, FormFlowSheetHead[,] pFormFlowSheetHead)
        {
            InitializeComponent();
            mFLOWGB = pMake;
        ...
        public frmTextEmr_NrActPchy(string strFormNo, string strUpdateNo, string strEmrNo, int pCallFormGb)
        {
            InitializeComponent();
        ...
        public frmTextEmr_NrActPchy(string strFormNo, string strUpdateNo, EmrPatient po, string strEmrNo, string strMode, string strOrderDate, FormEmrMessage pEmrCallForm) //절대 수정하시 마시요(서식생성기 에러남)
        {
            mstrFormNo = strFormNo;
            mstrUpdateNo = strUpdateNo;
            pAcp = po;
        ...
        public frmTextEmr_NrActPchy(string strFormNo, string strUpdateNo, EmrPatient po, string strEmrNo, string strMode, FormEmrMessage pEmrCallForm) //절대 수정하시 마시요(서식생성기 에러남)
        {
            mstrFormNo = strFormNo;
            mstrUpdateNo = strUpdateNo;
            pAcp = po;
        ...
        private void frmTextEmr_NrActFall_Load(object sender, EventArgs e)
        {
            ...
            {            
                ...
                FarPoint.Win.Spread.SpreadView view = new FarPoint.Win.Spread.SpreadView(ssUserChartIO);
                FarPoint.Win.Spread.EditorNotifyEventArgs a = new FarPoint.Win.Spread.EditorNotifyEventArgs(view, ssUserChartIO, 1, 2);
                ssUserChartIO_ComboSelChange(ssUserChartIO, a);
        ...
        void ClearForm()
        {
            ...
            ssUserChartIO_Sheet1.Cells[5, 2].Text = "수면상태";
            ssUserChartIO_Sheet1.Cells[17, 2].Text = "식욕";
        }
        ...
        void GetLastValue(int lngCol, int lngRow)
        {
            ...
            string strEmrNo = ssUserChartHisIO_Sheet1.Cells[41, lngCol].Text.Trim();
            int i = 0;
            int nCol = 0;

            for (int xCol1 = 0; xCol1 < ssUserChartHisIO_Sheet1.ColumnCount; xCol1++)
            {
                if (strEmrNo == ssUserChartHisIO_Sheet1.Cells[41, xCol1].Text.Trim())
                {
                    i = i + 1;
                    if (i == 1)
                    {
                    ...
                    for (int xRow = 3; xRow < 40; xRow++)
                    {
                        if (nCol == 3)
                        {
                            if (!(xRow == 3 || xRow == 4))
                            {
                                ssUserChartIO_Sheet1.Cells[xRow, 3].Text = ssUserChartHisIO_Sheet1.Cells[xRow, xCol1].Text.Trim();
                            }
                        }
                        else
                        {
        ...
        void MakeUserChart(string strFormNo, int lngStartCol)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        case "EDIT":
                            //TypeText.WordWrap = dt.Rows[i]["MULTILINE"].ToString().Trim() == "1" ? true : false;
        ...
        string MkValue()
        {
            ...
            strVal += MkHaT(16, ssUserChartIO_Sheet1.Cells[3, 3].Text.Trim());

            strVal += MkHaT(17, ssUserChartIO_Sheet1.Cells[4, 2].Text.Trim());
            strVal += MkHaT(18, ssUserChartIO_Sheet1.Cells[4, 3].Text.Trim());

            strVal += MkHaT(19, ssUserChartIO_Sheet1.Cells[5, 2].Text.Trim());
            strVal += MkHaT(20, ssUserChartIO_Sheet1.Cells[5, 3].Text.Trim());

            strVal += MkHaT(21, ssUserChartIO_Sheet1.Cells[6, 2].Text.Trim());
            strVal += MkHaT(22, ssUserChartIO_Sheet1.Cells[6, 3].Text.Trim());

            strVal += MkHaT(23, ssUserChartIO_Sheet1.Cells[7, 2].Text.Trim());
            strVal += MkHaT(24, ssUserChartIO_Sheet1.Cells[7, 3].Text.Trim());

            strVal += MkHaT(25, ssUserChartIO_Sheet1.Cells[8, 2].Text.Trim());
            strVal += MkHaT(26, ssUserChartIO_Sheet1.Cells[8, 3].Text.Trim());

            strVal += MkHaT(27, ssUserChartIO_Sheet1.Cells[9, 2].Text.Trim());
            strVal += MkHaT(28, ssUserChartIO_Sheet1.Cells[9, 3].Text.Trim());

            strVal += MkHaT(29, ssUserChartIO_Sheet1.Cells[10, 2].Text.Trim());
            strVal += MkHaT(30, ssUserChartIO_Sheet1.Cells[10, 3].Text.Trim());

            strVal += MkHaT(31, ssUserChartIO_Sheet1.Cells[11, 2].Text.Trim());
            strVal += MkHaT(32, ssUserChartIO_Sheet1.Cells[11, 3].Text.Trim());

            strVal += MkHaT(33, ssUserChartIO_Sheet1.Cells[12, 2].Text.Trim());
            strVal += MkHaT(34, ssUserChartIO_Sheet1.Cells[12, 3].Text.Trim());

            strVal += MkHaT(35, ssUserChartIO_Sheet1.Cells[13, 2].Text.Trim());
            strVal += MkHaT(36, ssUserChartIO_Sheet1.Cells[13, 3].Text.Trim());

            strVal += MkHaT(37, ssUserChartIO_Sheet1.Cells[14, 2].Text.Trim());
            strVal += MkHaT(38, ssUserChartIO_Sheet1.Cells[14, 3].Text.Trim());

            strVal += MkHaT(39, ssUserChartIO_Sheet1.Cells[15, 2].Text.Trim());
            strVal += MkHaT(40, ssUserChartIO_Sheet1.Cells[15, 3].Text.Trim());

            strVal += MkHaT(41, ssUserChartIO_Sheet1.Cells[16, 2].Text.Trim());
            strVal += MkHaT(42, ssUserChartIO_Sheet1.Cells[16, 3].Text.Trim());

            strVal += MkHaT(43, ssUserChartIO_Sheet1.Cells[17, 2].Text.Trim());
            strVal += MkHaT(44, ssUserChartIO_Sheet1.Cells[17, 3].Text.Trim());

            strVal += MkHaT(45, ssUserChartIO_Sheet1.Cells[18, 2].Text.Trim());
            strVal += MkHaT(46, ssUserChartIO_Sheet1.Cells[18, 3].Text.Trim());

            strVal += MkHaT(47, ssUserChartIO_Sheet1.Cells[19, 2].Text.Trim());
            strVal += MkHaT(48, ssUserChartIO_Sheet1.Cells[19, 3].Text.Trim());

            strVal += MkHaT(49, ssUserChartIO_Sheet1.Cells[20, 2].Text.Trim());
            strVal += MkHaT(50, ssUserChartIO_Sheet1.Cells[20, 3].Text.Trim());

            strVal += MkHaT(51, ssUserChartIO_Sheet1.Cells[21, 2].Text.Trim());
            strVal += MkHaT(52, ssUserChartIO_Sheet1.Cells[21, 3].Text.Trim());

            strVal += MkHaT(53, ssUserChartIO_Sheet1.Cells[22, 2].Text.Trim());
            strVal += MkHaT(54, ssUserChartIO_Sheet1.Cells[22, 3].Text.Trim());

            strVal += MkHaT(55, ssUserChartIO_Sheet1.Cells[23, 2].Text.Trim());
            strVal += MkHaT(56, ssUserChartIO_Sheet1.Cells[23, 3].Text.Trim());

            strVal += MkHaT(57, ssUserChartIO_Sheet1.Cells[24, 2].Text.Trim());
            strVal += MkHaT(58, ssUserChartIO_Sheet1.Cells[24, 3].Text.Trim());

            strVal += MkHaT(59, ssUserChartIO_Sheet1.Cells[25, 2].Text.Trim());
            strVal += MkHaT(60, ssUserChartIO_Sheet1.Cells[25, 3].Text.Trim());

            strVal += MkHaT(61, ssUserChartIO_Sheet1.Cells[26, 2].Text.Trim());
            strVal += MkHaT(62, ssUserChartIO_Sheet1.Cells[26, 3].Text.Trim());

            strVal += MkHaT(63, ssUserChartIO_Sheet1.Cells[27, 2].Text.Trim());
            strVal += MkHaT(64, ssUserChartIO_Sheet1.Cells[27, 3].Text.Trim());

            strVal += MkHaT(65, ssUserChartIO_Sheet1.Cells[28, 2].Text.Trim());
            strVal += MkHaT(66, ssUserChartIO_Sheet1.Cells[28, 3].Text.Trim());

            strVal += MkHaT(67, ssUserChartIO_Sheet1.Cells[29, 2].Text.Trim());
            strVal += MkHaT(68, ssUserChartIO_Sheet1.Cells[29, 3].Text.Trim());

            strVal += MkHaT(69, ssUserChartIO_Sheet1.Cells[30, 2].Text.Trim());
            strVal += MkHaT(70, ssUserChartIO_Sheet1.Cells[30, 3].Text.Trim());

            strVal += MkHaT(71, ssUserChartIO_Sheet1.Cells[31, 2].Text.Trim());
            strVal += MkHaT(72, ssUserChartIO_Sheet1.Cells[31, 3].Text.Trim());

            strVal += MkHaT(73, ssUserChartIO_Sheet1.Cells[32, 2].Text.Trim());
            strVal += MkHaT(74, ssUserChartIO_Sheet1.Cells[32, 3].Text.Trim());

            strVal += MkHaT(75, ssUserChartIO_Sheet1.Cells[33, 2].Text.Trim());
            strVal += MkHaT(76, ssUserChartIO_Sheet1.Cells[33, 3].Text.Trim());

            strVal += MkHaT(77, ssUserChartIO_Sheet1.Cells[34, 2].Text.Trim());
            strVal += MkHaT(78, ssUserChartIO_Sheet1.Cells[34, 3].Text.Trim());

            strVal += MkHaT(79, ssUserChartIO_Sheet1.Cells[35, 2].Text.Trim());
            strVal += MkHaT(80, ssUserChartIO_Sheet1.Cells[35, 3].Text.Trim());

            strVal += MkHaT(81, ssUserChartIO_Sheet1.Cells[36, 2].Text.Trim());
            strVal += MkHaT(82, ssUserChartIO_Sheet1.Cells[36, 3].Text.Trim());

            strVal += MkHaT(83, ssUserChartIO_Sheet1.Cells[37, 2].Text.Trim());
            strVal += MkHaT(84, ssUserChartIO_Sheet1.Cells[37, 3].Text.Trim());

            strVal += MkHaT(85, ssUserChartIO_Sheet1.Cells[38, 2].Text.Trim());
            strVal += MkHaT(86, ssUserChartIO_Sheet1.Cells[38, 3].Text.Trim());

            strVal += MkHaT(87, ssUserChartIO_Sheet1.Cells[39, 2].Text.Trim());
            strVal += MkHaT(88, ssUserChartIO_Sheet1.Cells[39, 3].Text.Trim());
        ...
        void ConVIoData()
        {
            ...
            for (int xRow1 = 0; xRow1 < ssUserChartHis_Sheet1.RowCount; xRow1++)
            {
                ...
                //작성자
                ssConV_Sheet1.Cells[40, 0].Text = ssUserChartHis_Sheet1.Cells[xRow1, 91].Text.Trim(); //string.Format("{0} / {1}", ssUserChartHis_Sheet1.Cells[xRow1, 91].Text.Trim(), strTime);
                ssConV_Sheet1.Cells[40, 1].Text = ssUserChartHis_Sheet1.Cells[xRow1, 91].Text.Trim(); //string.Format("{0} / {1}", ssUserChartHis_Sheet1.Cells[xRow1, 91].Text.Trim(), strTime);

                //EMRNO
                ssConV_Sheet1.Cells[41, 0].Text = ssUserChartHis_Sheet1.Cells[xRow1, 11].Text.Trim();
                ssConV_Sheet1.Cells[41, 1].Text = ssUserChartHis_Sheet1.Cells[xRow1, 11].Text.Trim();

                //USEID
                ssConV_Sheet1.Cells[42, 0].Text = ssUserChartHis_Sheet1.Cells[xRow1, 12].Text.Trim();
                ssConV_Sheet1.Cells[42, 1].Text = ssUserChartHis_Sheet1.Cells[xRow1, 12].Text.Trim();
                SetIoHis();
            }
        ...
        void SetIoHis()
        {
            ...
            ssUserChartHisIO_Sheet1.Cells[40, ssUserChartHisIO_Sheet1.ColumnCount - 2].CellType = new TextCellType();
            ssUserChartHisIO_Sheet1.Cells[40, ssUserChartHisIO_Sheet1.ColumnCount - 2].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            ssUserChartHisIO_Sheet1.Cells[40, ssUserChartHisIO_Sheet1.ColumnCount - 2].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            ...
            ssUserChartHisIO_Sheet1.AddSpanCell(40, ssUserChartHisIO_Sheet1.ColumnCount - 2, 1, 2);

            ssUserChartHisIO_Sheet1.Columns[ssUserChartHisIO_Sheet1.ColumnCount - 2].Width = 90;//ssUserChartHisIO_Sheet1.Columns[ssUserChartHisIO_Sheet1.ColumnCount - 2].GetPreferredWidth() + 5;
            ssUserChartHisIO_Sheet1.Columns[ssUserChartHisIO_Sheet1.ColumnCount - 1].Width = 130;//ssUserChartHisIO_Sheet1.Columns[ssUserChartHisIO_Sheet1.ColumnCount - 1].GetPreferredWidth() + 5;
        }
        ...
        private void SsUserChartHisIO_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            mEmrUseId = ssUserChartHisIO_Sheet1.Cells[42, e.Column].Text.Trim();

            string strEmrNo = ssUserChartHisIO_Sheet1.Cells[41, e.Column].Text.Trim();
            mstrEmrNo = strEmrNo;
            ...
            for (int xCol1 = 0; xCol1 < ssUserChartHisIO_Sheet1.ColumnCount; xCol1++)
            {
                if (strEmrNo == ssUserChartHisIO_Sheet1.Cells[41, xCol1].Text.Trim())
                {
                    ...
                    for (int xRow1 = 3; xRow1 < 40; xRow1++)
                    {
                        ssUserChartIO_Sheet1.Cells[xRow1, nCol].Text = ssUserChartHisIO_Sheet1.Cells[xRow1, xCol1].Text.Trim();                  
                    }
                }
            }
        ...
        {
            if (ssUserChartHisIO_Sheet1.ActiveColumn.Index <= 1)
            {
                return;
            }

            GetLastValue(ssUserChartHisIO_Sheet1.ActiveColumn.Index, 0);
        }
        ...
        private void ssUserChartIO_ComboSelChange(object sender, FarPoint.Win.Spread.EditorNotifyEventArgs e)
        {
            ...
            {
                //strChartDate = string.Format(dtp)

                strDuty = ssUserChartIO_Sheet1.Cells[e.Row, e.Column].Text.Trim();

                ssUserChartIO_Sheet1.Cells[16, 2].Text = "";
                ssUserChartIO_Sheet1.Cells[18, 2].Text = "";

                strSql = " SELECT D.DIETDAY, D.BUN,  D.DIETNAME, D.QTY ";
                strSql = strSql + ComNum.VBLF + "   FROM ADMIN.DIET_NEWORDER D ";
                strSql = strSql + ComNum.VBLF + "WHERE D.ACTDATE = TO_DATE('" + usFormTopMenuEvent.dtMedFrDate.Value.ToShortDateString() + "', 'YYYY-MM-DD') ";
                strSql = strSql + ComNum.VBLF + "     AND D.PANO = '" + pAcp.ptNo + "' ";
                strSql = strSql + ComNum.VBLF + "     AND D.BUN IN ('01','02','03','04') ";
                clsDB.GetDataTableREx(ref dt, strSql, clsDB.DbCon);
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    if (dt.Rows[i]["BUN"].ToString().Trim() != "04")
                    {
                        ...
                        {
                            case "1":
                                strDiet1 = strDiet1 + dt.Rows[i]["DIETNAME"].ToString().Trim();
                                strDiet1Qty = VB.Val(dt.Rows[i]["QTY"].ToString()).ToString();
                                break;
                            case "2":
                                strDiet2 = strDiet2 + dt.Rows[i]["DIETNAME"].ToString().Trim();
                                strDiet2Qty = VB.Val(dt.Rows[i]["QTY"].ToString()).ToString();
                                break;
                            case "3":
                                strDiet3 = strDiet3 + dt.Rows[i]["DIETNAME"].ToString().Trim();
                                strDiet3Qty = VB.Val(dt.Rows[i]["QTY"].ToString()).ToString();
                                break;
                    ...
                    else
                    {
                        switch (dt.Rows[i]["DIETDAY"].ToString().Trim())
                        {
                            case "1": strDiet1Etc = strDiet1 + dt.Rows[i]["DIETNAME"].ToString().Trim(); break;
                            case "2": strDiet1Etc = strDiet2 + dt.Rows[i]["DIETNAME"].ToString().Trim(); break;
                            case "3": strDiet1Etc = strDiet3 + dt.Rows[i]["DIETNAME"].ToString().Trim(); break;
                        }
                    }
                }
                ...
                if (strDuty == "Day")
                {
                    ssUserChartIO_Sheet1.Cells[16, 2].Text = VB.Trim(ssUserChartIO_Sheet1.Cells[16, 2].Text) == "" ? strDiet1 : ssUserChartIO_Sheet1.Cells[16, 2].Text
                        + (VB.Val(strDiet1Qty) > 100 ? "(" + strDiet1Qty + ")" : "");

                    ssUserChartIO_Sheet1.Cells[18, 2].Text = VB.Trim(ssUserChartIO_Sheet1.Cells[18, 2].Text) == "" ? strDiet2 : ssUserChartIO_Sheet1.Cells[18, 2].Text
                        + (VB.Val(strDiet2Qty) > 100 ? "(" + strDiet2Qty + ")" : "");

                    ssUserChartIO_Sheet1.Cells[19, 2].Text = strDiet1Etc != "" ? "아)" + strDiet1Etc : ""
                        + " " + (strDiet3Etc != "" ? "점)" + strDiet2Etc : "");
                }
                else if (strDuty == "Evening")
                {
                    ssUserChartIO_Sheet1.Cells[16, 2].Text = VB.Trim(ssUserChartIO_Sheet1.Cells[16, 2].Text) == "" ? strDiet3 : ssUserChartIO_Sheet1.Cells[16, 2].Text
                        + (VB.Val(strDiet3Qty) > 100 ? "(" + strDiet3Qty + ")" : "");

                    ssUserChartIO_Sheet1.Cells[19, 2].Text = strDiet3Etc != "" ? "저)" + strDiet3Etc : "";
                }

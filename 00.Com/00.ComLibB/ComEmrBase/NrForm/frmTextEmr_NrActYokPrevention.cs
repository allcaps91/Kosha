...
namespace ComEmrBase
{
    ...
    /// 욕창예방간호활동기록지
    /// FORMNO = 2596
    /// \mtsEmrf\frmTextEmr_NrActYokPrevention.frm
    /// </summary>
    public partial class frmTextEmr_NrActYokPrevention : Form, EmrChartForm
    {
        #region // TopMenu관련 선언
        ...
        private void pPrintForm()
        {
            clsSpreadPrint.PrintEmrSpread(clsDB.DbCon, mstrFormNo, mstrUpdateNo, pAcp, true, dtpOptSDate.Value.ToString("yyyyMMdd"), dtpOptEDate.Value.ToString("yyyyMMdd"),
                                             ssUserChartHisIO, "P", 30, 20, 30, 20, false, FarPoint.Win.Spread.PrintOrientation.Landscape, mFLOWGB, -1, 20, mFLOWHEADCNT, "P");
        }
        ...
        #region //생성자
        public frmTextEmr_NrActYokPrevention()
        {
            InitializeComponent();
        }

        public frmTextEmr_NrActYokPrevention(string pMake, int pItemCnt, int pHeadCnt, FormFlowSheet[] pFormFlowSheet, FormFlowSheetHead[,] pFormFlowSheetHead)
        {
            InitializeComponent();
            mFLOWGB = pMake;
        ...
        public frmTextEmr_NrActYokPrevention(string strFormNo, string strUpdateNo, string strEmrNo, int pCallFormGb)
        {
            InitializeComponent();
        ...
        public frmTextEmr_NrActYokPrevention(string strFormNo, string strUpdateNo, EmrPatient po, string strEmrNo, string strMode, string strOrderDate, FormEmrMessage pEmrCallForm) //절대 수정하시 마시요(서식생성기 에러남)
        {
            mstrFormNo = strFormNo;
            mstrUpdateNo = strUpdateNo;
            pAcp = po;
        ...
        public frmTextEmr_NrActYokPrevention(string strFormNo, string strUpdateNo, EmrPatient po, string strEmrNo, string strMode, FormEmrMessage pEmrCallForm) //절대 수정하시 마시요(서식생성기 에러남)
        {
            mstrFormNo = strFormNo;
            mstrUpdateNo = strUpdateNo;
            pAcp = po;
        ...
        private void frmTextEmr_NrActYokPrevention_Load(object sender, EventArgs e)
        {
        ...
        void GetLastValue(int lngCol)
        {
            ...
            string strEmrNo = ssUserChartHisIO_Sheet1.Cells[28, lngCol].Text.Trim();

            for (int xCol1 = 0; xCol1 < ssUserChartHisIO_Sheet1.ColumnCount; xCol1++)
            {
                if (strEmrNo == ssUserChartHisIO_Sheet1.Cells[28, xCol1].Text.Trim())
                {
                    for (int xRow = 5; xRow < 27; xRow++)
                    {
        ...
        string MkValue()
        {
            ...
            strVal += MkHaT(29, ssUserChartIO_Sheet1.Cells[17, 2].Text.Trim());
            strVal += MkHaT(30, ssUserChartIO_Sheet1.Cells[18, 2].Text.Trim());
            strVal += MkHaT(31, ssUserChartIO_Sheet1.Cells[19, 2].Text.Trim());
            strVal += MkHaT(32, ssUserChartIO_Sheet1.Cells[20, 2].Text.Trim());
            strVal += MkHaT(33, ssUserChartIO_Sheet1.Cells[21, 2].Text.Trim());
            strVal += MkHaT(34, ssUserChartIO_Sheet1.Cells[22, 2].Text.Trim());
            strVal += MkHaT(35, ssUserChartIO_Sheet1.Cells[23, 2].Text.Trim());
            strVal += MkHaT(36, ssUserChartIO_Sheet1.Cells[24, 2].Text.Trim());
            strVal += MkHaT(37, ssUserChartIO_Sheet1.Cells[25, 2].Text.Trim());
            strVal += MkHaT(38, ssUserChartIO_Sheet1.Cells[26, 2].Text.Trim());
        ...
        void READ_INIT_FALL()
        {
            ...
            try
            {
                ...
                ssUserChartIO_Sheet1.Cells[3, 2].Text = READ_DETAIL_BRADEN(pAcp.ptNo,
                  Convert.ToDateTime(ComQuery.CurrentDateTime(clsDB.DbCon, "S")).ToShortDateString(), strIpdNo, pAcp.age, pAcp.ward);
                ...
                ssUserChartIO_Sheet1.Cells[4, 2].Text = READ_DETAIL_EVAL_BRADEN_NEW(strIpdNo);
        ...
        string READ_DETAIL_BRADEN(string argPTNO, string argDate, string argIPDNO, string argAge, string argWARD, string ArgDate2 = "")
        {
            OracleDataReader dataReader = null;
            DataTable dt = null;
            string SQL = string.Empty;
        ...
        string READ_DETAIL_EVAL_BRADEN_NEW(string strIpdNo)
        {
            string rtnVal = string.Empty;
            ...
            try
            {
                ...
                SQL = " SELECT * ";
                SQL += ComNum.VBLF + " FROM KOSMOS_PMPA.NUR_BRADEN_EVAL ";
        ...
        void ConVIoData()
        {
            ...
            for (int xRow1 = 0; xRow1 < ssUserChartHis_Sheet1.RowCount; xRow1++)
            {
                ...
                //작성자
                ssConV_Sheet1.Cells[27, 0].Text = string.Format("{0} / {1}", ssUserChartHis_Sheet1.Cells[xRow1, 41].Text.Trim(), strTime);

                //EMRNO
                ssConV_Sheet1.Cells[28, 0].Text = ssUserChartHis_Sheet1.Cells[xRow1, 11].Text.Trim();

                //USEID
                ssConV_Sheet1.Cells[29, 0].Text = ssUserChartHis_Sheet1.Cells[xRow1, 12].Text.Trim();
        ...
        void SetIoHis(int intColorInfo)
        {
            ...
            ssUserChartHisIO_Sheet1.Columns[2, ssUserChartHisIO_Sheet1.ColumnCount - 1].Width = 120;
            ssUserChartHisIO_Sheet1.Cells[2, ssUserChartHisIO_Sheet1.ColumnCount - 2, ssUserChartHisIO_Sheet1.RowCount - 1, ssUserChartHisIO_Sheet1.ColumnCount - 1].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            ssUserChartHisIO_Sheet1.Cells[2, ssUserChartHisIO_Sheet1.ColumnCount - 2, ssUserChartHisIO_Sheet1.RowCount - 1, ssUserChartHisIO_Sheet1.ColumnCount - 1].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            ssUserChartHisIO_Sheet1.Cells[0, 2, 0, ssUserChartHisIO_Sheet1.ColumnCount - 1].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
        ...
        private void SsUserChartHisIO_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            string strEmrNo = ssUserChartHisIO_Sheet1.Cells[28, e.Column].Text.Trim();
            mstrEmrNo = strEmrNo;
            mEmrUseId = ssUserChartHisIO_Sheet1.Cells[29, e.Column].Text.Trim();
            ...
            for (int xCol1 = 0; xCol1 < ssUserChartHisIO_Sheet1.ColumnCount; xCol1++)
            {
                if (strEmrNo == ssUserChartHisIO_Sheet1.Cells[28, xCol1].Text.Trim())
                {
                    for (int xRow1 = 5; xRow1 < 27; xRow1++)
                    {

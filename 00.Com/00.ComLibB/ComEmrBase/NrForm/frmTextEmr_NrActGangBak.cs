...
namespace ComEmrBase
{
    ...
    /// 신체억제간호활동기록지
    /// FORMNO = 1574
    /// \mtsEmrf\frmTextEmr_NrActGangBak.frm
    /// </summary>
    public partial class frmTextEmr_NrActGangBak : Form, EmrChartForm
    {
        #region // TopMenu관련 선언
        ...
        #region //생성자
        public frmTextEmr_NrActGangBak()
        {
            InitializeComponent();
        }

        public frmTextEmr_NrActGangBak(string pMake, int pItemCnt, int pHeadCnt, FormFlowSheet[] pFormFlowSheet, FormFlowSheetHead[,] pFormFlowSheetHead)
        {
            InitializeComponent();
            mFLOWGB = pMake;
        ...
        public frmTextEmr_NrActGangBak(string strFormNo, string strUpdateNo, string strEmrNo, int pCallFormGb)
        {
            InitializeComponent();
        ...
        public frmTextEmr_NrActGangBak(string strFormNo, string strUpdateNo, EmrPatient po, string strEmrNo, string strMode, string strOrderDate, FormEmrMessage pEmrCallForm) //절대 수정하시 마시요(서식생성기 에러남)
        {
            mstrFormNo = strFormNo;
            mstrUpdateNo = strUpdateNo;
            pAcp = po;
        ...
        public frmTextEmr_NrActGangBak(string strFormNo, string strUpdateNo, EmrPatient po, string strEmrNo, string strMode, FormEmrMessage pEmrCallForm) //절대 수정하시 마시요(서식생성기 에러남)
        {
            mstrFormNo = strFormNo;
            mstrUpdateNo = strUpdateNo;
            pAcp = po;
        ...
        string MkValue()
        {
            ...
            strVal += MkHaT(16, ssUserChartIO_Sheet1.Cells[4, 3].Text.Trim());
            strVal += MkHaT(17, ssUserChartIO_Sheet1.Cells[5, 3].Text.Trim());
            strVal += MkHaT(18, ssUserChartIO_Sheet1.Cells[6, 3].Text.Trim());
            strVal += MkHaT(19, ssUserChartIO_Sheet1.Cells[7, 3].Text.Trim());
            strVal += MkHaT(20, ssUserChartIO_Sheet1.Cells[8, 3].Text.Trim());
            strVal += MkHaT(21, ssUserChartIO_Sheet1.Cells[9, 3].Text.Trim());
            strVal += MkHaT(22, ssUserChartIO_Sheet1.Cells[10, 3].Text.Trim());
            strVal += MkHaT(23, ssUserChartIO_Sheet1.Cells[11, 3].Text.Trim());
            strVal += MkHaT(24, ssUserChartIO_Sheet1.Cells[12, 3].Text.Trim());
            strVal += MkHaT(25, ssUserChartIO_Sheet1.Cells[13, 3].Text.Trim());
            strVal += MkHaT(26, ssUserChartIO_Sheet1.Cells[14, 3].Text.Trim());
            strVal += MkHaT(27, ssUserChartIO_Sheet1.Cells[15, 3].Text.Trim());
            strVal += MkHaT(28, ssUserChartIO_Sheet1.Cells[16, 3].Text.Trim());
            strVal += MkHaT(29, ssUserChartIO_Sheet1.Cells[17, 3].Text.Trim());
            strVal += MkHaT(30, ssUserChartIO_Sheet1.Cells[18, 3].Text.Trim());
            strVal += MkHaT(31, ssUserChartIO_Sheet1.Cells[19, 3].Text.Trim());
            strVal += MkHaT(32, ssUserChartIO_Sheet1.Cells[20, 3].Text.Trim());
            strVal += MkHaT(33, ssUserChartIO_Sheet1.Cells[21, 3].Text.Trim());
            strVal += MkHaT(34, ssUserChartIO_Sheet1.Cells[22, 3].Text.Trim());
            strVal += MkHaT(35, ssUserChartIO_Sheet1.Cells[23, 3].Text.Trim());
        ...
        void ConVIoData()
        {
            for (int xRow1 = 0; xRow1 < ssUserChartHis_Sheet1.RowCount; xRow1++)
            {
                ...
                //작성자
                ssConV_Sheet1.Cells[24, 0].Text = string.Format("{0} / {1}", ssUserChartHis_Sheet1.Cells[xRow1, 38].Text.Trim(), strTime);
        ...
        void SetIoHis()
        {
            ...
            ssUserChartHisIO_Sheet1.Cells[24, ssUserChartHisIO_Sheet1.ColumnCount - 1].CellType = new TextCellType();
            ssUserChartHisIO_Sheet1.Cells[24, ssUserChartHisIO_Sheet1.ColumnCount - 1].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            ssUserChartHisIO_Sheet1.Cells[24, ssUserChartHisIO_Sheet1.ColumnCount - 1].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
        ...
        private void SsUserChartHisIO_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            mstrEmrNo = strEmrNo;
            mEmrUseId = ssUserChartHisIO_Sheet1.Cells[26, e.Column].Text.Trim();
        ...
        private void BtnSearchPreHis_Click(object sender, EventArgs e)
        {
            ...
            string strDuty = ssUserChartHisIO_Sheet1.Cells[1, ssUserChartHisIO_Sheet1.ActiveColumnIndex].Text.Trim();

            ssUserChartIO_Sheet1.Cells[1, 3].Text = strDuty;

            for(int xRow1 = 3; xRow1 < 24; xRow1++)
            {
                ssUserChartIO_Sheet1.Cells[xRow1, 3].Text = ssUserChartHisIO_Sheet1.Cells[xRow1, ssUserChartHisIO_Sheet1.ActiveColumnIndex].Text.Trim();
            }
        }

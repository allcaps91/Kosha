...
{
    public partial class frmEmrForm_Progress_New : Form, EmrChartForm
    {
        string mstrPROGNO = "";
        string mSYSMPGB = "";
        /// <summary>
        ...
        public frmEmrForm_Progress_New()
        {
            InitializeComponent();
        }

        public frmEmrForm_Progress_New(EmrPatient pAcpEmr, FormEmrMessage pEmrCallForm)
        {
            InitializeComponent();
            AcpEmr = pAcpEmr;
        ...
        public frmEmrForm_Progress_New(string strFormNo, string strUpdateNo, EmrPatient po, string strEmrNo, string strMode, FormEmrMessage pEmrCallForm)
        {
        ...
        void ChkFrDate()
        {
            ...
            if (mEmrCallForm == null ||
                mEmrCallForm != null && ((Form)mEmrCallForm).Name != "frmEmrBaseProgressOcsNew" ||
                AcpEmr == null || AcpEmr.inOutCls == "O")
                return;
        ...
        private bool SaveData()
        {
            ...
            string strCONTENTS = "(SELECT CONTENTS FROM KOSMOS_EMR.EMRFORM WHERE FORMNO = " + VB.Val(mstrPROGNO) + ")";
            ...
            try
            {
                ...
                double dblEmrNoNew = ComQuery.GetSequencesNo(clsDB.DbCon, "KOSMOS_EMR.GetEmrXmlNo");
                ...
                SQL = "";
                SQL = SQL + ComNum.VBLF + "    UPDATE KOSMOS_EMR.EMRMIBI SET WRITEDATE = '" + VB.Left(strCurDateTime, 8) + "', WRITETIME = '" + VB.Right(strCurDateTime, 6) + "'";

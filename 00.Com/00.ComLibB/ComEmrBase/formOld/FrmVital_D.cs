    ...
    public partial class FrmVital_D : Form
    {
        ...
        void READ_VITAL()
        {
            ...
            try
            {
                ...
                SQL += ComNum.VBLF + "  SELECT EMRNO FROM KOSMOS_EMR.EMRXMLMST WHERE FORMNO = 1562";
                ...
                if (pForm.FmOLDGB != 1)
                {
                    ...
                    SQL = SQL + ComNum.VBLF + "       LEFT OUTER JOIN KOSMOS_EMR.AEMRCHARTROW B0";
                    ...
                    SQL = SQL + ComNum.VBLF + "       LEFT OUTER JOIN KOSMOS_EMR.AEMRCHARTROW B00";
                    ...
                    SQL = SQL + ComNum.VBLF + "       LEFT OUTER JOIN KOSMOS_EMR.AEMRCHARTROW B41";
                    ...
                    SQL = SQL + ComNum.VBLF + "       LEFT OUTER JOIN KOSMOS_EMR.AEMRCHARTROW B51";
                    ...
                    SQL = SQL + ComNum.VBLF + "       LEFT OUTER JOIN KOSMOS_EMR.AEMRCHARTROW B71";
                    ...
                    SQL = SQL + ComNum.VBLF + "       LEFT OUTER JOIN KOSMOS_EMR.AEMRCHARTROW B11";
                    ...
                    SQL = SQL + ComNum.VBLF + "       LEFT OUTER JOIN KOSMOS_EMR.AEMRCHARTROW B12";

...
namespace ComDbB
{
    public class PsmhVB
    {
        ...
        /// <returns></returns>
        public int Len(string Expression)
        {
            int rtnVal = 0;
        ...
        /// <param name="String"></param>
        /// <returns></returns>
        public string String(int intLen, string String)
        {
            string rtnVal = "";
        ...
        /// <returns></returns>
        public DateTime DateAddVB(DateInterval Interval, double Number, DateTime DateValue)
        {
        ...
        /// <param name="DateValue"></param>
        /// <returns></returns>
        public DateTime DateAdd(string Interval, double Number, object DateValue)
        {
            DateTime rtnVal;
        ...
        /// <returns></returns>
        public long DateDiffVB(DateInterval Interval, DateTime Date1, DateTime Date2)
        {
        ...
        /// <param name="Date2"></param>
        /// <returns></returns>
        public long DateDiff(string Interval, object Date1, object Date2)
        {
            //s Second
            //n Minute
            //h Hour
        ...
        /// <param name="Date1"></param>
        /// <returns></returns>
        public long DatePart(string Interval, object Date1)
        {
        ...
        /// <param name="DateValue"></param>
        /// <returns></returns>
        public int Day(DateTime DateValue)
        {
        ...
        /// <returns></returns>
        public int Hour(DateTime TimeValue)
        {
        ...
        /// <param name="TimeValue"></param>
        /// <returns></returns>
        public int Minute(DateTime TimeValue)
        {
        ...
        /// <param name="DateValue"></param>
        /// <returns></returns>
        public int Weekday(DateTime DateValue)
        {
        ...
        public int Shell(string PathName, string strStyle = "NormalFocus", bool Wait = false, int Timeout = -1)
        {
            int rtnVal = 0;
        ...
        public string InputBox(string Prompt, string Title = "", string Default = "", int XPos = -1, int YPos = -1)
        {
            string rtnVal = "";
            try
            {
        ...
        public object GetObject(string PathName = "", string Class = "")
        {
            object rtnVal = null;
        ...
        public bool IsHangul(string strText)
        {
            int ncount = 0;
            int iq = 0;
        ...
        public int UBound(Array Array, int Rank = 1)
        {
            int rtnVal = 0;
        ...
        public int LBound(Array Array, int Rank = 1)
        {
            int rtnVal = 0;
        ...
        /// <returns></returns>
        public string Pstr(string strVar, string strDel, int intFromCnt, int intArg1 = 0, int intArg2 = 0)
        {
            //' (c)CopyRight 1997.12.16  made by hyuntae Jo   use TypeName function
            string rtnVal = "";

            double dblSum = Val(IIf(intArg1 > 0, 1, 0).ToString()) + Val(IIf(intArg2 > 0, 1, 0).ToString());
        ...
        /// <returns></returns>
        public string SinglePiece(string strVar, string strDel, int intCnt)
        {
            string rtnVal = "";
        ...
        /// <returns></returns>
        public string MultiPiece(string strVar, string strDel, int intFromCnt, int intToCnt)
        {
        ...
        /// <returns></returns>
        public string SinglePieceSet(string strVar, string strDel, int intCnt, string strXCH)
        {
            //' (c)CopyRight 1997.07.15  made by hyuntae Jo   multi-delimiter support
            string rtnVal = "";
        ...
        /// <param name="strXCH"></param>
        /// <returns></returns>
        public string MultiPieceSet(string strVar, string strDel, int intFromCnt, int intToCnt, string strXCH)
        {
            //' (c)CopyRight 1997.07.15  made by hyuntae Jo   multi-delimiter support
            string rtnVal = "";
        ...
        /// <returns></returns>
        public string HExtract(string strVar, string strDel, int intGetCnt)
        {
        ...
        /// <param name="strXCH"></param>
        /// <returns></returns>
        public string TR(string strVar, string strDel, string strXCH)
        {
        ...
        /// <param name="Date2"></param>
        /// <returns></returns>
        public string STRCUT(string ArgString, string ArgStart, string ArgEnd)
        {
            string rtnVal = "";
        ...
        /// <param name="strMode"></param>
        /// <returns></returns>
        public string ExtractString(string strVar, string strMode)
        {
            //ArgMode = "1"  -> 한글추출
            //ArgMode = "2"  -> 영어숫자추출
            //ArgMode = "3"  -> 특수기호추출
        ...
        /// <param name="strDel"></param>
        /// <returns></returns>
        public int I(string strVar, string strDel)
        {
            int intSrt = 0;
            int intNxt = 0;
            int intCnt = 0;

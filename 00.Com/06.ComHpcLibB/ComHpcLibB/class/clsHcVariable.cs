/// <summary>
/// Description     : 건진센터 공용모듈 / Global 변수선언 (Structure, Enum 계열 제외)
///                   Structure, Enum 계열은 => clsHcType.cs 에 선언
///                   (HaBas.bas / HcBas.bas)  
/// Author          : 김민철
...
namespace ComHpcLibB
{
    ...
    public class clsHcVariable
    {
        ...
        public static List<HEA_RESV_EXAM> LSTHaRESEXAM = new List<HEA_RESV_EXAM>();

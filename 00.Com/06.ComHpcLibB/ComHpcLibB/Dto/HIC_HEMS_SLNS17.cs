namespace ComHpcLibB.Dto
{
    ...
    /// </summary>
    /// 
    public class HIC_HEMS_SLNS17 : BaseDto
    {
        /// <summary>
        /// 특검사업년도
        /// </summary>
        ...
        /// <summary>
        /// 3번(B형간염) 바이러스 보유 여부 (①예 ②아니오 ③모름)
        /// </summary>
        public string MDCXM_ITRVW_3010 { get; set; }

        /// <summary>
        /// 4번(흡연) 평생 총5갑(100개비) 일반담배(궐련)흡연여부 (①아니오 (5번 문
        /// </summary>
        public string MDCXM_ITRVW_4010 { get; set; }

        /// <summary>
        /// 4-1번 ①일반담배(궐련) 흡연 년수(총년)  (현재 피움)
        /// </summary>
        public string MDCXM_ITRVW_4031 { get; set; }

        /// <summary>
        /// 4-1번 ①일반담배(궐련) 흡연량(하루평균 개피) (현재 피움)
        /// </summary>
        public string MDCXM_ITRVW_4032 { get; set; }

        /// <summary>
        /// 4-1번 ②일반담배(궐련)  과거 흡연년수(총년) (현재 피우지 않음)
        /// </summary>
        public string MDCXM_ITRVW_4021 { get; set; }

        /// <summary>
        /// 4-1번 ②일반담배(궐련)  과거 흡연량(하루평균 개피) (현재 피우지 않음)
        /// </summary>
        public string MDCXM_ITRVW_4022 { get; set; }

        /// <summary>
        /// 4-1번 ②일반담배(궐련)  금연 년수 (현재 피우지 않음)
        /// </summary>
        public string MDCXM_ITRVW_4023 { get; set; }

        /// <summary>
        /// 5번 궐련형 전자담배(가열담배) 사용 경험 여부 (①예 (5-1번 문항 이동),
        /// </summary>
        public string MDCXM_ITRVW_5110 { get; set; }

        /// <summary>
        /// 5-1번 ①궐련형 전자담배(가열담배) 현재 흡연년수 (총년)
        /// </summary>
        public string MDCXM_ITRVW_5120 { get; set; }

        /// <summary>
        /// 5-1번 ①궐련형 전자담배(가열담배) 현재 흡연량(하루평균 개피)
        /// </summary>
        public string MDCXM_ITRVW_5130 { get; set; }

        /// <summary>
        /// 5-1번 ②궐련형 전자담배(가열담배) 과거 흡연년수 (총년)
        /// </summary>
        public string MDCXM_ITRVW_5140 { get; set; }

        /// <summary>
        /// 5-1번 ②궐련형 전자담배(가열담배) 과거 흡연량(하루평균 개피) (현재 피
        /// </summary>
        public string MDCXM_ITRVW_5150 { get; set; }

        /// <summary>
        /// 5-1번 ②궐련형 전자담배(가열담배) 금연 년수 (현재 피우지 않음)
        /// </summary>
        public string MDCXM_ITRVW_5160 { get; set; }

        /// <summary>
        /// 6번(액상형 전자담배) 사용 경험 여부 (①예, ②아니오)
        /// </summary>
        public string MDCXM_ITRVW_5010 { get; set; }

        /// <summary>
        /// 6-1번(액상형 전자담배) 최근 한달 사용 경험 여부 (①아니오, ②월 1-2일,
        /// </summary>
        public string MDCXM_ITRVW_5020 { get; set; }

        /// <summary>
        /// 7번(음주) 지난 1년간  술을 마시는 횟수(주기) (①일주일에, ②한달에, ③
        /// </summary>
        ...
        /// <summary>
        /// 7-2번(음주) 가장 많이 마셨던 하루 음주량은 보통 어느정도 마십니까? (맥
        /// </summary>
        ...
        /// <summary>
        /// 7-2번(음주) 가장 많이 마셨던 하루 음주량은 보통 어느정도 마십니까? (양
        /// </summary>
        ...
        /// <summary>
        /// 7-2번(음주) 가장 많이 마셨던 하루 음주량은 보통 어느정도 마십니까? (막
        /// </summary>
        ...
        /// <summary>
        /// 7-2번(음주) 가장 많이 마셨던 하루 음주량은 보통 어느정도 마십니까? (와
        /// </summary>
        ...
        /// <summary>
        /// 11번(증상) 작업중 이상 (1.Yes, 2.No)
        /// </summary>
        public string MDCXM_ITRVW_A130 { get; set; }

        /// <summary>
        /// 11번(증상) 작업중 취급물질로 이상 (1.Yes, 2.No)
        /// </summary>

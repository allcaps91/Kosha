...
/// File Name       : frmHcSchoolStudentStatic.cs
/// Description     : 학생건강검진 통계표(남여)
/// Author          : 이상훈
...
/// <history>  
/// </history>
/// <seealso cref= "FrmSchool6.frm(HcSchool06)" />

namespace ComHpcLibB
{
    public partial class frmHcSchoolStudentStatic : Form
    {
        ...
        public frmHcSchoolStudentStatic()
        {
            InitializeComponent();
            SetEvent();
            SetControl();
        ...
        void eBtnClick(object sender, EventArgs e)
        {
            ...
            else if (sender == btnSearch)
            {
                ...
                if (nRead > 0)
                {
                    ...
                    HIC_JEPSU_PATIENT_SCHOOL list3 = hicJepsuPatientSchoolService.GetMinMaxDate(strFrDate, strToDate, nLtdCode);

                    SS1.ActiveSheet.Cells[3, 1].Text = " 검진기간 : " + list3.MINDATE + " ~ " + list3.MAXDATE;
                    SS1.ActiveSheet.Cells[3, 6].Text = "학교명 : " + VB.Pstr(txtLtdCode.Text, ".", 2).Trim();
                    ...
                    if (strClass != "1")
                    {
                        ...
                        SS1.ActiveSheet.Cells[7, 7].Text = "";
                    }
                    ...
                    {
                        strClass1 = list[i].CLASS.To<string>() + list[i].SEX;
                        ...
                        if (!list[i].PPANC3.IsNullOrEmpty() && list[i].PPANC3 != "1")
                        {
                            nCNT[4] += 1;   //색각이상
                        }
                        ...
                        strOldData = list[i].CLASS.To<string>() + list[i].SEX;
                        strTEMP = list[i].SEX;
                        strTemp1 = list[i].CLASS.To<string>();
                        strSex1 = list[i].SEX;
                    }
                    ...
                    for (int i = 8; i <= 41; i++)
                    {
                        ...
                        nTemp += SS1.ActiveSheet.Cells[i, 6].Text.To<long>();
                        nTemp += SS1.ActiveSheet.Cells[i, 7].Text.To<long>();
            ...
            else if (sender == btnMenuExcel)
            {
                ...
                strDate = hb.READ_Ltd_Name(VB.Pstr(txtLtdCode.Text, ".", 1)) + "(" + string.Format("{0:0000}", VB.Pstr(txtLtdCode.Text, ".", 1)) + "_" + VB.Left(dtpFrDate.Text, 4) + VB.Mid(dtpFrDate.Text, 6, 2) + VB.Mid(dtpFrDate.Text, 9, 2) + "~" + VB.Left(dtpToDate.Text, 4) + VB.Mid(dtpToDate.Text, 6, 2) + VB.Mid(dtpToDate.Text, 9, 2) + "[성별통계표]";
        ...
        void fn_Sheet_Clear()
        {
            ...
            SS1.ActiveSheet.Cells[7, 4].Text = "1학년";
            SS1.ActiveSheet.Cells[7, 5].Text = "4학년";
            SS1.ActiveSheet.Cells[7, 6].Text = "1학년";
            SS1.ActiveSheet.Cells[7, 7].Text = "4학년";

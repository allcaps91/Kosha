    ...
    public partial class frmHcSchoolResultMunjinPrint : Form
    {
        ...
        void eBtnClick(object sender, EventArgs e)
        {
            ...
            else if (sender == btnSearch)
            {
                ...
                for (int i = 0; i < nRead; i++)
                {
                    ...
                    SS1.ActiveSheet.Cells[i, 6].Text = list[i].SEX + "/" + list[i].AGE.To<string>();
                    SS1.ActiveSheet.Cells[i, 7].Text = list[i].JEPDATE;
                    SS1.ActiveSheet.Cells[i, 8].Text = list[i].WRTNO.To<string>();
                    ...
                    SS1.ActiveSheet.Cells[i, 11].Text = hb.READ_Ltd_Name(list[i].LTDCODE.To<string>()) + "^^" + list[i].CLASS.To<string>() + "학년 " + list[i].BAN.To<string>() + "반 " + list[i].BUN.To<string>() + "번";
                }
            }
        ...
        void fn_Result_Print_PPan(long argWrtNo, string argGbn)
        {
            ...
            if (!list.IsNullOrEmpty())
            {
                ...
                SS2.ActiveSheet.Cells[3, 6].Text = VB.Space(3) + list.CLASS.To<string>() + "학년 " + list.BAN.To<string>() + "반 " + list.BUN.To<string>() + "번";
                ...
                if (!list.GBPAN.IsNullOrEmpty())
                {
                    ...
                    SS2.ActiveSheet.Cells[30, 3].Text = list.PPANDRNO.To<string>();
                    SS2.ActiveSheet.Cells[30, 9].Text = list.JEPDATE.To<string>();

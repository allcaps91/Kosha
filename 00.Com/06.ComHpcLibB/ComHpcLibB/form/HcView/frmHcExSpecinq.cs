...
/// File Name       : frmHcExSpecinq.cs
/// Description     : 건강증진센터 검체번호 현황 조회
/// Author          : 김민철
...
{
    public partial class frmHcExSpecinq : Form
    {
        ...
        public frmHcExSpecinq(string strPANO, string strFDATE, string strTDATE)
        {
            InitializeComponent();
            setEvent();
            setCombo();
        ...
        void Display_SPREAD(PsmhDb pDbCon, FpSpread Spd)
        {
            ...
            {
                isHea = rdoIO2.Checked;
                isHic = rdoIO3.Checked;
            }
            ...
            //스레드 시작
            thread = new Thread(() => tProcess(strFDATE, strTDATE, strPANO, strSNAME, isEXCP, strWS, strWARD, isPB, isHea, isHic));
            thread.Start();

            Cursor.Current = Cursors.Default;
        }

        DataSet sel_EXAM_SPECMST_RCP03(PsmhDb pDbCon, string strFDATE, string strTDATE, string strPANO, string strSNAME, bool isEXCP, string strWS, string strWARD, bool isPB, bool isHea, bool isHic)
        {
            DataSet ds = null;
            string SQL = "";
            ...
            SQL += "  		       WHEN A.IPDOPD !='I' AND A.BI ='62' THEN '건진'                                                   \r\n";
        ...
        void tProcess(string strFDATE, string strTDATE, string strPANO, string strSNAME, bool isEXCP, string strWS, string strWARD, bool isPB, bool isHea, bool isHic)
        {
            ...
            try
            {
                ...
                DataSet ds = null;
                ds = sel_EXAM_SPECMST_RCP03(clsDB.DbCon, strFDATE, strTDATE, strPANO, strSNAME, isEXCP, strWS, strWARD, isPB, isHea, isHic);

namespace ComHpcLibB.Repository
{
    ...
    public class HeaCodeRepository : BaseRepository
    {
        ...
        public List<HEA_CODE> GetGroupNameByGubun(string argGbn)
        {
            ...
            parameter.AppendSql("  FROM ADMIN.HEA_CODE        ");
        ...
        public List<HEA_CODE> FindOne(string argGubun)
        {
            ...
            if (!string.IsNullOrEmpty(argGubun))
            {
                parameter.Add("GUBUN", argGubun.Trim(), Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            }
        ...
        public int UpdateSortbyRowId(string cODE, string rID)
        {
            ...
            parameter.AppendSql("UPDATE ADMIN.HEA_CODE SET    ");
        ...
        public List<HEA_CODE> GetListByCodeName(string strGubun, string strName)
        {
            ...
            else if (strGubun == "SA")
            {
                ...
                //parameter.AppendSql("     , ADMIN.FC_BAS_BUSENAME(BUSE) AS GUBUN1 ");
                ...
                parameter.AppendSql("     , ADMIN.FC_BAS_BUSENAME(DEPT_CD) AS GUBUN1  ");
                parameter.AppendSql("  FROM ADMIN.HR_EMP_BASIS                         ");
                parameter.AppendSql(" WHERE 1 = 1                                           ");
                if (!strName.IsNullOrEmpty())
                {
        ...
        public HEA_CODE GetItemByActPart(string argActPart)
        {
            ...
            parameter.Add("ACTPART", argActPart, Oracle.ManagedDataAccess.Client.OracleDbType.Char);

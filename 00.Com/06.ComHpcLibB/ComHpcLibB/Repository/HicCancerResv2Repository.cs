namespace ComHpcLibB.Repository
{
    ...
    public class HicCancerResv2Repository : BaseRepository
    {
        ...
        public int Insert(HIC_CANCER_RESV2 item)
        {
            ...
            parameter.Add("RTIME", item.RTIME);
            parameter.Add("JUMIN", item.JUMIN, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("JUMIN2", item.JUMIN2);
            parameter.Add("SNAME", item.SNAME);
            parameter.Add("TEL", item.TEL);
            parameter.Add("HPHONE", item.HPHONE);
            parameter.Add("GBAM1", item.GBAM1, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBAM2", item.GBAM2, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBAM3", item.GBAM3, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBAM4", item.GBAM4, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBUGI", item.GBUGI, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBGFS", item.GBGFS, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBGFSH", item.GBGFSH, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBMAMMO", item.GBMAMMO, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBRECUTM", item.GBRECUTM, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBSONO", item.GBSONO, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBWOMB", item.GBWOMB, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBBOHUM", item.GBBOHUM, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBCOLON", item.GBCOLON, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBCT", item.GBCT, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("GBLUNG_SANGDAM", item.GBLUNG_SANGDAM);
            parameter.Add("PANO", item.PANO, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("REMARK", item.REMARK);
            parameter.Add("SMSOK", item.SMSOK, Oracle.DataAccess.Client.OracleDbType.Char);
            parameter.Add("SDOCT", item.SDOCT);
            parameter.Add("ENTSABUN", item.ENTSABUN);            

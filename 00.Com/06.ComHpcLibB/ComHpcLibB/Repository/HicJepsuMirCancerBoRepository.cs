namespace ComHpcLibB.Repository
{
    ...
    /// 
    /// </summary>
    public class HicJepsuMirCancerBoRepository : BaseRepository
    {
        
        /// <summary>
        /// 
        /// </summary>
        public HicJepsuMirCancerBoRepository()
        {
        }
        ...
        public List<HIC_JEPSU_MIR_CANCER_BO> GetListByItems(string ArgYear, string ArgFDATE, string ArgTDATE, string ArgJohap, string ArgJong, string ArgLtdcode)
        {
            ...
            parameter.AppendSql(" FROM HIC_JEPSU a, HIC_MIR_CANCER_BO b                                                                                        ");
            ...
            return ExecuteReader<HIC_JEPSU_MIR_CANCER_BO>(parameter);
        }
    }
}

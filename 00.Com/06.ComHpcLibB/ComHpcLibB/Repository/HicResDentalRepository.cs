namespace ComHpcLibB.Repository
{
    ...
    public class HicResDentalRepository : BaseRepository
    {
        ...
        public int UpdateAll(HIC_RES_DENTAL item)
        {
            ...
            parameter.Add("WRTNO", item.WRTNO);
            parameter.Add("OPDDNT", item.OPDDNT, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("DNTSTATUS", item.DNTSTATUS, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_HABIT1", item.T_HABIT1, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_HABIT2", item.T_HABIT2, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_HABIT4", item.T_HABIT4, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_HABIT5", item.T_HABIT5, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_HABIT6", item.T_HABIT6, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_HABIT7", item.T_HABIT7, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_HABIT8", item.T_HABIT8, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_HABIT9", item.T_HABIT9, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_STAT1", item.T_STAT1, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_STAT2", item.T_STAT2, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_FUNCTION1", item.T_FUNCTION1, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_JILBYUNG1", item.T_JILBYUNG1, Oracle.ManagedDataAccess.Client.OracleDbType.Char);
            parameter.Add("T_JILBYUNG2", item.T_JILBYUNG2, Oracle.ManagedDataAccess.Client.OracleDbType.Char);

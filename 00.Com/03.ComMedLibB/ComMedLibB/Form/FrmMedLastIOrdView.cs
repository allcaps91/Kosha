...
namespace ComMedLibB
{
    ...
    /// File Name       : FrmMedLastIOrdView.cs
    /// Description     : 입원환자 진료내역 조회
    /// Author          : 이정현
    ...
    /// </vbp>
    /// </summary>
    public partial class FrmMedLastIOrdView : Form
    {
        ...
        public FrmMedLastIOrdView()
        {
            InitializeComponent();
        }

        public FrmMedLastIOrdView(string strGBIO, int intStartRow, string strPtNo = "")
        {
            InitializeComponent();
        ...
        public FrmMedLastIOrdView(string strGBIO, int intStartRow, string strFrDate, string strToDate, string strPtNo = "")
        {
            InitializeComponent();
        ...
        private void FrmMedLastIOrdView_Load(object sender, EventArgs e)
        {
            //폼 권한 조회
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ssList_Sheet1.Cells[ssList.ActiveSheet.ActiveRowIndex, 3].Text.Trim() == "입원")
                {
                    Read_Orders_IPD();
                }
                else
        ...
        private void Read_Orders_IPD()
        {
            ...
            try
            {
                ...
                SQL = SQL + ComNum.VBLF + "     TO_CHAR(A.BDate,'YYYY-MM-DD') AS BDate1  ";
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            ...
            //if (clsOrdFunction.GstrGbJob == "IPD") strGBIO = "IPD";
            //if (clsOrdFunction.GstrGbJob == "ER") strGBIO = "ER";
        ...
        private void chkAll_Click(object sender, EventArgs e)
        {
            if (ssOrder.ActiveSheet.NonEmptyRowCount > 0)
            {
                if (chkAll.Checked == true)
                {
                    ...
                    ssOrder.ActiveSheet.Cells[0, 1, ssOrder.ActiveSheet.NonEmptyRowCount - 1, ssOrder.ActiveSheet.ColumnCount - 1].BackColor = Color.FromArgb(255, 255, 128);
                }
                else
                {
        ...
        {
            if (ssIlls.ActiveSheet.NonEmptyRowCount > 0)
            {
                if (chkDiagAll.Checked == true)
                {
                    ssIlls.ActiveSheet.Cells[0, 0, ssIlls.ActiveSheet.NonEmptyRowCount - 1, 0].Text = "True";
                    ssIlls.ActiveSheet.Cells[0, 1, ssIlls.ActiveSheet.NonEmptyRowCount - 1, ssIlls.ActiveSheet.ColumnCount - 1].BackColor = Color.FromArgb(255, 255, 128);
                }
                else
                {
                    ssIlls.ActiveSheet.Cells[0, 0, ssIlls.ActiveSheet.NonEmptyRowCount - 1, 0].Text = "False";
                    ssIlls.ActiveSheet.Cells[0, 1, ssIlls.ActiveSheet.NonEmptyRowCount - 1, ssIlls.ActiveSheet.ColumnCount - 1].BackColor = Color.FromArgb(255, 255, 234);
                }
            }
            else
            {

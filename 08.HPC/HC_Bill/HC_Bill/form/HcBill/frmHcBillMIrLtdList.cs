...
/// <summary>
/// Class Name      : HC_Bill
/// File Name       : frmHcBillMIrLtdList.cs
/// Description     : 회사청구 명단 및 금액 조회
/// Author          : 이상훈
...
namespace HC_Bill
{
    public partial class frmHcBillMIrLtdList : Form
    {
        ...
        void eBtnClick(object sender, EventArgs e)
        {
            ...
            else if (sender == btnSearch)
            {
                ...
                List<HIC_JEPSU_PATIENT> list = hicJepsuPatientService.GetItembyJepDateSDateLtdCode(strJong, strFrDate, strToDate, nLtdCode, strToDate1, "1");
                ...
                for (int i = 0; i < nREAD; i++)
                {
                    ...
                    if (list[i].GUBUN == "1")
                    {
                        ...
                        if (strNewData != strOldData)
                        {
                            ...
                            if (list[i].GJJONG == "11")
                            {
                                HIC_JEPSU_SUNAP list2 = hicJepsuSunapService.GetSumJohapAmtMirNo1byWrtNo2(list[i].WRTNO2, list[i].GJJONG,  "1");
                            ...
                            {
                                //암검진
                                HIC_JEPSU_SUNAP list3 = hicJepsuSunapService.GetSumJohapAmtMirNo3byWrtNo2(list[i].WRTNO2, list[i].GJJONG, "3");
                        ...
                        {
                            HIC_JEPSU_SUNAP list4 = hicJepsuSunapService.GetSumJohapAmtMirNo3byWrtNo2(list[i].WRTNO2, "31", "3");
                    ...
                    else if (list[i].GUBUN == "2")
                    {
                        ...
                        if (strNewData != strOldData)
                        {
                            ...
                            else if (list[i].GJJONG == "13")
                            {
                                //건진 사업장
                                HIC_JEPSU_SUNAP listBoninAmt2 = hicJepsuSunapService.GetBoninAmtMirNo1byWrtNo2(list[i].WRTNO2, list[i].GJJONG, "1");
                                if (!listBoninAmt2.IsNullOrEmpty())
                                {
                                    nAmt1 = listBoninAmt2.BONINAMT;
                                    SS1.ActiveSheet.Cells[nRow - 1, 7].Text = string.Format("{0:###,###,###,##0}", nAmt1);
                                }

                                HIC_JEPSU_SUNAP list6 = hicJepsuSunapService.GetJohapAmtMirNo1byWrtNo2(list[i].WRTNO2, list[i].GJJONG, "1");
                                ...
                                if (!list6.IsNullOrEmpty())
                                {
                                    ...
                                    nAmt2 = list6.JOHAPAMT;
                                    SS1.ActiveSheet.Cells[nRow - 1, 8].Text = string.Format("{0:###,###,###,##0}", nAmt2);
                                }

                                //회사부담금
                                HIC_JEPSU_SUNAP list7 = hicJepsuSunapService.GetLtdAmtMirNo1byWrtNo2(list[i].WRTNO2, list[i].GJJONG, "1");
                                if (!list7.IsNullOrEmpty())
                                {
                                    nTotAmt1 = list7.LTDAMT;
                                    SS1.ActiveSheet.Cells[nRow - 1, 10].Text = string.Format("{0:###,###,###,##0}", nTotAmt1);
                                }
                            }
                            else if (list[i].GJJONG == "23")
                            {
                                //건진 사업장
                                HIC_JEPSU_SUNAP listBoninAmt3 = hicJepsuSunapService.GetBoninAmtMirNo1byWrtNo2(list[i].WRTNO2, list[i].GJJONG, "1");
                                ...
                                HIC_JEPSU_SUNAP list8 = hicJepsuSunapService.GetJohapAmtMirNo1byWrtNo2(list[i].WRTNO2, list[i].GJJONG, "1");
                                ...
                                if (!list8.IsNullOrEmpty())
                                {
                                    ...
                                    nAmt2 = list8.JOHAPAMT;
                                    SS1.ActiveSheet.Cells[nRow - 1, 8].Text = string.Format("{0:###,###,###,##0}", nAmt2);
                                }

                                //회사부담금
                                HIC_JEPSU_SUNAP list9 = hicJepsuSunapService.GetLtdAmtMirNo1byWrtNo2(list[i].WRTNO2, list[i].GJJONG, "1");
                                if (!list9.IsNullOrEmpty())
                                {
                                    nTotAmt1 = list9.LTDAMT;
                                    SS1.ActiveSheet.Cells[nRow - 1, 10].Text = string.Format("{0:###,###,###,##0}", nTotAmt1);
                                }

                            }
                            else if (list[i].GJJONG == "69")
                            {
                                //건진 사업장
                                HIC_JEPSU_SUNAP listBoninAmt3 = hicJepsuSunapService.GetBoninAmtMirNo1byWrtNo2(list[i].WRTNO2, list[i].GJJONG, "1");
                                if (!listBoninAmt3.IsNullOrEmpty())
                                ...
                                HIC_JEPSU_SUNAP list10 = hicJepsuSunapService.GetJohapAmtMirNo1byWrtNo2(list[i].WRTNO2, list[i].GJJONG, "1");
                                ...
                                if (!list10.IsNullOrEmpty())
                                {
                                    ...
                                    nAmt2 = list10.JOHAPAMT;
                                    SS1.ActiveSheet.Cells[nRow - 1, 8].Text = string.Format("{0:###,###,###,##0}", nAmt2);
                                }

                                //회사부담금
                                HIC_JEPSU_SUNAP list11 = hicJepsuSunapService.GetLtdAmtMirNo1byWrtNo2(list[i].WRTNO2, list[i].GJJONG, "1");
                        ...
                        else
                        {
                            ...
                            else if (list[i].GJJONG == "69")
                            {
                                ...
                                //회사추가
                                HIC_JEPSU_SUNAP list12 = hicJepsuSunapService.GetJohapAmtMirNo1byWrtNo2(list[i].WRTNO2, list[i].GJJONG, "1");
                                ...
                                //건진종류
                                SS1.ActiveSheet.Cells[nRow - 1, 5].Text = "1차+회사추가";
                            }
                            //토탈금액

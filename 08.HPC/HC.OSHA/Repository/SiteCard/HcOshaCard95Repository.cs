namespace HC.OSHA.Repository
{
    ...
    public class HcOshaCard95Repository : BaseRepository
    {
        ...
        public List<HC_OSHA_CARD9_5> FindAll(long siteId, string year)
        {
            ...
            parameter.AppendSql("       D.CODENAME AS ISAPPROVE_TEXT ");
            parameter.AppendSql("  FROM HIC_OSHA_CARD9_5 A ");
            parameter.AppendSql("       INNER JOIN HIC_USERS B ");
            parameter.AppendSql("             ON A.CREATEDUSER = B.USERID ");
            parameter.AppendSql("             AND B.SWLICENSE = :SWLICENSE ");
            parameter.AppendSql("       INNER JOIN HIC_USERS C ");
        ...
        public HC_OSHA_CARD9_5 Insert(HC_OSHA_CARD9_5 dto)
        {
            ...
            parameter.AppendSql("  ID,SITE_ID,ESTIMATE_ID,REQUESTDATE,APPROVEDATE,ISAPPROVE,STARTDATE,");
            parameter.AppendSql("  ENDDATE,REMARK,MODIFIED,MODIFIEDUSER,CREATED,CREATEDUSER,SWLICENSE ) ");
            parameter.AppendSql("VALUES ( ");
            parameter.AppendSql("  :ID,:SITE_ID,:ESTIMATE_ID,:REQUESTDATE,:APPROVEDATE,:ISAPPROVE,:STARTDATE,");
            parameter.AppendSql("  :ENDDATE,:REMARK,SYSTIMESTAMP,:MODIFIEDUSER,SYSTIMESTAMP,:CREATEDUSER,:SWLICENSE) ");

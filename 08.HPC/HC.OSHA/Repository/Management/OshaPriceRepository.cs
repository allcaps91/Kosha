...
namespace HC.OSHA.Repository
{
    public class OshaPriceRepository : BaseRepository
    {
        ...
        {
            MParameter parameter = CreateParameter();
            parameter.AppendSql("SELECT A.ID as SITE_ID, C.ID AS ESTIMATE_ID, B.NAME AS SITE_NAME, D.ID,");
            parameter.AppendSql("       D.WORKERTOTALCOUNT, UNITPRICE, UNITTOTALPRICE, TOTALPRICE, ISBILL, ISFIX ");
            ...
            parameter.AppendSql("             SELECT A.* FROM HIC_OSHA_PRICE A ");

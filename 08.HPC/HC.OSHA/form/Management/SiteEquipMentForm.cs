...
namespace HC_OSHA
{
    public partial class SiteEquipMentForm : CommonForm, ISelectSite, ISelectEstimate
    {
        ...
        private void SiteEquipMentForm_Load(object sender, EventArgs e)
        {
            ...
            SSList.AddColumnComboBox("장비명", nameof(HC_OSHA_EQUIPMENT.NAME), 190, IsReadOnly.N, EQUIP_NAME, new SpreadCellTypeOption { });
         ...
         //   SSList.AddColumnText("시리얼번호", nameof(HC_OSHA_EQUIPMENT.SERIALNUMBER), 190, IsReadOnly.N, new SpreadCellTypeOption { IsSort = false });

...
namespace HC_Pan
{
    public partial class frmPanjeng_Hic : Form
    {
        ...
        frmPanjeng_LifeStyle FrmPanjeng_LifeStyle = null;
        ...
        public frmPanjeng_Hic(long nWrtNo, string strSName, string strJob, string strLtdCode, string strGbHea)
        {
            InitializeComponent();
        ...
        void SetEvent()
        {
            ...
            this.txtSogen.TextChanged += new EventHandler(eTxtChanged);
            this.txtSogenB.TextChanged += new EventHandler(eTxtChanged);
            this.txtSogenC.TextChanged += new EventHandler(eTxtChanged);
            this.txtSogenD.TextChanged += new EventHandler(eTxtChanged);
            this.chkPanjengB8.CheckedChanged += new EventHandler(eChkChanged);
            this.cboPanBEtc.SelectedIndexChanged += new EventHandler(eCboSelIdxChanged);
        }

        private void eFormClosing(object sender, FormClosingEventArgs e)
        {
            if (tabLifeStyle.Visible)
            {
                FrmPanjeng_LifeStyle.rSaveEventClosed -= new frmPanjeng_LifeStyle.SaveEventClosed(rSaveEventClosed);
            }
        }

        private void eCboSelIdxChanged(object sender, EventArgs e)
        {
            if (sender == cboPanBEtc)
            {
                if (VB.Pstr(cboPanBEtc.Text, ".", 1) == "4")
                {
                    txtPanjengB_etc.Enabled = true;
                }
                else
                {
                    txtPanjengB_etc.Text = "";
                    txtPanjengB_etc.Enabled = false;
                }
            }
        }
        ...
        private void eTxtChanged(object sender, EventArgs e)
        {
            if (sender == txtSogen)
            {
                lblSogen08.Text = "의심질환소견" + ComNum.VBLF;
                lblSogen08.Text += "(" + Encoding.Default.GetBytes(txtSogen.Text).Length / 2 + "/250)";
            }
            else if (sender == txtSogenB)
            {
                lblSogen09.Text = "유질환소견" + ComNum.VBLF;
                lblSogen09.Text += "(" + Encoding.Default.GetBytes(txtSogenB.Text).Length / 2 + "/250)";
            }
            else if (sender == txtSogenC)
            {
                lblSogen10.Text = "생활습관소견" + ComNum.VBLF;
                lblSogen10.Text += "(" + Encoding.Default.GetBytes(txtSogenC.Text).Length / 2 + "/250)";
            }
            else if (sender == txtSogenD)
            {
                lblSogen11.Text = "기타소견" + ComNum.VBLF;
                lblSogen11.Text += "(" + Encoding.Default.GetBytes(txtSogenD.Text).Length / 2 + "/250)";
            }
        }
        ...
        void eFormLoad(object sender, EventArgs e)
        {
            ...
            tabLifeStyle.Visible = false;

            //생활습관도구 처방전
            List<HIC_SUNAPDTL> listSunapDtl = hicSunapdtlService.GetCodebyWrtNo(FnWrtNo);

            if (listSunapDtl.Count > 0)
            {
                for (int j = 0; j < listSunapDtl.Count; j++)
                {
                    switch (listSunapDtl[j].CODE.Trim())
                    {
                        case "1164":
                            tabLifeStyle.Visible = true;//생활습관처방
                            clsHcVariable.GstrPanLifeTab2 = "Y";
                            clsHcVariable.GstrPanLifeTab3 = "Y";
                            clsHcVariable.GstrPanLifeTab4 = "Y";
                            break;
                        case "1165":
                            tabLifeStyle.Visible = true;//생활습관처방
                            clsHcVariable.GstrPanLifeTab0 = "Y";
                            break;
                        case "1166":
                            tabLifeStyle.Visible = true;//생활습관처방
                            clsHcVariable.GstrPanLifeTab1 = "Y";
                            break;
                        default:
                            break;
                    }
                ...
                if (tabLifeStyle.Visible)
                {
                    FrmPanjeng_LifeStyle = new frmPanjeng_LifeStyle(FnWrtNo, this);

                    if (FormIsExist(FrmPanjeng_LifeStyle.GetType()))
                    {
                        FrmPanjeng_LifeStyle.Dispose();
                        return;
                    }
                    else
                    {
                        FrmPanjeng_LifeStyle.Owner = this;
                        FrmPanjeng_LifeStyle.TopLevel = false;
                        this.Controls.Add(FrmPanjeng_LifeStyle);
                        FrmPanjeng_LifeStyle.Parent = superTabControlPanel2;
                        FrmPanjeng_LifeStyle.Text = "";
                        FrmPanjeng_LifeStyle.ControlBox = false;
                        FrmPanjeng_LifeStyle.FormBorderStyle = FormBorderStyle.None;
                        FrmPanjeng_LifeStyle.Top = 0;
                        FrmPanjeng_LifeStyle.Left = 0;
                        FrmPanjeng_LifeStyle.WindowState = FormWindowState.Normal;
                        FrmPanjeng_LifeStyle.Height = superTabControlPanel2.Height;
                        FrmPanjeng_LifeStyle.Width = superTabControlPanel2.Width;

                        FrmPanjeng_LifeStyle.rSaveEventClosed += new frmPanjeng_LifeStyle.SaveEventClosed(rSaveEventClosed);

                        FrmPanjeng_LifeStyle.Show();
                        FrmPanjeng_LifeStyle.BringToFront();
            ...
            {
                //2020-12-07(신충곤과장님 요청사항으로 자동판정 주석처리)
        ...
        void fn_Auto_Panjeng_Display()
        {
            ...
            if (clsHcType.TFA.Panjeng == "1")   //정상A
            {
                ...
                //B형간염 대상자 문구 연동위해 return 구문 제거 2021-06-02 전현준 과장 요청
                //return;
            }
        ...
        void fn_Screen_Display()
        {
            ...
            if (list2.Count > 0)
            {
                if (!list2[0].PANJENGB_ETC.IsNullOrEmpty())
                {
                    cboPanBEtc.SelectedIndex = 4;
            ...
            if (fn_First_Panjeng_Check() == false)
            {
                ...
                hm.Auto_Panjen_BEtc(FnWrtNo,FnPano);
        ...
        void fn_Auto_LifeHabit_Update()
        {
            ...
            if (!list.TMUN0011.IsNullOrEmpty())
            {
                ...
                nTime1 = nTime1 * list.T_ACTIVE1.To<int>();
            }
            if (!list.TMUN0012.IsNullOrEmpty())
            {
                nTime2 = VB.Pstr(list.TMUN0012, ":", 1).To<int>() * 60;
                nTime2 += VB.Pstr(list.TMUN0012, ":", 2).To<int>();
                nTime2 = nTime2 * list.T_ACTIVE2.To<int>();
            }
        ...
        double fn_Drink_Set(string strTemp)
        {
            double rtnVal = 0;
            double nDrink1 = 0;
            ...
            if (!strTemp.IsNullOrEmpty())
            {
                ...
                if (VB.Pstr(strTemp, ";", 1) == "1")
                {
                    ...
                    {
                        case "잔":
                            nDrink1 = VB.Pstr(strTemp, ";", 2).To<double>() * (4.0 / 7.0);
                            break;
                        case "병":
                            nDrink1 = VB.Pstr(strTemp, ";", 2).To<double>() * 4.0;
                            break;
                        case "CC":
                            nDrink1 = VB.Pstr(strTemp, ";", 2).To<double>() / 90.0;
                            break;
                        default:
                            break;
                    }
                ...
                else if (VB.Pstr(strTemp, ";", 1) == "2")
                {
                    ...
                    {
                        case "잔":
                            nDrink1 += VB.Pstr(strTemp, ";", 2).To<double>() * (200.0 / 350.0);
                            break;
                        case "병":
                            nDrink1 += VB.Pstr(strTemp, ";", 2).To<double>() * (500.0 / 350.0);
                            break;
                        case "CC":
                            nDrink1 += VB.Pstr(strTemp, ";", 2).To<double>() / 350;
                            break;
                        case "캔":
                            nDrink1 += VB.Pstr(strTemp, ";", 2).To<double>();
                            break;
                        default:
                            break;
                    }
                ...
                else if (VB.Pstr(strTemp, ";", 1) == "3")
                {
                    switch (VB.Pstr(strTemp, ";", 3))
                    {
                        case "잔":
                            ...
                            break;
                        case "병":
                            nDrink1 += VB.Pstr(strTemp, ";", 2).To<double>() * (500.0 / 45.0);
                            break;
                        case "CC":
                ...
                else if (VB.Pstr(strTemp, ";", 1) == "4")
                {
                    switch (VB.Pstr(strTemp, ";", 3))
                    {
                        case "잔":
                            ...
                            break;
                        case "병":
                            nDrink1 += VB.Pstr(strTemp, ";", 2).To<double>() * (750.0 / 300.0);
                            break;
                        case "CC":
                            nDrink1 += VB.Pstr(strTemp, ";", 2).To<double>() / 300.0;
                            break;
                        default:
                            break;
                    }
                ...
                else if (VB.Pstr(strTemp, ";", 1) == "5")
                {
                    switch (VB.Pstr(strTemp, ";", 3))
                    {
                        case "잔":
                            ...
                            break;
                        case "병":
                            nDrink1 += VB.Pstr(strTemp, ";", 2).To<double>() * (750.0 / 150.0);
                            break;
                        case "CC":
                            nDrink1 += VB.Pstr(strTemp, ";", 2).To<double>() / 150.0;
                            break;
                        default:
                            break;
                    }
        ...
        private void Data_Save_Panjeng()
        {
            //고혈압 2차대상자 오류 점검
            if (chkPanjengR2.Checked == true && clsHcType.TFA.PanR[2] == false)
            {
            ...
            else if (chkPanjengR2.Checked == false && clsHcType.TFA.PanR[2] == true)
            {
            ...
            //당뇨병 2차대상자 오류 점검
            if (chkPanjengR5.Checked == true && clsHcType.TFA.PanR[5] == false)
            {
            ...
            else if (chkPanjengR5.Checked == false && clsHcType.TFA.PanR[5] == true)
            {
            ...
            if (tabLifeStyle.Visible)
            {
                if (!FrmPanjeng_LifeStyle.Data_Save_LifePanjeng())
                {
                    clsDB.setRollbackTran(clsDB.DbCon);
                    return;
                }
            ...
            if (FstrOK == "Y") { fn_Panjeng_End_Check(); }
            if (FstrOK != "N") { rSaveEventClosed("HIC"); }
        }
        ...
        bool fn_DB_Update_Panjeng(string argGbn)
        {
            bool rtnVal = false;
            int nBCnt = 0;
            int nRCNT = 0;
            ...
            if (chkPanjengR2.Checked == true || chkPanjengR5.Checked == true)
            {
                strPanjeng = "5";
            }
            ...
            if (argGbn == "판정")
            {
                ...
                if (chkPanjengR9.Checked == true && txtPanjengR_Etc.IsNullOrEmpty())
                {
                    MessageBox.Show("질환의심(R1) 기타질환내용이 공란입니다.", "확인", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    FstrOK = "N";
                    return rtnVal;
                }
                ...
                //정상B
                if (chkPanjengB0.Checked == true) { item.PANJENGB1 = "1"; }
                else { item.PANJENGB1 = "0"; }

                if (chkPanjengB1.Checked == true) { item.PANJENGB2 = "1"; }
                else { item.PANJENGB2 = "0"; }

                if (chkPanjengB2.Checked == true) { item.PANJENGB3 = "1"; }
                else { item.PANJENGB3 = "0"; }

                if (chkPanjengB3.Checked == true) { item.PANJENGB4 = "1"; }
                else { item.PANJENGB4 = "0"; }
                ...
                //질환의심R1, R2
                if (chkPanjengR0.Checked == true) { item.PANJENGR1 = "1"; }
                else { item.PANJENGR1 = "0"; }

                if (chkPanjengR1.Checked == true) { item.PANJENGR2 = "1"; }
                else { item.PANJENGR2 = "0"; }

                if (chkPanjengR3.Checked == true) { item.PANJENGR4 = "1"; }
                else { item.PANJENGR4 = "0"; }

                if (chkPanjengR4.Checked == true) { item.PANJENGR5 = "1"; }
                else { item.PANJENGR5 = "0"; }

                if (chkPanjengR6.Checked == true) { item.PANJENGR7 = "1"; }
                else { item.PANJENGR7 = "0"; }

                if (chkPanjengR7.Checked == true) { item.PANJENGR8 = "1"; }
                else { item.PANJENGR8 = "0"; }

                if (chkPanjengR8.Checked == true) { item.PANJENGR9 = "1"; }
                else { item.PANJENGR9 = "0"; }

                if (chkPanjengR11.Checked == true) { item.PANJENGR12 = "1"; }
                else { item.PANJENGR12 = "0"; }

                if (chkPanjengR10.Checked == true) { item.PANJENGR11 = "1"; }
                else { item.PANJENGR11 = "0"; }

                if (chkPanjengR9.Checked == true) { item.PANJENGR10 = "1"; }
                else { item.PANJENGR10 = "0"; }

                //확진검사 대상
                if (chkPanjengR2.Checked == true) { item.PANJENGR3 = "1"; }
                else { item.PANJENGR3 = "0"; }

                if (chkPanjengR5.Checked == true) { item.PANJENGR6 = "1"; }
                else { item.PANJENGR6 = "0"; }
        ...
        void ReExam_value(string argValue, string argName)
        {

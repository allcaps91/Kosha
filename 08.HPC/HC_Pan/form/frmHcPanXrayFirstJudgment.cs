...
/// <summary>
/// Class Name      : HC_Pan
/// File Name       : frmHcPanXrayFirstJudgment.cs
/// Description     : 방사선 작업종사자 1차판정
/// Author          : 이상훈
...
{
    public partial class frmHcPanXrayFirstJudgment : Form
    {
        ...
        public frmHcPanXrayFirstJudgment()
        {
            InitializeComponent();
            SetEvent();
            SetControl();
        ...
        void eBtnClick(object sender, EventArgs e)
        {
            ...
            else if (sender == btnJobYN)
            {
                ...
                {
                    txtJobYN.Text = FstrCode;
                    lblJobYN.Text = FstrName;
                }
                else
                {
                    txtJobYN.Text = "";
            ...
            {
                clsPublic.GstrRetValue = "71";
                frmHcPanXHelp f = new frmHcPanXHelp("71");
                f.ShowDialog(this);
            }
            ...
            {
                clsPublic.GstrRetValue = "53";
                frmHcPanPanjengHelp f = new frmHcPanPanjengHelp("53");
                f.ShowDialog(this);
                if (!clsPublic.GstrRetValue.IsNullOrEmpty())
                {
                    txtReExam.Text = clsPublic.GstrRetValue;
                    txtReExam.Text = VB.Left(txtReExam.Text, txtReExam.Text.Length - 1);
                    lblReExamName.Text = "☞추가검사: " + clsPublic.GstrRetName;
                }
            }
            ...
            else if (sender == btnSearch)
            {
                ...
                btnAutoPan.Enabled = false;

                if (clsHcVariable.GnHicLicense > 0)
                {
                    if (rdoJob1.Checked == true && SSList.ActiveSheet.RowCount > 0)
                    {
                        btnAutoPan.Enabled = true;
                    }
                }
            ...
            else if (sender == btnAutoPan)  //정상자동판정
            {
                int Inx = 0;
                long nWRTNO = 0;
                int nREAD = 0;
                ...
                {
                    strJong = SSList.ActiveSheet.Cells[i, 1].Text.Trim();
                    nWRTNO = long.Parse(SSList.ActiveSheet.Cells[i, 5].Text.Trim());
        ...
        void fn_Screen_Display()
        {
            ...
            txtReExam.Text = list4.REEXAM.Trim();
        ...
        void fn_DB_Update_Panjeng(string argGbn)
        {
            ...
            item.REEXAM = txtReExam.Text.Trim();
            item.PANJENGDRNO = clsHcVariable.GnHicLicense;
            item.WRTNO = FnWRTNO;
            ...
            result = hicJepsuService.UpdatePanjengDatePanjenghDrNobyWrtNo(txtPanDate.Text, clsHcVariable.GnHicLicense, FnWRTNO);

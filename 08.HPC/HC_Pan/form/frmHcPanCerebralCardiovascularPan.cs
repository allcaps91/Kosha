...
/// <summary>
/// Class Name      : HC_Pan
/// File Name       : frmHcPanCerebralCardiovascularPan.cs
/// Description     : 뇌심혈관계판정
/// Author          : 이상훈
...
/// <history>  
/// </history>
/// <seealso cref= "FrmPanjeng10.frm(HcPan110)" />

namespace HC_Pan
{
    public partial class frmHcPanCerebralCardiovascularPan : Form
    {
        ...
        public frmHcPanCerebralCardiovascularPan()
        {
            InitializeComponent();
            SetEvent();
            SetControl();
        ...
        void SetEvent()
        {
            ...
            this.btnDefault.Click += new EventHandler(eBtnClick);
            this.btnJobYN.Click += new EventHandler(eBtnClick);
            ...
            this.txtSogenRemark.KeyPress += new KeyPressEventHandler(eTxtKeyPress);
        ...
        void eFormLoad(object sender, EventArgs e)
        {
            ...
            this.Text = "뇌심혈관계검사 및 판정(" + clsHcVariable.GstrHicDrName + ") (면허:" + clsHcVariable.GnHicLicense + ")";
        ...
        void eBtnClick(object sender, EventArgs e)
        {
            ...
            {
                clsPublic.GstrRetValue = "70";
                frmHcPanSpcSahuCode f = new frmHcPanSpcSahuCode("");
                f.ShowDialog(this);

                if (!clsPublic.GstrRetValue.IsNullOrEmpty())
                {
                    txtSahu.Text = clsPublic.GstrRetValue.Trim();
        ...
        void eSpdDClick(object sender, CellClickEventArgs e)
        {
            if (sender == SSHistory)
            {
                ...
                if (SSHistory.ActiveSheet.Cells[e.Row, 4].Text == "1")
                {
                    return;
                }
                ...
                {
                    nWrtNo = SSHistory.ActiveSheet.Cells[e.Row, 2].Text.To<long>();
                    clsPublic.GstrRetValue = SSHistory.ActiveSheet.Cells[e.Row, 2].Text.Trim();

                    FrmHcPanView = new frmHcPanView(nWrtNo);
        ...
        void fn_Screen_Display()
        {
            ...
            txtSogenRemark.Text = list4.SOGENREMARK.Trim();
            txtJochiRemark.Text = list4.JOCHI.Trim();
        ...
        void fn_OLD_Result_Display_SUB(long nWrtNo, List<string> argExamCode, string argSex, int index)
        {
            ...
            ///TODO : 이상훈(2019.11.26) clsHcMain.cs GET_HIC_JepsuDate Method 확인 필요
        ...
        void fn_HIC_RES_ETC_INSERT()
        {
            ...
            for (int i = 0; i < nREAD; i++)
            {
                ...
                strSExams = list[i].SEXAMS.Trim();
                strOK = "";
                for (int j = 1; j < VB.L(strSExams, ",") - 1; j++)
                {
                    switch (VB.Pstr(strSExams, ",", j))
                    {
                        case "7054":
                        case "7055":
                            strOK = "OK";
                ...
                if (strOK == "OK")
                {
                    result = hicResEtcService.SaveHicResEtc(nWrtNo, strJepDate, "3");
        ...
        void fn_Panjeng_End_Check()
        {
            ...
            clsDB.setBeginTran(clsDB.DbCon);
            //건강보험1차 판정완료 Check
            HIC_RES_ETC list = hicResEtcService.GetItembyWrtNo(FnWRTNO, "3");
            ...
            //판정완료/미완료 SET
            result = hicResEtcService.UpdatebyWrtNo(FnWRTNO, strOK, "3");
        ...
        void fn_DB_Update_Panjeng(string argGbn)
        {
            ...
            item.SOGENREMARK = txtSogenRemark.Text.Trim();
            item.JOCHI = txtJochiRemark.Text.Replace("'", "`");
            item.WORKYN = txtJobYN.Text.Trim();
            item.SAHUCODE = txtSahu.Text.Trim();

            result = hicResEtcService.UpdatebyWrtNoGubun(item);

    ...
    public partial class frmHcSchoolStudentStatic : Form
    {
        ...
        void eBtnClick(object sender, EventArgs e)
        {
            ...
            else if (sender == btnSearch)
            {
                ...
                {
                    strClass1 = list2[i].CLASS.Trim() + list2[i].SEX.Trim();
                    ...
                    strTEMP = list[i].SEX.Trim();
                    strTemp1 = list[i].CLASS.Trim();
                    strSex1 = list[i].SEX.Trim();
                }
                ...
                for (int i = 8; i <= 41; i++)
                {
                    ...
                    nTemp += long.Parse(SS1.ActiveSheet.Cells[i, 6].Text);
                    nTemp += long.Parse(SS1.ActiveSheet.Cells[i, 7].Text);

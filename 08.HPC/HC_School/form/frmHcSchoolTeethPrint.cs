    ...
    public partial class frmHcSchoolTeethPrint : Form
    {
        ...
        void eBtnClick(object sender, EventArgs e)
        {
            ...
            else if (sender == btnSearch)
            {
                ...
                for (int i = 0; i < nRead; i++)
                {
                    ...
                    SS1.ActiveSheet.Cells[i, 6].Text = list[i].SEX.Trim() + "/" + list[i].AGE;
        ...
        void fn_Result_Print_DMun(long nWrtNo)
        {
            ...
            if (!list.IsNullOrEmpty())
            {
                ...
                SS2.ActiveSheet.Cells[5, 5].Text = list.CLASS.Trim() + "학년 " + list.BAN + "학년 " + list.BUN + "번";
                SS2.ActiveSheet.Cells[6, 5].Text = list.SNAME.Trim();
                ...
                strTEMP = "";
                if (VB.Pstr(list.DMUN8.Trim(), "^^", 1) == "1")
                {
                    strTEMP += "●아침식사전 ";
                }
                else if (VB.Pstr(list.DMUN8.Trim(), "^^", 1) == "0")
                {
                    strTEMP += "①아침식사전 ";
                }
                if (VB.Pstr(list.DMUN8.Trim(), "^^", 2) == "1")
                {
                    strTEMP += "●아침식사후 ";
                }
                else if (VB.Pstr(list.DMUN8.Trim(), "^^", 2) == "0")
                {
                    strTEMP += "②아침식사후 ";
                }
                ...
                strTEMP = "";
                if (VB.Pstr(list.DMUN8.Trim(), "^^", 3) == "1")
                {
                    strTEMP += "●점심식사후 ";
                }
                else if (VB.Pstr(list.DMUN8.Trim(), "^^", 3) == "0")
                {
                    strTEMP += "③점심식사후 ";
                }
                if (VB.Pstr(list.DMUN8.Trim(), "^^", 4) == "1")
                {
                    strTEMP += "●저녁식사후 ";
                }
                else if (VB.Pstr(list.DMUN8.Trim(), "^^", 4) == "0")
                {
                    strTEMP += "④저녁식사후 ";
                }
                ...
                strTEMP = "";
                if (VB.Pstr(list.DMUN8.Trim(), "^^", 5) == "1")
                {
                    strTEMP += "●잠자기직전 ";
                }
                else if (VB.Pstr(list.DMUN8.Trim(), "^^", 5) == "0")
                {
                    strTEMP += "⑤잠자기직전 ";
                }
                if (VB.Pstr(list.DMUN8.Trim(), "^^", 6) == "1")
                {
                    strTEMP += "●간식섭취후 ";
                }
                else if (VB.Pstr(list.DMUN8.Trim(), "^^", 6) == "0")
                {
                    strTEMP += "⑥간식섭취후 ";
                }
                SS2.ActiveSheet.Cells[16, 4].Text = strTEMP;

                switch (list.DMUN9.Trim())
                {
                    case "1":
                ...
                SS2.ActiveSheet.Cells[23, 4].Text = list.DMUNREMARK.Trim();
            }
        ...
        void fn_Result_Print_DPan(long nWrtNo)
        {
            ...
            if (!list.IsNullOrEmpty())
            {
                ...
                SS3.ActiveSheet.Cells[4, 3].Text = list.SNAME.Trim();
                if (list.SEX == "M")
                {
                ...
                if (list.DPAN5.Trim() == "1")
                {
                    SS3.ActiveSheet.Cells[15, 2].Text = "●";
                }
                else if (list.DPAN5.Trim() == "2")
                {
                    SS3.ActiveSheet.Cells[15, 4].Text = "●";
                }
                else if (list.DPAN5.Trim() == "3")
                {
                    SS3.ActiveSheet.Cells[15, 6].Text = "●";
                }

                if (list.DPAN6.Trim() == "1")
                {
                    SS3.ActiveSheet.Cells[15, 2].Text = "●";
                }
                else if (list.DPAN6.Trim() == "2")
                {
                    SS3.ActiveSheet.Cells[15, 4].Text = "●";
                }
                else if (list.DPAN6.Trim() == "3")
                {
                    SS3.ActiveSheet.Cells[15, 6].Text = "●";
                }
                SS3.ActiveSheet.Cells[15, 6].Text = "③그밖의치아상태";

                if (VB.Pstr(list.DPAN7.Trim(), "^^", 1) == "1")
                {
                    SS3.ActiveSheet.Cells[17, 6].Text = "●";
                }
                else if (VB.Pstr(list.DPAN7.Trim(), "^^", 1) == "2")
                {
                    SS3.ActiveSheet.Cells[17, 6].Text = "●";
                }
                else if (VB.Pstr(list.DPAN7.Trim(), "^^", 1) == "3")
                {
                    SS3.ActiveSheet.Cells[17, 6].Text = "●그밖의치아상태";
                    SS3.ActiveSheet.Cells[18, 6].Text = VB.Pstr(list.DPAN7.Trim(), "^^", 2);
                }
                ...
                {
                    strTEMP = "";
                    if (VB.Pstr(list.DPAN8.Trim(), "^^", 1) == "1")
                    {
                    ...
                    if (VB.Pstr(list.DPAN8.Trim(), "^^", 2) == "1")
                    {
                    ...
                    if (VB.Pstr(list.DPAN8.Trim(), "^^", 3) == "1")
                    {
                    ...
                    if (VB.Pstr(list.DPAN8.Trim(), "^^", 4) != "")
                    {
                        SS3.ActiveSheet.Cells[12, 13].Text = VB.Pstr(list.DPAN8.Trim(), "^^", 4);
                        strTEMP = "OK";
                    }
                    else
                    {
                    ...
                    if (list.DPAN9.Trim() == "2")
                    {
                        SS3.ActiveSheet.Cells[12, 11].Text = "●";
                    }
                    else if (list.DPAN9.Trim() == "1")
                    {
                        SS3.ActiveSheet.Cells[12, 9].Text = "●";
                    }
                }
                ...
                if (strGuBun == "3")
                {
                    if (list.DPAN10.Trim() == "2")
                    {
                        SS3.ActiveSheet.Cells[15, 11].Text = "●";
                    }
                    else if (list.DPAN10.Trim() == "1")
                    {
                        SS3.ActiveSheet.Cells[15, 9].Text = "●";
                    }
                    if (VB.Pstr(list.DPAN11.Trim(), "^^", 1) == "1")
                    {
                        SS3.ActiveSheet.Cells[16, 9].Text = "●";
                        SS3.ActiveSheet.Cells[16, 12].Text = "이상( )";
                    }
                    else if (VB.Pstr(list.DPAN11.Trim(), "^^", 1) == "2")
                    {
                        SS3.ActiveSheet.Cells[16, 9].Text = "●";
                        SS3.ActiveSheet.Cells[16, 12].Text = "이상(" + VB.Pstr(list.DPAN11.Trim(), "^^", 2) + ")";
                    }
                }
                strPan1 = "";
                strPan2 = "";
                switch (list.DPAN12.Trim())
                {
                    case "1":
                        strPan1 = "정상";
                    break;
                ...
                SS3.ActiveSheet.Cells[22, 1].Text = VB.Space(3) + list.DPANSOGEN.Trim(); ;
                SS3.ActiveSheet.Cells[22, 8].Text = VB.Space(3) + list.DPANJOCHI.Trim(); ;

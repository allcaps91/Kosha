    ...
    public partial class frmHcSchoolOpinionAfterMgmtPrint : Form
    {
        ...
        void eBtnClick(object sender, EventArgs e)
        {
            ...
            else if (sender == btnSearch)
            {
                ...
                List<HIC_JEPSU_PATIENT_SCHOOL> list = hicJepsuPatientSchoolService.GetItemCntbyJepDate(strFrDate, strFrDate, nLtdCode);
                ...
                for (int i = 0; i < nRead; i++)
                {
                    ...
                    SS1.ActiveSheet.Cells[i, 2].Text = list2.MINDATE.ToString();
                    SS1.ActiveSheet.Cells[i, 3].Text = list2.MAXDATE.ToString();
                    SS1.ActiveSheet.Cells[i, 4].Text = list2.CNT.ToString();
                    SS1.ActiveSheet.Cells[i, 5].Text = list2.CLASS.ToString();
                    SS1.ActiveSheet.Cells[i, 6].Text = list2.LTDCODE.ToString();
                }
        ...
        void fn_Screen_Display(string argDate1, string argDate2, string argClass, string argBan, string argLtdCode)
        {
            ...
            for (int i = 0; i < nRead; i++)
            {
                ...
                SS2.ActiveSheet.Cells[i, 0].Text = list[i].CLASS.Trim();
                SS2.ActiveSheet.Cells[i, 1].Text = list[i].BAN.Trim();
                SS2.ActiveSheet.Cells[i, 2].Text = list[i].BUN.Trim();
                SS2.ActiveSheet.Cells[i, 3].Text = list[i].SNAME.Trim();
                SS2.ActiveSheet.Cells[i, 4].Text = list[i].SEX1.Trim();
                SS2.ActiveSheet.Cells[i, 5].Text = "[ 종합판정 : 질환의심 ]" + "\r\n" + list[i].PPANREMARK1.Trim();
                SS2.ActiveSheet.Cells[i, 6].Text = list[i].PPANREMARK2.Trim();
            }

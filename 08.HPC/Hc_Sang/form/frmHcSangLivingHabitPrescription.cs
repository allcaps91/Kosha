...
namespace Hc_Sang
{
    public partial class frmHcSangLivingHabitPrescription : Form
    {
        ...
        void fn_Screen_Life_Slip()
        {
            ...
            if (!list.IsNullOrEmpty())
            {
                strSLIP1 = list.SLIP_SMOKE.Trim();
                strSLIP2 = list.SLIP_DRINK.Trim();
                strSLIP3 = list.SLIP_ACTIVE.Trim();
                strSLIP4 = list.SLIP_FOOD.Trim();
                strSLIP5 = list.SLIP_BIMAN.Trim();
                strTSmoke1 = list.T_SMOKE1.Trim();
                strDrink = list.TMUN0003.Trim();
                txtLifeSogen1.Text = list.SLIP_LIFESOGEN1.Trim();
                txtLifeSogen2.Text = list.SLIP_LIFESOGEN2.Trim();
            }
            ...
            for (int i = 0; i < nREAD; i++)
            {
                ...
                {
                    case "A143":
                        nJemsu[0] = long.Parse(list2[i].RESULT);    //흡연
                        break;
                    case "A144":
                        nJemsu[1] = long.Parse(list2[i].RESULT);    //음주
                        break;
                    case "A145":
                        nJemsu[2] = long.Parse(list2[i].RESULT);    //운동
                        break;
                    case "A146":
                        nJemsu[3] = long.Parse(list2[i].RESULT);    //영양
                        break;
                    case "A147":
                        nJemsu[4] = long.Parse(list2[i].RESULT);    //비만
                        break;
                    default:
                        break;
                }
            ...
            if (tab1.Visible == true)
            {
                ...
                if (strSLIP1 == "")
                {
                    ...
                    else if (strTSmoke1 == "2") //문진표에 과거흡연자
                    {
                        ...
                        cboSmoke2.SelectedIndex = int.Parse(strTSmoke1);    //니코틴의존도
                    }
                    else
                    {
            ...
            if (tab3.Visible == true)
            {
                ...
                {
                    switch (list3[i].JUMSU.ToString())
                    {
                        case "910":
                            nIlsu1 = int.Parse(list3[i].CODE);
                            break;
                        case "911":
                            nTime11 = int.Parse(list3[i].CODE);
                            break;
                        case "912":
                            nTime12 = int.Parse(list3[i].CODE);
                            break;
                        case "913":
                            nIlsu2 = int.Parse(list3[i].CODE);
                            break;
                        case "914":
                            nTime21 = int.Parse(list3[i].CODE);
                            break;
                        case "915":
                            nTime22 = int.Parse(list3[i].CODE);
                            break;
                        default:
                            break;
                    }
                ...
                if (strSLIP3 != "")
                {
                    ...
                    for (int k = 2; k <= 11; k++)
                    {
                        CheckBox chkHealth = (Controls.Find("chkHealth" + (k - 1).ToString(), true)[0] as CheckBox);
                    ...
                    for (int k = 17; k <= 27; k++)
                    {   
                        CheckBox chkHealth2 = (Controls.Find("chkHealth2" + (k - 16).ToString(), true)[0] as CheckBox);
            ...
            if (tab4.Visible == true)
            {
                ...
                else
                {
                    ...
                    for (int j = 2; j <= 11; j++)
                    {   
                        CheckBox chkDiet = (Controls.Find("chkDiet" + (j - 1).ToString(), true)[0] as CheckBox);
                        chkDiet.Checked = VB.Pstr(strSLIP4, ";", j) == "1" ? true : false;
                    }
                    //호전가능
                    for (int j = 12; j <= 20; j++)
                    {
                        CheckBox chkDiet2 = (Controls.Find("chkDiet2" + (j - 11).ToString(), true)[0] as CheckBox);
            ...
            if (tab5.Visible == true)
            {
                ...
                if (strSLIP5 == "")
                {
                    ...
                    for (int i = 0; i < list3.Count; i++)
                    {
                        if (list3[i].EXCODE.Trim() == "A117")
                        {
                            nBiman1 = double.Parse(list3[i].RESULT.Trim());
                        }
                        if (list3[i].EXCODE.Trim() == "A115")
                        {
                            nBiman2 = double.Parse(list3[i].RESULT.Trim());
                        }
                    }
                    //비만도체크
                ...
                else
                {
                    ...
                    for (int j = 8; j <= 14; j++)
                    {
                        CheckBox chkBiman = (Controls.Find("chkBiman" + (j - 7).ToString(), true)[0] as CheckBox);
                    ...
                    for (int j = 17; j <= 26; j++)
                    {
                        CheckBox chkBiman2 = (Controls.Find("chkBiman2" + (j - 16).ToString(), true)[0] as CheckBox);
            ...
            if (txtLifeSogen1.Text.Trim() == "")
            {
                txtLifeSogen1.Text = "특이소견 없음/";
            }

            if (txtLifeSogen2.Text.Trim() == "")
            {
        ...
        void fn_Screen_Clear()
        {
            ...
            for (int i = 1; i <= 4; i++)
            {
                ...
                TextBox txtBiman = (Controls.Find("txtBiman" + i.ToString(), true)[0] as TextBox);
            ...
            for (int i = 1; i <= 10; i++)
            {
                ...
                CheckBox chkBiman2 = (Controls.Find("chkBiman1" + i.ToString(), true)[0] as CheckBox);
                if (i < 8)
                {
            ...
            else if (sender == btnSave)
            {
                ...
                if (tab5.Visible == true)
                {
                    if (VB.Left(cboBiman1.Text, 1) == "3" || VB.Left(cboBiman2.Text, 1) == "1")
                    {
                        ...
                        if (txtBiman21.Text.Trim() != "") strChk = "Y";
                        if (txtBiman22.Text.Trim() != "") strChk = "Y";
                        if (strChk == "")
                        {
        ...
        void fn_DB_Update_LifeSlip()
        {
            ...
            if (tab1.Visible == true)
            {
                ...
                for (int j = 1; j <= 6; j++)
                {
                    CheckBox chkSmoking4 = (Controls.Find("chkSmoking4" + (j).ToString(), true)[0] as CheckBox);
                ...
                for (int j = 1; j <= 6; j++)
                {
                    CheckBox chkSmoking5 = (Controls.Find("chkSmoking4" + (j).ToString(), true)[0] as CheckBox);
            ...
            if (tab2.Visible == true)
            {
                ...
                for (int j = 1; j <= 8; j++)
                {
                    CheckBox chkDrink0 = (Controls.Find("chkDrink0" + (j).ToString(), true)[0] as CheckBox);
                ...
                for (int j = 1; j <= 6; j++)
                {
                    CheckBox chkDrink2 = (Controls.Find("chkDrink2" + (j).ToString(), true)[0] as CheckBox);
            ...
            if (tab3.Visible == true)
            {
                ...
                for (int j = 1; j <= 10; j++)
                {
                    CheckBox chkHealth = (Controls.Find("chkHealth" + (j).ToString(), true)[0] as CheckBox);
                ...
                for (int j = 1; j <= 11; j++)
                {
                    CheckBox chkHealth2 = (Controls.Find("chkHealth2" + (j).ToString(), true)[0] as CheckBox);
            ...
            if (tab4.Visible == true)
            {
                ...
                for (int j = 1; j <= 10; j++)
                {
                    CheckBox chkDiet = (Controls.Find("chkDiet" + (j).ToString(), true)[0] as CheckBox);
                ...
                for (int j = 1; j <= 9; j++)
                {
                    CheckBox chkDiet2 = (Controls.Find("chkDiet2" + (j).ToString(), true)[0] as CheckBox);
            ...
            if (tab5.Visible == true)
            {
                ...
                for (int j = 1; j <= 7; j++)
                {
                    CheckBox chkBiman1 = (Controls.Find("chkBiman1" + (j).ToString(), true)[0] as CheckBox);
                ...
                for (int j = 1; j <= 10; j++)
                {
                    CheckBox chkBiman2 = (Controls.Find("chkBiman2" + (j).ToString(), true)[0] as CheckBox);

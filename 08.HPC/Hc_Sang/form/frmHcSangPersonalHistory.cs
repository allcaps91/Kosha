    ...
    public partial class frmHcSangPersonalHistory : Form
    {
        ...
        void eSpdDClick(object sender, CellClickEventArgs e)
        {
            if (sender == SS2)
            {
                ...
                {
                    clsHcVariable.GnWRTNO = long.Parse(SS2.ActiveSheet.Cells[e.Row, 0].Text);
                }
                ...
                ///TODO : 이상훈(2019.12.26) FrmResultView(김민철 개발 완료 후 주석 해제)
                //FrmResultView f = new FrmResultView();
                //f.ShowDialog();

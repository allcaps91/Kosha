...
namespace Hc_Sang
{
    public partial class frmHcSangLivingHabitPrescriptionModify : Form
    {
        ...
        void fn_Screen_Display()
        {
            ...
            ssPatInfo.ActiveSheet.Cells[0, 5].Text = list2.GJJONG;
            ...
            if (FstrGjJong == "41" || FstrGjJong == "42" || FstrGjJong == "43" || FstrGjJong == "93" || FstrGjJong == "94")
            {
                ...
                str_T40_Feel[1] = list3.T40_FEEL3.Trim();
                str_T40_Feel[2] = list3.T40_FEEL4.Trim();

                str_T66_Feel[1] = list3.T66_FEEL1.Trim();
                str_T66_Feel[2] = list3.T66_FEEL2.Trim();
                str_T66_Feel[3] = list3.T66_FEEL3.Trim();

                str_T66_Memory[1] = list3.T66_MEMORY1.Trim();
                str_T66_Memory[2] = list3.T66_MEMORY2.Trim();
                str_T66_Memory[3] = list3.T66_MEMORY3.Trim();
                str_T66_Memory[4] = list3.T66_MEMORY4.Trim();
                str_T66_Memory[5] = list3.T66_MEMORY5.Trim();
